...
public abstract class EnversBug1676(IServiceProvider rootServiceProvider) : TestBase(rootServiceProvider)
{
    [Fact]
    public void OneToOneMapping()
    {
        ...
        this.EvaluateWrite(
                           context =>
                           {
                               var location = context.Logics.Location1676.GetById(locationId, true)!;
