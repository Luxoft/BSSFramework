...
public class ExampleAuthorizationSystem : AuthorizationSystem<Guid>
{
    ...
    public override bool HasAccess(SecurityOperation securityOperation) => throw new NotImplementedException();

    public override void CheckAccess(SecurityOperation securityOperation) => throw new NotImplementedException();

    public override IEnumerable<string> GetAccessors(SecurityOperation securityOperation, Expression<Func<IPrincipal<Guid>, bool>> principalFilter) => throw new NotImplementedException();
}
