...
public class ConfigurationContextFacade
{
    ...
    public virtual Type GetSecurityType(SecurityContextType securityContextType)
    {
        ...
        var result = this.context.ServiceProvider.GetRequiredService<ISecurityContextInfoSource>().GetSecurityContextInfo(securityContextType.Id).Type;
        return result;
    }
        ...
        ImmutableArray<NotificationFilterGroup> notificationFilterGroups)
    {
        ...
        var result = this.context.NotificationPrincipalExtractor.GetPrincipalsAsync(securityRoles, notificationFilterGroups).ToArrayAsync().GetAwaiter().GetResult();
    ...
    public virtual IEnumerable<Principal> GetNotificationPrincipals(ImmutableArray<SecurityRole> securityRoles)
    {
        ...
        var result = this.context.NotificationPrincipalExtractor.GetPrincipalsAsync(securityRoles, []).ToArrayAsync().GetAwaiter().GetResult();
