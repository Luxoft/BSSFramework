        ...
        public void SetUp()
        {
            ...
            this.DataHelper.Environment.GetContextEvaluator().Evaluate(
                ...
                context =>
                {
                    ...
                    var employeeView = authContext.Logics.Operation.GetByName(WorkflowSampleSystemSecurityOperationCode.EmployeeView.ToString());
                    ...
                    var employeePositionView = authContext.Logics.Operation.GetByName(WorkflowSampleSystemSecurityOperationCode.EmployeePositionView.ToString());
