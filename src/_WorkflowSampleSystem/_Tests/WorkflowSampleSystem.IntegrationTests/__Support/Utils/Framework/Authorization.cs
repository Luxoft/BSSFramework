...
namespace WorkflowSampleSystem.IntegrationTests.__Support.Utils.Framework
{
    public abstract class Authorization
    {
        ...
        private void FindAndSavePermissionFilter(IWorkflowSampleSystemBLLContext context, IPermissionDefinition permission, Permission permissionObject)
        {
