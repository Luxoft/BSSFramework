...
public static class PersistentTargetSystemInfoHelper
{
    public static PersistentTargetSystemInfo Authorization { get; } =
        new()
        {
            ...
            TypeResolver = TypeResolverHelper.Create(TypeSource.FromSample<Authorization.Domain.PersistentDomainObjectBase>(), TypeSearchMode.Both)
        };
    ...
    public static PersistentTargetSystemInfo Configuration { get; } =
        ...
        new()
        {
            ...
            TypeResolver = TypeResolverHelper.Create(TypeSource.FromSample<Configuration.Domain.PersistentDomainObjectBase>(), TypeSearchMode.Both)
        };
}
