...
public abstract partial class RazorTemplate<TDomainObject>
{
    ...
    protected void WriteAttribute(
            ...
            params object[] fragments) => this.WriteAttributeTo(this.Writer, name, prefix, suffix, fragments);
    ...
    private void WriteObject(object o) => this.Writer.Write(o);

    private void WriteLiteralTo(TextWriter writer, string text) => writer.Write(text);

    private void WriteTo(TextWriter writer, object value) => writer.Write(Convert.ToString(value, this.Culture));
}
