...
namespace AttachmentsSampleSystem.WebApiCore
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        {
            services.RegisterEvaluateScopeManager<IAttachmentsSampleSystemBLLContext>();
        ...
        public static IServiceCollection RegisterMainBLL(this IServiceCollection services)
        {
            return services
                   ...
                   .AddScopedTransientByContainer<ISecurityOperationResolver<PersistentDomainObjectBase, AttachmentsSampleSystemSecurityOperationCode>>(c => c.MainContext)
                   ...
                   .AddScopedTransientByContainer<IAttachmentsSampleSystemSecurityPathContainer>(c => c.MainContext.SecurityService)
        ...
        public static IServiceCollection AddScopedTransientByContainer<T>(this IServiceCollection services, Func<IServiceEnvironmentBLLContextContainer<IAttachmentsSampleSystemBLLContext>, T> func)
            where T : class
        {
            return services.AddScopedTransientFactory(sp => sp.GetRequiredService<IEvaluateScopeManager<IAttachmentsSampleSystemBLLContext>>()
