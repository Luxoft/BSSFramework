...
public abstract class IntegrationVersionTest(IServiceProvider rootServiceProvider) : TestBase(rootServiceProvider)
{
    [Fact]
    public void SaveWithMoreVersion_IgnoreLessPolicy_ValueSaved()
    {
        ...
        this.AuthManager.For().SetRole(SecurityRole.SystemIntegration);
