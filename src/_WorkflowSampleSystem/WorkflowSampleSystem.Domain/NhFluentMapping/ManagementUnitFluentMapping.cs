...
namespace WorkflowSampleSystem.Domain
{
    ...
    [BLLRole]
    [WorkflowSampleSystemViewDomainObject(
        WorkflowSampleSystemSecurityOperationCode.ManagementUnitView,
        WorkflowSampleSystemSecurityOperationCode.EmployeeEdit)]
