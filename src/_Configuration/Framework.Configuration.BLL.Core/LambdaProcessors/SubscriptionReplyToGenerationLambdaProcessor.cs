...
{
    /// <summary>
    /// Процессор лямбда-выражения типа "ReplyTo".
    /// </summary>
    ...
    public class SubscriptionReplyToGenerationLambdaProcessor<TBLLContext, TDomainObject>
        : SubscriptionLambdaObjectProcessorBase<Subscription, Func<TBLLContext, TDomainObject, TDomainObject, IEnumerable<NotificationMessageGenerationInfo>>>
    {
        ...
        public SubscriptionReplyToGenerationLambdaProcessor(INativeExpressionParser parser)
            : base(parser, subscription => subscription.ReplyToGeneration)
        {
        }
    }
    ...
    /// <typeparam name="TDomainObject">Тип доменного объекта.</typeparam>
    /// <seealso cref="SubscriptionLambdaObjectProcessorBase{Subscription, Func}" />
    public class SubscriptionReplyToGenerationLambdaProcessor<TDomainObject>
        : SubscriptionLambdaObjectProcessorBase<Subscription,
            Func<TDomainObject, TDomainObject, IEnumerable<NotificationMessageGenerationInfo>>>
    {
        /// <summary>
