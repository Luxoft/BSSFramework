...
{
    public AuditTableGenerateContext(ITableMetadata originalTable, ITableMetadata tableInfo, Table table, global::NHibernate.Dialect.Dialect dialect, IMapping mapping, string defaultCatalog, string defaultSchema, PersistentClass original, IAuditAttributeService auditAttributeService, IDatabaseScriptGeneratorContext context)
    {
    ...
    public global::NHibernate.Dialect.Dialect Dialect { get; }
