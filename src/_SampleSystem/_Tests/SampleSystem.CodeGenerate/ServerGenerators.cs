...
public partial class ServerGenerators
{
    ...
    public IEnumerable<FileInfo> GenerateMainWebApiNetCore()
    {
        var configurators =
                ...
                Framework.DomainDriven.ServiceModelGenerator.IGenerationEnvironmentBase>[] { this.environment.MainService };
    ...
    public IEnumerable<FileInfo> GenerateMainQueryWebApiNetCore()
    {
        var configurators =
                new Framework.DomainDriven.ServiceModelGenerator.IGeneratorConfigurationBase<
                Framework.DomainDriven.ServiceModelGenerator.IGenerationEnvironmentBase>[] { this.environment.QueryService };

        var attr = new CodeAttributeDeclaration(
                                                typeof(RouteAttribute).ToTypeReference(),
                                                new CodeAttributeArgument(
                                                                          new CodePrimitiveExpression(
                                                                           "mainQueryApi/v{version:apiVersion}/[controller]")));
    ...
    public IEnumerable<FileInfo> GenerateIntegrationWebApiNetCore()
    {
        ...
        var attr = new CodeAttributeDeclaration(
                                                ...
                                                new CodeAttributeArgument(
                                                                          new CodePrimitiveExpression(
                                                                           "integrationApi/v{version:apiVersion}/[controller]")));
    ...
    public IEnumerable<FileInfo> GenerateAuditWebApiNetCore()
    {
        var configurators =
                new Framework.DomainDriven.ServiceModelGenerator.IGeneratorConfigurationBase<
                Framework.DomainDriven.ServiceModelGenerator.IGenerationEnvironmentBase>[] { this.environment.AuditService };

        var attr = new CodeAttributeDeclaration(
                                                typeof(RouteAttribute).ToTypeReference(),
                                                new CodeAttributeArgument(
                                                                          new CodePrimitiveExpression(
                                                                           "mainAuditApi/v{version:apiVersion}/[controller]")));
    ...
    public IEnumerable<FileInfo> GenerateAuthWebApiNetCoreTest()
    {
        ...
        var configurators =
                new Framework.DomainDriven.ServiceModelGenerator.IGeneratorConfigurationBase<
                Framework.DomainDriven.ServiceModelGenerator.IGenerationEnvironmentBase>[] { e.MainService, };

        var attr = new CodeAttributeDeclaration(
                                                typeof(RouteAttribute).ToTypeReference(),
                                                new CodeAttributeArgument(
                                                                          new CodePrimitiveExpression(
                                                                           "authApi/v{version:apiVersion}/[controller]")));
    ...
    public IEnumerable<FileInfo> GenerateConfigurationWebApiNetCoreTest()
    {
        ...
        var attr = new CodeAttributeDeclaration(
                                                ...
                                                new CodeAttributeArgument(
                                                                          new CodePrimitiveExpression(
                                                                           "configApi/v{version:apiVersion}/[controller]")));
    ...
    {
        var generator =
                new ServerDTO.SampleSystemServerFileGenerator<ServerDTO.ServerDTOGeneratorConfiguration>(
