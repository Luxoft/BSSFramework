...
namespace WorkflowSampleSystem.CodeGenerate
{
    ...
    public class ComplexChangeMethodGenerator : ModelMethodGenerator<MainServiceGeneratorConfiguration, BLLSaveRoleAttribute>
    {
        ...
        {
            this.Identity = new MethodIdentity(WorkflowSampleSystemMethodIdentityType.ComplexChange, this.ModelType);
        }
        ...
        protected override IEnumerable<CodeStatement> GetFacadeMethodInternalStatements(CodeExpression evaluateDataExpr, CodeExpression bllRefExpr)
        {
            ...
            yield return bllRefExpr.ToMethodInvokeExpression(this.DomainType.GetModelMethodName(this.ModelType, WorkflowSampleSystemModelRole.ComplexChange, false),
