...
public static class EnumerableExtensions
{
    ...
    {
        if (targetCodeObject is null) throw new ArgumentNullException(nameof(targetCodeObject));
        if (sourceCodeObject is null) throw new ArgumentNullException(nameof(sourceCodeObject));
    ...
    {
        if (targetDictionary is null) throw new ArgumentNullException(nameof(targetDictionary));
            ...
            where T : class
    {
        ...
        return source.Where(v => v is not null).ToArray();
    }
}
