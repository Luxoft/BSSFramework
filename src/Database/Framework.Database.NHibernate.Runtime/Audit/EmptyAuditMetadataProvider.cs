...
/// Empty implement
/// </summary>
internal class EmptyAuditMetadataProvider(IRevisionListener entityTrackingRevisionListener) : IMetaDataProvider
{
    public IDictionary<Type, IEntityMeta> CreateMetaData(Configuration nhConfiguration)
    {
        ...
        entityMeta.AddClassMeta(new RevisionEntityAttribute { Listener = entityTrackingRevisionListener });
