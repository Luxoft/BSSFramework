...
namespace WorkflowSampleSystem.IntegrationTests.Reports
{
    ...
    public class CustomReportsTests : TestBase
    {
        ...
        public void InitDd()
        {
            ActivatorUtilities.CreateInstance<WorkflowSampleSystemCustomReportsServiceEnvironment>(this.Environment.ServiceProvider);
        }
        ...
        public void GetEmployeeReport_CorrectReportExcel()
        {
            ...
            // Act
            var report = this.GetController<WorkflowSampleSystem.WebApiCore.Controllers.CustomReport.EmployeeReportParameterController>().GetEmployeeReport(new EmployeeReportParameterStrictDTO { ReportId = reportId });
        ...
        public void GetEmployeeReport_WithoutAdminRights_CorrectReportExcel()
        {
            ...
            // Act
            var report = this.GetController<WorkflowSampleSystem.WebApiCore.Controllers.CustomReport.EmployeeReportParameterController>(Tester).GetEmployeeReport(new EmployeeReportParameterStrictDTO { ReportId = reportId });
        ...
        public void GetSimpleReportParameterValues_AllValuesReturned()
        {
            ...
            var parameters = this.GetController<WorkflowSampleSystemGenericReportController>().GetSimpleReportParameters(reportId);

            // Act
            var values = this.GetController<WorkflowSampleSystemGenericReportController>().GetSimpleReportParameterValues(new GetSimpleReportParameterValuesRequest
            {
        ...
        public void GetEmployeeReport_RequestWithOptionalReportParameter_CorrectReportExcel()
        {
            ...
            // Act
            var report = this.GetController<WorkflowSampleSystem.WebApiCore.Controllers.CustomReport.EmployeeReportParameterController>()
