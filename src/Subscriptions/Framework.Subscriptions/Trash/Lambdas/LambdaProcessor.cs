...
namespace Framework.Subscriptions.Lambdas;
        ...
        where TBLLContext : class
{
            ...
            where T : class
    {
        var invalidArguments = lambda == null
                               || versions == null
                               || versions.ChangeType == Domain.DomainObjectChangeType.Unknown;
        ...
        Func<Domain.DomainObjectChangeType, bool> func;
    ...
    {
        var create = Domain.DomainObjectChangeType.Create;
        var update = Domain.DomainObjectChangeType.Update;
        var delete = Domain.DomainObjectChangeType.Delete;
    ...
    private class ComplianceFunctionsTable : Dictionary<SubscriptionType, Func<Domain.DomainObjectChangeType, bool>>;
}
