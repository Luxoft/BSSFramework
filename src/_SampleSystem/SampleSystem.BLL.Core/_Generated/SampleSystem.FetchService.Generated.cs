...
namespace SampleSystem.BLL
{
    ...
    public partial class SampleSystemMainFetchServiceBase : Framework.DomainDriven.MainFetchServiceBase<SampleSystem.Domain.PersistentDomainObjectBase>
    {
        ...
        protected override Framework.DomainDriven.IFetchContainer<TDomainObject> GetContainer<TDomainObject>(Framework.Transfering.ViewDTOType rule)
        {
            ...
            else if ((typeof(TDomainObject) == typeof(SampleSystem.Domain.TypedAuth.TypedAuthPermission)))
            {
                return ((Framework.DomainDriven.IFetchContainer<TDomainObject>)(this.GetTypedAuthPermissionContainer(rule)));
            }
            else if ((typeof(TDomainObject) == typeof(SampleSystem.Domain.TypedAuth.TypedAuthPermissionBusinessUnit)))
            {
                return ((Framework.DomainDriven.IFetchContainer<TDomainObject>)(this.GetTypedAuthPermissionBusinessUnitContainer(rule)));
            }
            else if ((typeof(TDomainObject) == typeof(SampleSystem.Domain.TypedAuth.TypedAuthPermissionEmployee)))
            {
                return ((Framework.DomainDriven.IFetchContainer<TDomainObject>)(this.GetTypedAuthPermissionEmployeeContainer(rule)));
            }
            else if ((typeof(TDomainObject) == typeof(SampleSystem.Domain.TypedAuth.TypedAuthPermissionLocation)))
            {
                return ((Framework.DomainDriven.IFetchContainer<TDomainObject>)(this.GetTypedAuthPermissionLocationContainer(rule)));
            }
            else if ((typeof(TDomainObject) == typeof(SampleSystem.Domain.TypedAuth.TypedAuthPermissionManagementUnit)))
            {
                return ((Framework.DomainDriven.IFetchContainer<TDomainObject>)(this.GetTypedAuthPermissionManagementUnitContainer(rule)));
            }
        ...
        protected virtual Framework.DomainDriven.IFetchContainer<SampleSystem.Domain.TypedAuth.TypedAuthPermissionBusinessUnit> GetTypedAuthPermissionBusinessUnitContainer(Framework.Transfering.ViewDTOType rule)
        {
            if ((rule == Framework.Transfering.ViewDTOType.VisualDTO))
            {
                return Framework.DomainDriven.FetchContainer<SampleSystem.Domain.TypedAuth.TypedAuthPermissionBusinessUnit>.Empty;
            }
            else if ((rule == Framework.Transfering.ViewDTOType.SimpleDTO))
            {
                return Framework.DomainDriven.FetchContainer<SampleSystem.Domain.TypedAuth.TypedAuthPermissionBusinessUnit>.Empty;
            ...
            {
                return Framework.DomainDriven.FetchContainer.Create<SampleSystem.Domain.TypedAuth.TypedAuthPermissionBusinessUnit>(
                    fetchRootRule => fetchRootRule.SelectNested(typedAuthPermissionBusinessUnit => typedAuthPermissionBusinessUnit.ContextEntity),
                    fetchRootRule => fetchRootRule.SelectNested(typedAuthPermissionBusinessUnit => typedAuthPermissionBusinessUnit.Permission));
            }
            else if ((rule == Framework.Transfering.ViewDTOType.RichDTO))
            {
                return Framework.DomainDriven.FetchContainer.Create<SampleSystem.Domain.TypedAuth.TypedAuthPermissionBusinessUnit>(
        ...
        protected virtual Framework.DomainDriven.IFetchContainer<SampleSystem.Domain.TypedAuth.TypedAuthPermission> GetTypedAuthPermissionContainer(Framework.Transfering.ViewDTOType rule)
        {
            if ((rule == Framework.Transfering.ViewDTOType.VisualDTO))
            {
                return Framework.DomainDriven.FetchContainer<SampleSystem.Domain.TypedAuth.TypedAuthPermission>.Empty;
            }
            else if ((rule == Framework.Transfering.ViewDTOType.SimpleDTO))
            {
                return Framework.DomainDriven.FetchContainer<SampleSystem.Domain.TypedAuth.TypedAuthPermission>.Empty;
            ...
            {
                return Framework.DomainDriven.FetchContainer.Create<SampleSystem.Domain.TypedAuth.TypedAuthPermission>(
                    fetchRootRule => fetchRootRule.SelectMany(typedAuthPermission => typedAuthPermission.BusinessUnitItems).SelectNested(typedAuthPermissionBusinessUnit => typedAuthPermissionBusinessUnit.ContextEntity),
                    fetchRootRule => fetchRootRule.SelectMany(typedAuthPermission => typedAuthPermission.EmployeeItems).SelectNested(typedAuthPermissionEmployee => typedAuthPermissionEmployee.ContextEntity).SelectNested(employee => employee.CoreBusinessUnit),
                    fetchRootRule => fetchRootRule.SelectMany(typedAuthPermission => typedAuthPermission.EmployeeItems).SelectNested(typedAuthPermissionEmployee => typedAuthPermissionEmployee.ContextEntity).SelectNested(employee => employee.HRDepartment).SelectNested(hRDepartment => hRDepartment.Location),
                    fetchRootRule => fetchRootRule.SelectMany(typedAuthPermission => typedAuthPermission.LocationItems).SelectNested(typedAuthPermissionLocation => typedAuthPermissionLocation.ContextEntity).SelectMany(location => location.Children),
                    fetchRootRule => fetchRootRule.SelectMany(typedAuthPermission => typedAuthPermission.ManagementUnitItems).SelectNested(typedAuthPermissionManagementUnit => typedAuthPermissionManagementUnit.ContextEntity));
            }
            else
            {
                throw new System.ArgumentOutOfRangeException("rule");
        ...
        protected virtual Framework.DomainDriven.IFetchContainer<SampleSystem.Domain.TypedAuth.TypedAuthPermissionEmployee> GetTypedAuthPermissionEmployeeContainer(Framework.Transfering.ViewDTOType rule)
        {
            if ((rule == Framework.Transfering.ViewDTOType.VisualDTO))
            {
                return Framework.DomainDriven.FetchContainer<SampleSystem.Domain.TypedAuth.TypedAuthPermissionEmployee>.Empty;
            }
            else if ((rule == Framework.Transfering.ViewDTOType.SimpleDTO))
            {
                return Framework.DomainDriven.FetchContainer<SampleSystem.Domain.TypedAuth.TypedAuthPermissionEmployee>.Empty;
            ...
            {
                return Framework.DomainDriven.FetchContainer.Create<SampleSystem.Domain.TypedAuth.TypedAuthPermissionEmployee>(
                    fetchRootRule => fetchRootRule.SelectNested(typedAuthPermissionEmployee => typedAuthPermissionEmployee.ContextEntity).SelectNested(employee => employee.CoreBusinessUnit),
                    fetchRootRule => fetchRootRule.SelectNested(typedAuthPermissionEmployee => typedAuthPermissionEmployee.ContextEntity).SelectNested(employee => employee.HRDepartment).SelectNested(hRDepartment => hRDepartment.Location),
                    fetchRootRule => fetchRootRule.SelectNested(typedAuthPermissionEmployee => typedAuthPermissionEmployee.Permission));
            }
            else if ((rule == Framework.Transfering.ViewDTOType.RichDTO))
            {
                return Framework.DomainDriven.FetchContainer.Create<SampleSystem.Domain.TypedAuth.TypedAuthPermissionEmployee>(
        ...
        protected virtual Framework.DomainDriven.IFetchContainer<SampleSystem.Domain.TypedAuth.TypedAuthPermissionLocation> GetTypedAuthPermissionLocationContainer(Framework.Transfering.ViewDTOType rule)
        {
            if ((rule == Framework.Transfering.ViewDTOType.VisualDTO))
            {
                return Framework.DomainDriven.FetchContainer<SampleSystem.Domain.TypedAuth.TypedAuthPermissionLocation>.Empty;
            }
            else if ((rule == Framework.Transfering.ViewDTOType.SimpleDTO))
            {
                return Framework.DomainDriven.FetchContainer<SampleSystem.Domain.TypedAuth.TypedAuthPermissionLocation>.Empty;
            ...
            {
                return Framework.DomainDriven.FetchContainer.Create<SampleSystem.Domain.TypedAuth.TypedAuthPermissionLocation>(
                    fetchRootRule => fetchRootRule.SelectNested(typedAuthPermissionLocation => typedAuthPermissionLocation.ContextEntity).SelectMany(location => location.Children),
                    fetchRootRule => fetchRootRule.SelectNested(typedAuthPermissionLocation => typedAuthPermissionLocation.Permission));
            }
            else if ((rule == Framework.Transfering.ViewDTOType.RichDTO))
            {
                return Framework.DomainDriven.FetchContainer.Create<SampleSystem.Domain.TypedAuth.TypedAuthPermissionLocation>(
        ...
        protected virtual Framework.DomainDriven.IFetchContainer<SampleSystem.Domain.TypedAuth.TypedAuthPermissionManagementUnit> GetTypedAuthPermissionManagementUnitContainer(Framework.Transfering.ViewDTOType rule)
        {
            if ((rule == Framework.Transfering.ViewDTOType.VisualDTO))
            {
                return Framework.DomainDriven.FetchContainer<SampleSystem.Domain.TypedAuth.TypedAuthPermissionManagementUnit>.Empty;
            }
            else if ((rule == Framework.Transfering.ViewDTOType.SimpleDTO))
            {
                return Framework.DomainDriven.FetchContainer<SampleSystem.Domain.TypedAuth.TypedAuthPermissionManagementUnit>.Empty;
            ...
            {
                return Framework.DomainDriven.FetchContainer.Create<SampleSystem.Domain.TypedAuth.TypedAuthPermissionManagementUnit>(
                    fetchRootRule => fetchRootRule.SelectNested(typedAuthPermissionManagementUnit => typedAuthPermissionManagementUnit.ContextEntity),
                    fetchRootRule => fetchRootRule.SelectNested(typedAuthPermissionManagementUnit => typedAuthPermissionManagementUnit.Permission));
            }
            else if ((rule == Framework.Transfering.ViewDTOType.RichDTO))
            {
                return Framework.DomainDriven.FetchContainer.Create<SampleSystem.Domain.TypedAuth.TypedAuthPermissionManagementUnit>(
