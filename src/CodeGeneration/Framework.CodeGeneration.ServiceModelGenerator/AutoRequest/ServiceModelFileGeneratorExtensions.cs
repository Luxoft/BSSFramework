...
namespace Framework.CodeGeneration.ServiceModelGenerator.AutoRequest;
...
public static class ServiceModelFileGeneratorExtensions
{
    public static IFileGenerator<ICodeFile, CodeDomRenderer> WithAutoRequestMethods(
        ...
        new AutoRequestCodeFileGenerator(fileGenerator);

    private class AutoRequestCodeFileGenerator(IFileGenerator<ICodeFile, CodeDomRenderer> baseCodeFileGenerator) : IFileGenerator<ICodeFile, CodeDomRenderer>
    {
        private readonly IFileGenerator<ICodeFile, CodeDomRenderer> baseCodeFileGenerator = baseCodeFileGenerator ?? throw new ArgumentNullException(nameof(baseCodeFileGenerator));
    ...
    private class AutoRequestFileFactory(ICodeFile baseCodeFile) : ICodeFile
    {
