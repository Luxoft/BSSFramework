...
public class TestEnvironment
{
        ...
        string[] secondaryDatabases)
    {
        ...
        this.AssemblyInitializeAndCleanup = new AssemblyInitializeAndCleanup(
            ...
            (serviceProvider) => this.ServiceProviderPool.Release(serviceProvider));
    }
        ...
        string[] secondaryDatabases)
    {
        ...
        var databaseContextSettings = new DatabaseContextSettings(configUtil.GetConnectionString(connectionStringName), secondaryDatabases);
        var databaseContext = new DatabaseContext(configUtil, databaseContextSettings);
        var configuration = new ConfigurationBuilder()
            .AddConfiguration(rootConfiguration)
            .AddInMemoryCollection(
                rootConfiguration.GetSection("ConnectionStrings").GetChildren()
