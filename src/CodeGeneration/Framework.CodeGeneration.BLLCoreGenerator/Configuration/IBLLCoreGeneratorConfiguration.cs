...
public interface IBLLCoreGeneratorConfiguration<out TEnvironment> : IBLLCoreGeneratorConfiguration, ICodeGeneratorConfiguration<TEnvironment, FileType>
    where TEnvironment : IBLLCoreGenerationEnvironment;
