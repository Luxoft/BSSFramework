...
using WorkflowSampleSystem.Domain.Models.Custom;
...
using WorkflowSampleSystem.Subscriptions.Metadata.Examples.Attachment;
using WorkflowSampleSystem.Subscriptions.Metadata.Examples.AttachmentTemplateEvaluator;

namespace WorkflowSampleSystem.IntegrationTests.Subscriptions_Metadata
{
    [TestClass]
    public sealed class MetadataSubscriptionSystemServiceTests : TestBase
    {
        ...
        public void SubscriptionFromMetadataShouldBeSent()
        {
            ...
            var expectedNotifications = this.GetNotifications()
                .Where(n => n.From == "WorkflowSampleSystem@luxoft.com");
        ...
        public void DateModelCreateSubscriptionTest()
        {
            ...
            var expectedNotifications = this.GetNotifications()
                                            .Where(n => n.From == "DateModelCreateWorkflowSampleSystem@luxoft.com");
        ...
        public void PrincipalCreateModelSubscriptionTest()
        {
            ...
            var expectedNotifications = this.GetNotifications()
                                            .Where(n => n.From == "PrincipalCreateModelCreateWorkflowSampleSystem@luxoft.com");
