...
namespace AttachmentsSampleSystem.Generated.DAL.NHibernate
{
    public class AttachmentsSampleSystemMappingSettings : MappingSettings<PersistentDomainObjectBase>
    {
        private readonly string connectionString;

        public AttachmentsSampleSystemMappingSettings(DatabaseName databaseName, string connectionString)
                : base(typeof(AttachmentsSampleSystemMappingSettings).Assembly, databaseName, databaseName.ToDefaultAudit()) =>
                this.connectionString = connectionString;

        /// <summary>
        /// For DBGenerator
        /// </summary>
        public AttachmentsSampleSystemMappingSettings(
        ...
        public override void InitMapping(Configuration cfg)
        {
            ...
            Fluently
                    ...
                    .Mappings(
                              m =>
                              {
                                  m.FluentMappings.AddFromAssemblyOf<AttachmentsSampleSystemMappingSettings>()
