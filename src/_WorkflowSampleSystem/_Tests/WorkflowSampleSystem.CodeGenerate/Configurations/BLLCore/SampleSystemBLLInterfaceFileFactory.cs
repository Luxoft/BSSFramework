...
namespace WorkflowSampleSystem.CodeGenerate
{
    ...
    /// </summary>
    public class WorkflowSampleSystemBLLInterfaceFileFactory : BLLInterfaceFileFactory<BLLCoreGeneratorConfiguration>
    {
        public WorkflowSampleSystemBLLInterfaceFileFactory(BLLCoreGeneratorConfiguration configuration, Type domainType)
        ...
        protected override IEnumerable<CodeTypeMember> GetMembers()
        {
            ...
            {
                var methodName = this.DomainType.GetModelMethodName(complexChangeModelType, WorkflowSampleSystemModelRole.ComplexChange, false);
