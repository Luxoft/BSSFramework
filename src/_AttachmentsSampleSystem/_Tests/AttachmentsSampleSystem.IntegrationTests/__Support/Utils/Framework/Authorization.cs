...
namespace AttachmentsSampleSystem.IntegrationTests.__Support.Utils.Framework
{
    public abstract class Authorization
    {
        ...
        private void FindAndSavePermissionFilter(IAttachmentsSampleSystemBLLContext context, IPermissionDefinition permission, Permission permissionObject)
        {
        ...
        private void SavePermissionFilter(IAttachmentsSampleSystemBLLContext context, Permission permission, Guid entityId, string entityName)
        {
            var entity =
