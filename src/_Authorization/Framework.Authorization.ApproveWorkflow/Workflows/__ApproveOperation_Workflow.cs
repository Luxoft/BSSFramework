        ...
        builder.StartWith(_ => { })
            ...
            .Do(@if => @if.Parallel()
                .Do(approveBuilder => approveBuilder
                    .WaitFor("Approve_Event", wfObj => wfObj.OperationId.ToString())
                ...
                .Do(rejectBuilder => rejectBuilder
                    .WaitFor("Reject_Event", wfObj => wfObj.OperationId.ToString())
                    .Output((_, operation) => operation.Status = ApproveOperationWorkflowStatus.Rejected)
                    .CancelCondition(operation => operation.Status != ApproveOperationWorkflowStatus.Approving))
