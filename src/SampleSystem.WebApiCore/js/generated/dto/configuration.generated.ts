...
export class MessageTemplateIdentityDTO {
    public static Empty = new MessageTemplateIdentityDTO(Guid.Empty);

    public __type = 'MessageTemplateIdentityDTO';

    private _messagetemplateidentitydto: string;
    ...
    public static fromJs(source: any): MessageTemplateIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new MessageTemplateIdentityDTO(source.Id);
    }

    public toNativeJson(): MessageTemplateIdentityDTO {
        return this;
    }
...
export class RegularJobIdentityDTO {
    public static Empty = new RegularJobIdentityDTO(Guid.Empty);

    public __type = 'RegularJobIdentityDTO';

    private _regularjobidentitydto: string;
    ...
    public static fromJs(source: any): RegularJobIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new RegularJobIdentityDTO(source.Id);
    }

    public toNativeJson(): RegularJobIdentityDTO {
        return this;
    }
...
export class SubBusinessRoleIdentityDTO {
    public static Empty = new SubBusinessRoleIdentityDTO(Guid.Empty);

    public __type = 'SubBusinessRoleIdentityDTO';

    private _subbusinessroleidentitydto: string;
    ...
    public static fromJs(source: any): SubBusinessRoleIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new SubBusinessRoleIdentityDTO(source.Id);
    }

    public toNativeJson(): SubBusinessRoleIdentityDTO {
        return this;
    }

}

export class SubscriptionIdentityDTO {
    public static Empty = new SubscriptionIdentityDTO(Guid.Empty);

    public __type = 'SubscriptionIdentityDTO';

    private _subscriptionidentitydto: string;
    ...
    public static fromJs(source: any): SubscriptionIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new SubscriptionIdentityDTO(source.Id);
    }

    public toNativeJson(): SubscriptionIdentityDTO {
        return this;
    }

}

export class SubscriptionLambdaIdentityDTO {
    public static Empty = new SubscriptionLambdaIdentityDTO(Guid.Empty);

    public __type = 'SubscriptionLambdaIdentityDTO';

    private _subscriptionlambdaidentitydto: string;
    ...
    public static fromJs(source: any): SubscriptionLambdaIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new SubscriptionLambdaIdentityDTO(source.Id);
    }

    public toNativeJson(): SubscriptionLambdaIdentityDTO {
        return this;
    }

}

export class SubscriptionSecurityItemIdentityDTO {
    public static Empty = new SubscriptionSecurityItemIdentityDTO(Guid.Empty);

    public __type = 'SubscriptionSecurityItemIdentityDTO';

    private _subscriptionsecurityitemidentitydto: string;
    ...
    public static fromJs(source: any): SubscriptionSecurityItemIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new SubscriptionSecurityItemIdentityDTO(source.Id);
    }

    public toNativeJson(): SubscriptionSecurityItemIdentityDTO {
        return this;
    }
...
export class ExecuteRegularJobResultObservableIdentityDTO {
    public Id: Guid;
    ...
    public static fromJs(source: any): ExecuteRegularJobResultObservableIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new ExecuteRegularJobResultObservableIdentityDTO(source.Id);
    }

}

export class ExecuteRegularJobResultObservableSimpleDTO extends BaseObservableAbstractDTO {
    public __type = 'ExecuteRegularJobResultObservableSimpleDTO';

    private _executeregularjobresultobservablesimpledto: string;

    public Description = observable<string>();

    public ExecutionTime = observable<number>();

    public Status = observable<RegularJobStatus>();

    public Time = observable<number>();

    public static fromJs(source: IExecuteRegularJobResultSimpleDTO): ExecuteRegularJobResultObservableSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new ExecuteRegularJobResultObservableSimpleDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IExecuteRegularJobResultSimpleDTO): void {
        super.fromJs(source);
    ...
    public toJs(): ExecuteRegularJobResultSimpleDTO {
        let e = new ExecuteRegularJobResultSimpleDTO();
        e.fromObservable(this);
        return e;
    }

    public toStrict(): ExecuteRegularJobResultStrictDTO {
        let e = new ExecuteRegularJobResultSimpleDTO();
        e.fromObservable(this);
        return e.toStrict();
    }
...
export class ExecuteRegularJobResultObservableFullDTO extends ExecuteRegularJobResultObservableSimpleDTO {
    public __type = 'ExecuteRegularJobResultObservableFullDTO';

    private _executeregularjobresultobservablefulldto: string;

    public static fromJs(source: IExecuteRegularJobResultFullDTO): ExecuteRegularJobResultObservableFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new ExecuteRegularJobResultObservableFullDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IExecuteRegularJobResultFullDTO): void {
        super.fromJs(source);
    }

    public toJs(): ExecuteRegularJobResultFullDTO {
        let e = new ExecuteRegularJobResultFullDTO();
        e.fromObservable(this);
        return e;
    }
...
export class ExecuteRegularJobResultObservableRichDTO extends ExecuteRegularJobResultObservableFullDTO {
    public __type = 'ExecuteRegularJobResultObservableRichDTO';

    private _executeregularjobresultobservablerichdto: string;

    public static fromJs(source: IExecuteRegularJobResultRichDTO): ExecuteRegularJobResultObservableRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new ExecuteRegularJobResultObservableRichDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IExecuteRegularJobResultRichDTO): void {
        super.fromJs(source);
    }

    public toJs(): ExecuteRegularJobResultRichDTO {
        let e = new ExecuteRegularJobResultRichDTO();
        e.fromObservable(this);
        return e;
    }
...
export class MessageTemplateObservableIdentityDTO {
    public Id: Guid;
    ...
    public static fromJs(source: any): MessageTemplateObservableIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new MessageTemplateObservableIdentityDTO(source.Id);
    }

}

export class MessageTemplateObservableSimpleDTO extends BaseObservableAuditPersistentDTO {
    public __type = 'MessageTemplateObservableSimpleDTO';

    private _messagetemplateobservablesimpledto: string;
    ...
    public Renderer = observable<TemplateRenderer>();

    public Subject = observable<string>();

    public static fromJs(source: IMessageTemplateSimpleDTO): MessageTemplateObservableSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new MessageTemplateObservableSimpleDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IMessageTemplateSimpleDTO): void {
        super.fromJs(source);
        this.Code(source.Code);
    ...
    public identity(): MessageTemplateIdentityDTO {
        return new MessageTemplateIdentityDTO(this.Id());
    }

    public toJs(): MessageTemplateSimpleDTO {
        let e = new MessageTemplateSimpleDTO();
        e.fromObservable(this);
        return e;
    }

    public toStrict(): MessageTemplateStrictDTO {
        let e = new MessageTemplateSimpleDTO();
        e.fromObservable(this);
        return e.toStrict();
    }
...
export class MessageTemplateObservableFullDTO extends MessageTemplateObservableSimpleDTO {
    public __type = 'MessageTemplateObservableFullDTO';

    private _messagetemplateobservablefulldto: string;

    public DomainType = observable<DomainTypeObservableSimpleDTO>();

    public TargetSystem = observable<TargetSystemObservableSimpleDTO>();

    public static fromJs(source: IMessageTemplateFullDTO): MessageTemplateObservableFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new MessageTemplateObservableFullDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IMessageTemplateFullDTO): void {
        super.fromJs(source);
        this.DomainType(DomainTypeObservableSimpleDTO.fromJs(source.DomainType));
        this.TargetSystem(TargetSystemObservableSimpleDTO.fromJs(source.TargetSystem));
    }

    public toJs(): MessageTemplateFullDTO {
        let e = new MessageTemplateFullDTO();
        e.fromObservable(this);
        return e;
    }
...
export class MessageTemplateObservableRichDTO extends MessageTemplateObservableFullDTO {
    public __type = 'MessageTemplateObservableRichDTO';

    private _messagetemplateobservablerichdto: string;

    public static fromJs(source: IMessageTemplateRichDTO): MessageTemplateObservableRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new MessageTemplateObservableRichDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IMessageTemplateRichDTO): void {
        super.fromJs(source);
    }

    public toJs(): MessageTemplateRichDTO {
        let e = new MessageTemplateRichDTO();
        e.fromObservable(this);
        return e;
    }
...
export class MessageTemplateObservableVisualDTO extends BaseObservablePersistentDTO {
    public __type = 'MessageTemplateObservableVisualDTO';

    private _messagetemplateobservablevisualdto: string;
    ...
    public static fromJs(source: IBasePersistentDTO): MessageTemplateObservableVisualDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new MessageTemplateObservableVisualDTO();
        e.fromJs(source);
        return e;
    }
    ...
    public toJs(): MessageTemplateVisualDTO {
        let e = new MessageTemplateVisualDTO();
        e.fromObservable(this);
        return e;
    }
...
export class MessageTemplateCreateModelObservableIdentityDTO {
    public Id: Guid;
    ...
    public static fromJs(source: any): MessageTemplateCreateModelObservableIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new MessageTemplateCreateModelObservableIdentityDTO(source.Id);
    }

}

export class MessageTemplateCreateModelObservableSimpleDTO extends BaseObservableAbstractDTO {
    public __type = 'MessageTemplateCreateModelObservableSimpleDTO';

    private _messagetemplatecreatemodelobservablesimpledto: string;

    public static fromJs(source: IMessageTemplateCreateModelSimpleDTO): MessageTemplateCreateModelObservableSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new MessageTemplateCreateModelObservableSimpleDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IMessageTemplateCreateModelSimpleDTO): void {
        super.fromJs(source);
    }

    public toJs(): MessageTemplateCreateModelSimpleDTO {
        let e = new MessageTemplateCreateModelSimpleDTO();
        e.fromObservable(this);
        return e;
    }

    public toStrict(): MessageTemplateCreateModelStrictDTO {
        let e = new MessageTemplateCreateModelSimpleDTO();
        e.fromObservable(this);
        return e.toStrict();
    }
...
export class MessageTemplateCreateModelObservableFullDTO extends MessageTemplateCreateModelObservableSimpleDTO {
    public __type = 'MessageTemplateCreateModelObservableFullDTO';

    private _messagetemplatecreatemodelobservablefulldto: string;

    public static fromJs(source: IMessageTemplateCreateModelFullDTO): MessageTemplateCreateModelObservableFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new MessageTemplateCreateModelObservableFullDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IMessageTemplateCreateModelFullDTO): void {
        super.fromJs(source);
    }

    public toJs(): MessageTemplateCreateModelFullDTO {
        let e = new MessageTemplateCreateModelFullDTO();
        e.fromObservable(this);
        return e;
    }
...
export class MessageTemplateCreateModelObservableRichDTO extends MessageTemplateCreateModelObservableFullDTO {
    public __type = 'MessageTemplateCreateModelObservableRichDTO';

    private _messagetemplatecreatemodelobservablerichdto: string;

    public static fromJs(source: IMessageTemplateCreateModelRichDTO): MessageTemplateCreateModelObservableRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new MessageTemplateCreateModelObservableRichDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IMessageTemplateCreateModelRichDTO): void {
        super.fromJs(source);
    }

    public toJs(): MessageTemplateCreateModelRichDTO {
        let e = new MessageTemplateCreateModelRichDTO();
        e.fromObservable(this);
        return e;
    }
...
export class MessageTemplateRootFilterModelObservableIdentityDTO {
    public Id: Guid;
    ...
    public static fromJs(source: any): MessageTemplateRootFilterModelObservableIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new MessageTemplateRootFilterModelObservableIdentityDTO(source.Id);
    }

}

export class MessageTemplateRootFilterModelObservableSimpleDTO extends BaseObservableAbstractDTO {
    public __type = 'MessageTemplateRootFilterModelObservableSimpleDTO';

    private _messagetemplaterootfiltermodelobservablesimpledto: string;

    public WithUntyped = observable<boolean>(true);

    public static fromJs(source: IMessageTemplateRootFilterModelSimpleDTO): MessageTemplateRootFilterModelObservableSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new MessageTemplateRootFilterModelObservableSimpleDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IMessageTemplateRootFilterModelSimpleDTO): void {
        super.fromJs(source);
        this.WithUntyped(source.WithUntyped);
    }

    public toJs(): MessageTemplateRootFilterModelSimpleDTO {
        let e = new MessageTemplateRootFilterModelSimpleDTO();
        e.fromObservable(this);
        return e;
    }

    public toStrict(): MessageTemplateRootFilterModelStrictDTO {
        let e = new MessageTemplateRootFilterModelSimpleDTO();
        e.fromObservable(this);
        return e.toStrict();
    }
...
export class MessageTemplateRootFilterModelObservableFullDTO extends MessageTemplateRootFilterModelObservableSimpleDTO {
    public __type = 'MessageTemplateRootFilterModelObservableFullDTO';

    private _messagetemplaterootfiltermodelobservablefulldto: string;

    public DomainType = observable<DomainTypeObservableSimpleDTO>();

    public TargetSystem = observable<TargetSystemObservableSimpleDTO>();

    public static fromJs(source: IMessageTemplateRootFilterModelFullDTO): MessageTemplateRootFilterModelObservableFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new MessageTemplateRootFilterModelObservableFullDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IMessageTemplateRootFilterModelFullDTO): void {
        super.fromJs(source);
        this.DomainType(DomainTypeObservableSimpleDTO.fromJs(source.DomainType));
        this.TargetSystem(TargetSystemObservableSimpleDTO.fromJs(source.TargetSystem));
    }

    public toJs(): MessageTemplateRootFilterModelFullDTO {
        let e = new MessageTemplateRootFilterModelFullDTO();
        e.fromObservable(this);
        return e;
    }
...
export class MessageTemplateRootFilterModelObservableRichDTO extends MessageTemplateRootFilterModelObservableFullDTO {
    public __type = 'MessageTemplateRootFilterModelObservableRichDTO';

    private _messagetemplaterootfiltermodelobservablerichdto: string;

    public static fromJs(source: IMessageTemplateRootFilterModelRichDTO): MessageTemplateRootFilterModelObservableRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new MessageTemplateRootFilterModelObservableRichDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IMessageTemplateRootFilterModelRichDTO): void {
        super.fromJs(source);
    }

    public toJs(): MessageTemplateRootFilterModelRichDTO {
        let e = new MessageTemplateRootFilterModelRichDTO();
        e.fromObservable(this);
        return e;
    }
...
export class RegularJobRevisionFilterModelObservableIdentityDTO {
    public Id: Guid;
    ...
    public static fromJs(source: any): RegularJobRevisionFilterModelObservableIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new RegularJobRevisionFilterModelObservableIdentityDTO(source.Id);
    }

}

export class RegularJobRevisionFilterModelObservableSimpleDTO extends BaseObservableAbstractDTO {
    public __type = 'RegularJobRevisionFilterModelObservableSimpleDTO';

    private _regularjobrevisionfiltermodelobservablesimpledto: string;

    public CountingEntities = observable<number>();

    public static fromJs(source: IRegularJobRevisionFilterModelSimpleDTO): RegularJobRevisionFilterModelObservableSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RegularJobRevisionFilterModelObservableSimpleDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IRegularJobRevisionFilterModelSimpleDTO): void {
        super.fromJs(source);
        this.CountingEntities(source.CountingEntities);
    }

    public toJs(): RegularJobRevisionFilterModelSimpleDTO {
        let e = new RegularJobRevisionFilterModelSimpleDTO();
        e.fromObservable(this);
        return e;
    }

    public toStrict(): RegularJobRevisionFilterModelStrictDTO {
        let e = new RegularJobRevisionFilterModelSimpleDTO();
        e.fromObservable(this);
        return e.toStrict();
    }
...
export class RegularJobRevisionFilterModelObservableFullDTO extends RegularJobRevisionFilterModelObservableSimpleDTO {
    public __type = 'RegularJobRevisionFilterModelObservableFullDTO';

    private _regularjobrevisionfiltermodelobservablefulldto: string;

    public RegularJob = observable<RegularJobObservableSimpleDTO>();

    public static fromJs(source: IRegularJobRevisionFilterModelFullDTO): RegularJobRevisionFilterModelObservableFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RegularJobRevisionFilterModelObservableFullDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IRegularJobRevisionFilterModelFullDTO): void {
        super.fromJs(source);
        this.RegularJob(RegularJobObservableSimpleDTO.fromJs(source.RegularJob));
    }

    public toJs(): RegularJobRevisionFilterModelFullDTO {
        let e = new RegularJobRevisionFilterModelFullDTO();
        e.fromObservable(this);
        return e;
    }
...
export class RegularJobRevisionFilterModelObservableRichDTO extends RegularJobRevisionFilterModelObservableFullDTO {
    public __type = 'RegularJobRevisionFilterModelObservableRichDTO';

    private _regularjobrevisionfiltermodelobservablerichdto: string;

    public static fromJs(source: IRegularJobRevisionFilterModelRichDTO): RegularJobRevisionFilterModelObservableRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RegularJobRevisionFilterModelObservableRichDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IRegularJobRevisionFilterModelRichDTO): void {
        super.fromJs(source);
    }

    public toJs(): RegularJobRevisionFilterModelRichDTO {
        let e = new RegularJobRevisionFilterModelRichDTO();
        e.fromObservable(this);
        return e;
    }
...
export class RegularJobObservableIdentityDTO {
    public Id: Guid;
    ...
    public static fromJs(source: any): RegularJobObservableIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new RegularJobObservableIdentityDTO(source.Id);
    }

}

export class RegularJobObservableSimpleDTO extends BaseObservableAuditPersistentDTO {
    public __type = 'RegularJobObservableSimpleDTO';

    private _regularjobobservablesimpledto: string;

    public ExpectedNextStartTime = observable<Date>();

    public Function = observable<string>();

    public LastPulseTime = observable<Date>();

    public Name = observable<string>();

    public ShedulerTime = observable<ShedulerTime>();

    public State = observable<RegularJobState>();

    public Version = observable<number>();

    public WrapUpSession = observable<boolean>(false);

    public static fromJs(source: IRegularJobSimpleDTO): RegularJobObservableSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RegularJobObservableSimpleDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IRegularJobSimpleDTO): void {
        super.fromJs(source);
        this.ExpectedNextStartTime(Convert.toDate(source.ExpectedNextStartTime));
        this.Function(source.Function);
        this.LastPulseTime(Convert.toDate(source.LastPulseTime));
        this.Name(source.Name);
        this.ShedulerTime(ShedulerTime.fromJs(source.ShedulerTime));
        this.State(source.State);
        this.Version(source.Version);
        this.WrapUpSession(source.WrapUpSession);
    }

    public identity(): RegularJobIdentityDTO {
        return new RegularJobIdentityDTO(this.Id());
    }

    public toJs(): RegularJobSimpleDTO {
        let e = new RegularJobSimpleDTO();
        e.fromObservable(this);
        return e;
    }

    public toStrict(): RegularJobStrictDTO {
        let e = new RegularJobSimpleDTO();
        e.fromObservable(this);
        return e.toStrict();
    }
...
export class RegularJobObservableFullDTO extends RegularJobObservableSimpleDTO {
    public __type = 'RegularJobObservableFullDTO';

    private _regularjobobservablefulldto: string;

    public ExecutionResult = observable<ExecuteRegularJobResultObservableSimpleDTO>();

    public static fromJs(source: IRegularJobFullDTO): RegularJobObservableFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RegularJobObservableFullDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IRegularJobFullDTO): void {
        super.fromJs(source);
        this.ExecutionResult(ExecuteRegularJobResultObservableSimpleDTO.fromJs(source.ExecutionResult));
    }

    public toJs(): RegularJobFullDTO {
        let e = new RegularJobFullDTO();
        e.fromObservable(this);
        return e;
    }
...
export class RegularJobObservableRichDTO extends RegularJobObservableFullDTO {
    public __type = 'RegularJobObservableRichDTO';

    private _regularjobobservablerichdto: string;

    public static fromJs(source: IRegularJobRichDTO): RegularJobObservableRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RegularJobObservableRichDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IRegularJobRichDTO): void {
        super.fromJs(source);
    }

    public toJs(): RegularJobRichDTO {
        let e = new RegularJobRichDTO();
        e.fromObservable(this);
        return e;
    }
...
export class RegularJobObservableVisualDTO extends BaseObservablePersistentDTO {
    public __type = 'RegularJobObservableVisualDTO';

    private _regularjobobservablevisualdto: string;
    ...
    public static fromJs(source: IBasePersistentDTO): RegularJobObservableVisualDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RegularJobObservableVisualDTO();
        e.fromJs(source);
        return e;
    }
    ...
    public toJs(): RegularJobVisualDTO {
        let e = new RegularJobVisualDTO();
        e.fromObservable(this);
        return e;
    }
...
export class RegularJobRevisionModelObservableIdentityDTO {
    public Id: Guid;
    ...
    public static fromJs(source: any): RegularJobRevisionModelObservableIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new RegularJobRevisionModelObservableIdentityDTO(source.Id);
    }

}

export class RegularJobRevisionModelObservableSimpleDTO extends BaseObservableAbstractDTO {
    public __type = 'RegularJobRevisionModelObservableSimpleDTO';

    private _regularjobrevisionmodelobservablesimpledto: string;

    public RevisionNumber = observable<number>();

    public static fromJs(source: IRegularJobRevisionModelSimpleDTO): RegularJobRevisionModelObservableSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RegularJobRevisionModelObservableSimpleDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IRegularJobRevisionModelSimpleDTO): void {
        super.fromJs(source);
        this.RevisionNumber(source.RevisionNumber);
    }

    public toJs(): RegularJobRevisionModelSimpleDTO {
        let e = new RegularJobRevisionModelSimpleDTO();
        e.fromObservable(this);
        return e;
    }

    public toStrict(): RegularJobRevisionModelStrictDTO {
        let e = new RegularJobRevisionModelSimpleDTO();
        e.fromObservable(this);
        return e.toStrict();
    }
...
export class RegularJobRevisionModelObservableFullDTO extends RegularJobRevisionModelObservableSimpleDTO {
    public __type = 'RegularJobRevisionModelObservableFullDTO';

    private _regularjobrevisionmodelobservablefulldto: string;

    public ExecutionResult = observable<ExecuteRegularJobResultObservableSimpleDTO>();

    public ExtendedObject = observable<RegularJobObservableSimpleDTO>();

    public static fromJs(source: IRegularJobRevisionModelFullDTO): RegularJobRevisionModelObservableFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RegularJobRevisionModelObservableFullDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IRegularJobRevisionModelFullDTO): void {
        super.fromJs(source);
        this.ExecutionResult(ExecuteRegularJobResultObservableSimpleDTO.fromJs(source.ExecutionResult));
        this.ExtendedObject(RegularJobObservableSimpleDTO.fromJs(source.ExtendedObject));
    }

    public toJs(): RegularJobRevisionModelFullDTO {
        let e = new RegularJobRevisionModelFullDTO();
        e.fromObservable(this);
        return e;
    }
...
export class RegularJobRevisionModelObservableRichDTO extends RegularJobRevisionModelObservableFullDTO {
    public __type = 'RegularJobRevisionModelObservableRichDTO';

    private _regularjobrevisionmodelobservablerichdto: string;

    public static fromJs(source: IRegularJobRevisionModelRichDTO): RegularJobRevisionModelObservableRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RegularJobRevisionModelObservableRichDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IRegularJobRevisionModelRichDTO): void {
        super.fromJs(source);
    }

    public toJs(): RegularJobRevisionModelRichDTO {
        let e = new RegularJobRevisionModelRichDTO();
        e.fromObservable(this);
        return e;
    }
...
export class RunRegularJobModelObservableIdentityDTO {
    public Id: Guid;
    ...
    public static fromJs(source: any): RunRegularJobModelObservableIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new RunRegularJobModelObservableIdentityDTO(source.Id);
    }

}

export class RunRegularJobModelObservableSimpleDTO extends BaseObservableAbstractDTO {
    public __type = 'RunRegularJobModelObservableSimpleDTO';

    private _runregularjobmodelobservablesimpledto: string;

    public InstanceServerName = observable<string>();

    public Mode = observable<RunRegularJobMode>();

    public static fromJs(source: IRunRegularJobModelSimpleDTO): RunRegularJobModelObservableSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RunRegularJobModelObservableSimpleDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IRunRegularJobModelSimpleDTO): void {
        super.fromJs(source);
        this.InstanceServerName(source.InstanceServerName);
        this.Mode(source.Mode);
    }

    public toJs(): RunRegularJobModelSimpleDTO {
        let e = new RunRegularJobModelSimpleDTO();
        e.fromObservable(this);
        return e;
    }

    public toStrict(): RunRegularJobModelStrictDTO {
        let e = new RunRegularJobModelSimpleDTO();
        e.fromObservable(this);
        return e.toStrict();
    }
...
export class RunRegularJobModelObservableFullDTO extends RunRegularJobModelObservableSimpleDTO {
    public __type = 'RunRegularJobModelObservableFullDTO';

    private _runregularjobmodelobservablefulldto: string;

    public RegularJob = observable<RegularJobObservableSimpleDTO>();

    public static fromJs(source: IRunRegularJobModelFullDTO): RunRegularJobModelObservableFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RunRegularJobModelObservableFullDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IRunRegularJobModelFullDTO): void {
        super.fromJs(source);
        this.RegularJob(RegularJobObservableSimpleDTO.fromJs(source.RegularJob));
    }

    public toJs(): RunRegularJobModelFullDTO {
        let e = new RunRegularJobModelFullDTO();
        e.fromObservable(this);
        return e;
    }
...
export class RunRegularJobModelObservableRichDTO extends RunRegularJobModelObservableFullDTO {
    public __type = 'RunRegularJobModelObservableRichDTO';

    private _runregularjobmodelobservablerichdto: string;

    public static fromJs(source: IRunRegularJobModelRichDTO): RunRegularJobModelObservableRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RunRegularJobModelObservableRichDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: IRunRegularJobModelRichDTO): void {
        super.fromJs(source);
    }

    public toJs(): RunRegularJobModelRichDTO {
        let e = new RunRegularJobModelRichDTO();
        e.fromObservable(this);
        return e;
    }
...
export class SubBusinessRoleObservableIdentityDTO {
    public Id: Guid;
    ...
    public static fromJs(source: any): SubBusinessRoleObservableIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new SubBusinessRoleObservableIdentityDTO(source.Id);
    }

}

export class SubBusinessRoleObservableSimpleDTO extends BaseObservableAuditPersistentDTO {
    public __type = 'SubBusinessRoleObservableSimpleDTO';

    private _subbusinessroleobservablesimpledto: string;

    public BusinessRoleId = observable<Guid>();

    public Name = observable<string>();

    public static fromJs(source: ISubBusinessRoleSimpleDTO): SubBusinessRoleObservableSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubBusinessRoleObservableSimpleDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubBusinessRoleSimpleDTO): void {
        super.fromJs(source);
        this.BusinessRoleId(source.BusinessRoleId);
        this.Name(source.Name);
    }

    public identity(): SubBusinessRoleIdentityDTO {
        return new SubBusinessRoleIdentityDTO(this.Id());
    }

    public toJs(): SubBusinessRoleSimpleDTO {
        let e = new SubBusinessRoleSimpleDTO();
        e.fromObservable(this);
        return e;
    }

    public toStrict(): SubBusinessRoleStrictDTO {
        let e = new SubBusinessRoleSimpleDTO();
        e.fromObservable(this);
        return e.toStrict();
    }
...
export class SubBusinessRoleObservableFullDTO extends SubBusinessRoleObservableSimpleDTO {
    public __type = 'SubBusinessRoleObservableFullDTO';

    private _subbusinessroleobservablefulldto: string;

    public Subscription = observable<SubscriptionObservableSimpleDTO>();

    public static fromJs(source: ISubBusinessRoleFullDTO): SubBusinessRoleObservableFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubBusinessRoleObservableFullDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubBusinessRoleFullDTO): void {
        super.fromJs(source);
        this.Subscription(SubscriptionObservableSimpleDTO.fromJs(source.Subscription));
    }

    public toJs(): SubBusinessRoleFullDTO {
        let e = new SubBusinessRoleFullDTO();
        e.fromObservable(this);
        return e;
    }
...
export class SubBusinessRoleObservableRichDTO extends SubBusinessRoleObservableFullDTO {
    public __type = 'SubBusinessRoleObservableRichDTO';

    private _subbusinessroleobservablerichdto: string;

    public static fromJs(source: ISubBusinessRoleRichDTO): SubBusinessRoleObservableRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubBusinessRoleObservableRichDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubBusinessRoleRichDTO): void {
        super.fromJs(source);
    }

    public toJs(): SubBusinessRoleRichDTO {
        let e = new SubBusinessRoleRichDTO();
        e.fromObservable(this);
        return e;
    }
...
export class SubscriptionObservableIdentityDTO {
    public Id: Guid;
    ...
    public static fromJs(source: any): SubscriptionObservableIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new SubscriptionObservableIdentityDTO(source.Id);
    }

}

export class SubscriptionObservableSimpleDTO extends BaseObservableAuditPersistentDTO {
    public __type = 'SubscriptionObservableSimpleDTO';

    private _subscriptionobservablesimpledto: string;

    public AllowEmptyListOfRecipients = observable<boolean>(false);

    public Code = observable<string>();

    public DynamicSourceExpandType = observable<NotificationExpandType>();

    public ExcludeCurrentUser = observable<boolean>(false);

    public IncludeAttachments = observable<boolean>(false);

    public RecepientsMode = observable<RecepientsSelectorMode>();

    public SenderEmail = observable<string>();

    public SenderName = observable<string>();

    public SendIndividualLetters = observable<boolean>(false);

    public static fromJs(source: ISubscriptionSimpleDTO): SubscriptionObservableSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionObservableSimpleDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionSimpleDTO): void {
        super.fromJs(source);
    ...
    public identity(): SubscriptionIdentityDTO {
        return new SubscriptionIdentityDTO(this.Id());
    }

    public toJs(): SubscriptionSimpleDTO {
        let e = new SubscriptionSimpleDTO();
        e.fromObservable(this);
        return e;
    }

    public toStrict(): SubscriptionStrictDTO {
        let e = new SubscriptionSimpleDTO();
        e.fromObservable(this);
        return e.toStrict();
    }
...
export class SubscriptionObservableFullDTO extends SubscriptionObservableSimpleDTO {
    public __type = 'SubscriptionObservableFullDTO';

    private _subscriptionobservablefulldto: string;

    public Condition = observable<SubscriptionLambdaObservableSimpleDTO>();

    public CopyGeneration = observable<SubscriptionLambdaObservableSimpleDTO>();

    public DomainType = observable<DomainTypeObservableSimpleDTO>();

    public DynamicSource = observable<SubscriptionLambdaObservableSimpleDTO>();

    public Generation = observable<SubscriptionLambdaObservableSimpleDTO>();

    public MessageTemplate = observable<MessageTemplateObservableSimpleDTO>();

    public ReplyToGeneration = observable<SubscriptionLambdaObservableSimpleDTO>();

    public TargetSystem = observable<TargetSystemObservableSimpleDTO>();

    public static fromJs(source: ISubscriptionFullDTO): SubscriptionObservableFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionObservableFullDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionFullDTO): void {
        super.fromJs(source);
        this.Condition(SubscriptionLambdaObservableSimpleDTO.fromJs(source.Condition));
        this.CopyGeneration(SubscriptionLambdaObservableSimpleDTO.fromJs(source.CopyGeneration));
        this.DomainType(DomainTypeObservableSimpleDTO.fromJs(source.DomainType));
        this.DynamicSource(SubscriptionLambdaObservableSimpleDTO.fromJs(source.DynamicSource));
        this.Generation(SubscriptionLambdaObservableSimpleDTO.fromJs(source.Generation));
        this.MessageTemplate(MessageTemplateObservableSimpleDTO.fromJs(source.MessageTemplate));
        this.ReplyToGeneration(SubscriptionLambdaObservableSimpleDTO.fromJs(source.ReplyToGeneration));
        this.TargetSystem(TargetSystemObservableSimpleDTO.fromJs(source.TargetSystem));
    }

    public toJs(): SubscriptionFullDTO {
        let e = new SubscriptionFullDTO();
        e.fromObservable(this);
        return e;
    }
...
export class SubscriptionObservableRichDTO extends SubscriptionObservableFullDTO {
    public __type = 'SubscriptionObservableRichDTO';

    private _subscriptionobservablerichdto: string;

    public SecurityItems = observableArray<SubscriptionSecurityItemObservableRichDTO>();

    public SubBusinessRoles = observableArray<SubBusinessRoleObservableRichDTO>();

    public static fromJs(source: ISubscriptionRichDTO): SubscriptionObservableRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionObservableRichDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionRichDTO): void {
        super.fromJs(source);
        if (source.SecurityItems) {
            this.SecurityItems(source.SecurityItems.map(e => {
                    return SubscriptionSecurityItemObservableRichDTO.fromJs(e);
                }));
        }
        if (source.SubBusinessRoles) {
            this.SubBusinessRoles(source.SubBusinessRoles.map(e => {
                    return SubBusinessRoleObservableRichDTO.fromJs(e);
                }));
        }
    }

    public toJs(): SubscriptionRichDTO {
        let e = new SubscriptionRichDTO();
        e.fromObservable(this);
        return e;
    }
...
export class SubscriptionObservableVisualDTO extends BaseObservablePersistentDTO {
    public __type = 'SubscriptionObservableVisualDTO';

    private _subscriptionobservablevisualdto: string;
    ...
    public static fromJs(source: IBasePersistentDTO): SubscriptionObservableVisualDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionObservableVisualDTO();
        e.fromJs(source);
        return e;
    }
    ...
    public toJs(): SubscriptionVisualDTO {
        let e = new SubscriptionVisualDTO();
        e.fromObservable(this);
        return e;
    }
...
export class SubscriptionContainerObservableIdentityDTO {
    public Id: Guid;
    ...
    public static fromJs(source: any): SubscriptionContainerObservableIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new SubscriptionContainerObservableIdentityDTO(source.Id);
    }

}

export class SubscriptionContainerObservableSimpleDTO extends BaseObservableAbstractDTO {
    public __type = 'SubscriptionContainerObservableSimpleDTO';

    private _subscriptioncontainerobservablesimpledto: string;

    public static fromJs(source: ISubscriptionContainerSimpleDTO): SubscriptionContainerObservableSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionContainerObservableSimpleDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionContainerSimpleDTO): void {
        super.fromJs(source);
    }

    public toJs(): SubscriptionContainerSimpleDTO {
        let e = new SubscriptionContainerSimpleDTO();
        e.fromObservable(this);
        return e;
    }

    public toStrict(): SubscriptionContainerStrictDTO {
        let e = new SubscriptionContainerSimpleDTO();
        e.fromObservable(this);
        return e.toStrict();
    }
...
export class SubscriptionContainerObservableFullDTO extends SubscriptionContainerObservableSimpleDTO {
    public __type = 'SubscriptionContainerObservableFullDTO';

    private _subscriptioncontainerobservablefulldto: string;

    public static fromJs(source: ISubscriptionContainerFullDTO): SubscriptionContainerObservableFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionContainerObservableFullDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionContainerFullDTO): void {
        super.fromJs(source);
    }

    public toJs(): SubscriptionContainerFullDTO {
        let e = new SubscriptionContainerFullDTO();
        e.fromObservable(this);
        return e;
    }
...
export class SubscriptionContainerObservableRichDTO extends SubscriptionContainerObservableFullDTO {
    public __type = 'SubscriptionContainerObservableRichDTO';

    private _subscriptioncontainerobservablerichdto: string;

    public AttachmentContainers = observableArray<AttachmentContainerObservableRichDTO>();

    public Lambdas = observableArray<SubscriptionLambdaObservableRichDTO>();

    public MessageTemplates = observableArray<MessageTemplateObservableRichDTO>();

    public Subscriptions = observableArray<SubscriptionObservableRichDTO>();

    public static fromJs(source: ISubscriptionContainerRichDTO): SubscriptionContainerObservableRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionContainerObservableRichDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionContainerRichDTO): void {
        super.fromJs(source);
        if (source.AttachmentContainers) {
            this.AttachmentContainers(source.AttachmentContainers.map(e => {
                    return AttachmentContainerObservableRichDTO.fromJs(e);
                }));
        }
        if (source.Lambdas) {
            this.Lambdas(source.Lambdas.map(e => {
                    return SubscriptionLambdaObservableRichDTO.fromJs(e);
                }));
        }
        if (source.MessageTemplates) {
            this.MessageTemplates(source.MessageTemplates.map(e => {
                    return MessageTemplateObservableRichDTO.fromJs(e);
                }));
        }
        if (source.Subscriptions) {
            this.Subscriptions(source.Subscriptions.map(e => {
                    return SubscriptionObservableRichDTO.fromJs(e);
                }));
        }
    }

    public toJs(): SubscriptionContainerRichDTO {
        let e = new SubscriptionContainerRichDTO();
        e.fromObservable(this);
        return e;
    }
...
export class SubscriptionCreateModelObservableIdentityDTO {
    public Id: Guid;
    ...
    public static fromJs(source: any): SubscriptionCreateModelObservableIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new SubscriptionCreateModelObservableIdentityDTO(source.Id);
    }

}

export class SubscriptionCreateModelObservableSimpleDTO extends BaseObservableAbstractDTO {
    public __type = 'SubscriptionCreateModelObservableSimpleDTO';

    private _subscriptioncreatemodelobservablesimpledto: string;

    public static fromJs(source: ISubscriptionCreateModelSimpleDTO): SubscriptionCreateModelObservableSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionCreateModelObservableSimpleDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionCreateModelSimpleDTO): void {
        super.fromJs(source);
    }

    public toJs(): SubscriptionCreateModelSimpleDTO {
        let e = new SubscriptionCreateModelSimpleDTO();
        e.fromObservable(this);
        return e;
    }

    public toStrict(): SubscriptionCreateModelStrictDTO {
        let e = new SubscriptionCreateModelSimpleDTO();
        e.fromObservable(this);
        return e.toStrict();
    }
...
export class SubscriptionCreateModelObservableFullDTO extends SubscriptionCreateModelObservableSimpleDTO {
    public __type = 'SubscriptionCreateModelObservableFullDTO';

    private _subscriptioncreatemodelobservablefulldto: string;

    public static fromJs(source: ISubscriptionCreateModelFullDTO): SubscriptionCreateModelObservableFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionCreateModelObservableFullDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionCreateModelFullDTO): void {
        super.fromJs(source);
    }

    public toJs(): SubscriptionCreateModelFullDTO {
        let e = new SubscriptionCreateModelFullDTO();
        e.fromObservable(this);
        return e;
    }
...
export class SubscriptionCreateModelObservableRichDTO extends SubscriptionCreateModelObservableFullDTO {
    public __type = 'SubscriptionCreateModelObservableRichDTO';

    private _subscriptioncreatemodelobservablerichdto: string;

    public static fromJs(source: ISubscriptionCreateModelRichDTO): SubscriptionCreateModelObservableRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionCreateModelObservableRichDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionCreateModelRichDTO): void {
        super.fromJs(source);
    }

    public toJs(): SubscriptionCreateModelRichDTO {
        let e = new SubscriptionCreateModelRichDTO();
        e.fromObservable(this);
        return e;
    }
...
export class SubscriptionLambdaObservableIdentityDTO {
    public Id: Guid;
    ...
    public static fromJs(source: any): SubscriptionLambdaObservableIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new SubscriptionLambdaObservableIdentityDTO(source.Id);
    }

}

export class SubscriptionLambdaObservableSimpleDTO extends BaseObservableAuditPersistentDTO {
    public __type = 'SubscriptionLambdaObservableSimpleDTO';

    private _subscriptionlambdaobservablesimpledto: string;

    public AuthDomainTypeId = observable<Guid>();

    public FormattedType = observable<string>();

    public Name = observable<string>();

    public ProcessType = observable<SubscriptionType>();

    public RequiredModeNext = observable<boolean>();

    public RequiredModePrev = observable<boolean>();

    public Type = observable<SubscriptionLambdaType>();

    public Value = observable<string>();

    public WithContext = observable<boolean>(false);

    public static fromJs(source: ISubscriptionLambdaSimpleDTO): SubscriptionLambdaObservableSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionLambdaObservableSimpleDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionLambdaSimpleDTO): void {
        super.fromJs(source);
    ...
    public identity(): SubscriptionLambdaIdentityDTO {
        return new SubscriptionLambdaIdentityDTO(this.Id());
    }

    public toJs(): SubscriptionLambdaSimpleDTO {
        let e = new SubscriptionLambdaSimpleDTO();
        e.fromObservable(this);
        return e;
    }

    public toStrict(): SubscriptionLambdaStrictDTO {
        let e = new SubscriptionLambdaSimpleDTO();
        e.fromObservable(this);
        return e.toStrict();
    }
...
export class SubscriptionLambdaObservableFullDTO extends SubscriptionLambdaObservableSimpleDTO {
    public __type = 'SubscriptionLambdaObservableFullDTO';

    private _subscriptionlambdaobservablefulldto: string;

    public DomainType = observable<DomainTypeObservableSimpleDTO>();

    public TargetSystem = observable<TargetSystemObservableSimpleDTO>();

    public static fromJs(source: ISubscriptionLambdaFullDTO): SubscriptionLambdaObservableFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionLambdaObservableFullDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionLambdaFullDTO): void {
        super.fromJs(source);
        this.DomainType(DomainTypeObservableSimpleDTO.fromJs(source.DomainType));
        this.TargetSystem(TargetSystemObservableSimpleDTO.fromJs(source.TargetSystem));
    }

    public toJs(): SubscriptionLambdaFullDTO {
        let e = new SubscriptionLambdaFullDTO();
        e.fromObservable(this);
        return e;
    }
...
export class SubscriptionLambdaObservableRichDTO extends SubscriptionLambdaObservableFullDTO {
    public __type = 'SubscriptionLambdaObservableRichDTO';

    private _subscriptionlambdaobservablerichdto: string;

    public static fromJs(source: ISubscriptionLambdaRichDTO): SubscriptionLambdaObservableRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionLambdaObservableRichDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionLambdaRichDTO): void {
        super.fromJs(source);
    }

    public toJs(): SubscriptionLambdaRichDTO {
        let e = new SubscriptionLambdaRichDTO();
        e.fromObservable(this);
        return e;
    }
...
export class SubscriptionLambdaObservableVisualDTO extends BaseObservablePersistentDTO {
    public __type = 'SubscriptionLambdaObservableVisualDTO';

    private _subscriptionlambdaobservablevisualdto: string;
    ...
    public static fromJs(source: IBasePersistentDTO): SubscriptionLambdaObservableVisualDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionLambdaObservableVisualDTO();
        e.fromJs(source);
        return e;
    }
    ...
    public toJs(): SubscriptionLambdaVisualDTO {
        let e = new SubscriptionLambdaVisualDTO();
        e.fromObservable(this);
        return e;
    }
...
export class SubscriptionLambdaCreateModelObservableIdentityDTO {
    public Id: Guid;
    ...
    public static fromJs(source: any): SubscriptionLambdaCreateModelObservableIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new SubscriptionLambdaCreateModelObservableIdentityDTO(source.Id);
    }

}

export class SubscriptionLambdaCreateModelObservableSimpleDTO extends BaseObservableAbstractDTO {
    public __type = 'SubscriptionLambdaCreateModelObservableSimpleDTO';

    private _subscriptionlambdacreatemodelobservablesimpledto: string;

    public static fromJs(source: ISubscriptionLambdaCreateModelSimpleDTO): SubscriptionLambdaCreateModelObservableSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionLambdaCreateModelObservableSimpleDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionLambdaCreateModelSimpleDTO): void {
        super.fromJs(source);
    }

    public toJs(): SubscriptionLambdaCreateModelSimpleDTO {
        let e = new SubscriptionLambdaCreateModelSimpleDTO();
        e.fromObservable(this);
        return e;
    }

    public toStrict(): SubscriptionLambdaCreateModelStrictDTO {
        let e = new SubscriptionLambdaCreateModelSimpleDTO();
        e.fromObservable(this);
        return e.toStrict();
    }
...
export class SubscriptionLambdaCreateModelObservableFullDTO extends SubscriptionLambdaCreateModelObservableSimpleDTO {
    public __type = 'SubscriptionLambdaCreateModelObservableFullDTO';

    private _subscriptionlambdacreatemodelobservablefulldto: string;

    public static fromJs(source: ISubscriptionLambdaCreateModelFullDTO): SubscriptionLambdaCreateModelObservableFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionLambdaCreateModelObservableFullDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionLambdaCreateModelFullDTO): void {
        super.fromJs(source);
    }

    public toJs(): SubscriptionLambdaCreateModelFullDTO {
        let e = new SubscriptionLambdaCreateModelFullDTO();
        e.fromObservable(this);
        return e;
    }
...
export class SubscriptionLambdaCreateModelObservableRichDTO extends SubscriptionLambdaCreateModelObservableFullDTO {
    public __type = 'SubscriptionLambdaCreateModelObservableRichDTO';

    private _subscriptionlambdacreatemodelobservablerichdto: string;

    public static fromJs(source: ISubscriptionLambdaCreateModelRichDTO): SubscriptionLambdaCreateModelObservableRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionLambdaCreateModelObservableRichDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionLambdaCreateModelRichDTO): void {
        super.fromJs(source);
    }

    public toJs(): SubscriptionLambdaCreateModelRichDTO {
        let e = new SubscriptionLambdaCreateModelRichDTO();
        e.fromObservable(this);
        return e;
    }
...
export class SubscriptionLambdaRootFilterModelObservableIdentityDTO {
    public Id: Guid;
    ...
    public static fromJs(source: any): SubscriptionLambdaRootFilterModelObservableIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new SubscriptionLambdaRootFilterModelObservableIdentityDTO(source.Id);
    }

}

export class SubscriptionLambdaRootFilterModelObservableSimpleDTO extends BaseObservableAbstractDTO {
    public __type = 'SubscriptionLambdaRootFilterModelObservableSimpleDTO';

    private _subscriptionlambdarootfiltermodelobservablesimpledto: string;

    public AuthDomainTypeId = observable<Guid>();

    public Type = observable<SubscriptionLambdaType>();

    public static fromJs(source: ISubscriptionLambdaRootFilterModelSimpleDTO): SubscriptionLambdaRootFilterModelObservableSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionLambdaRootFilterModelObservableSimpleDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionLambdaRootFilterModelSimpleDTO): void {
        super.fromJs(source);
        this.AuthDomainTypeId(source.AuthDomainTypeId);
        this.Type(source.Type);
    }

    public toJs(): SubscriptionLambdaRootFilterModelSimpleDTO {
        let e = new SubscriptionLambdaRootFilterModelSimpleDTO();
        e.fromObservable(this);
        return e;
    }

    public toStrict(): SubscriptionLambdaRootFilterModelStrictDTO {
        let e = new SubscriptionLambdaRootFilterModelSimpleDTO();
        e.fromObservable(this);
        return e.toStrict();
    }
...
export class SubscriptionLambdaRootFilterModelObservableFullDTO extends SubscriptionLambdaRootFilterModelObservableSimpleDTO {
    public __type = 'SubscriptionLambdaRootFilterModelObservableFullDTO';

    private _subscriptionlambdarootfiltermodelobservablefulldto: string;

    public DomainType = observable<DomainTypeObservableSimpleDTO>();

    public TargetSystem = observable<TargetSystemObservableSimpleDTO>();

    public static fromJs(source: ISubscriptionLambdaRootFilterModelFullDTO): SubscriptionLambdaRootFilterModelObservableFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionLambdaRootFilterModelObservableFullDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionLambdaRootFilterModelFullDTO): void {
        super.fromJs(source);
        this.DomainType(DomainTypeObservableSimpleDTO.fromJs(source.DomainType));
        this.TargetSystem(TargetSystemObservableSimpleDTO.fromJs(source.TargetSystem));
    }

    public toJs(): SubscriptionLambdaRootFilterModelFullDTO {
        let e = new SubscriptionLambdaRootFilterModelFullDTO();
        e.fromObservable(this);
        return e;
    }
...
export class SubscriptionLambdaRootFilterModelObservableRichDTO extends SubscriptionLambdaRootFilterModelObservableFullDTO {
    public __type = 'SubscriptionLambdaRootFilterModelObservableRichDTO';

    private _subscriptionlambdarootfiltermodelobservablerichdto: string;

    public static fromJs(source: ISubscriptionLambdaRootFilterModelRichDTO): SubscriptionLambdaRootFilterModelObservableRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionLambdaRootFilterModelObservableRichDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionLambdaRootFilterModelRichDTO): void {
        super.fromJs(source);
    }

    public toJs(): SubscriptionLambdaRootFilterModelRichDTO {
        let e = new SubscriptionLambdaRootFilterModelRichDTO();
        e.fromObservable(this);
        return e;
    }
...
export class SubscriptionRootFilterModelObservableIdentityDTO {
    public Id: Guid;
    ...
    public static fromJs(source: any): SubscriptionRootFilterModelObservableIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new SubscriptionRootFilterModelObservableIdentityDTO(source.Id);
    }

}

export class SubscriptionRootFilterModelObservableSimpleDTO extends BaseObservableAbstractDTO {
    public __type = 'SubscriptionRootFilterModelObservableSimpleDTO';

    private _subscriptionrootfiltermodelobservablesimpledto: string;

    public static fromJs(source: ISubscriptionRootFilterModelSimpleDTO): SubscriptionRootFilterModelObservableSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionRootFilterModelObservableSimpleDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionRootFilterModelSimpleDTO): void {
        super.fromJs(source);
    }

    public toJs(): SubscriptionRootFilterModelSimpleDTO {
        let e = new SubscriptionRootFilterModelSimpleDTO();
        e.fromObservable(this);
        return e;
    }

    public toStrict(): SubscriptionRootFilterModelStrictDTO {
        let e = new SubscriptionRootFilterModelSimpleDTO();
        e.fromObservable(this);
        return e.toStrict();
    }
...
export class SubscriptionRootFilterModelObservableFullDTO extends SubscriptionRootFilterModelObservableSimpleDTO {
    public __type = 'SubscriptionRootFilterModelObservableFullDTO';

    private _subscriptionrootfiltermodelobservablefulldto: string;

    public DomainType = observable<DomainTypeObservableSimpleDTO>();

    public Lambda = observable<SubscriptionLambdaObservableSimpleDTO>();

    public MessageTemplate = observable<MessageTemplateObservableSimpleDTO>();

    public TargetSystem = observable<TargetSystemObservableSimpleDTO>();

    public static fromJs(source: ISubscriptionRootFilterModelFullDTO): SubscriptionRootFilterModelObservableFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionRootFilterModelObservableFullDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionRootFilterModelFullDTO): void {
        super.fromJs(source);
        this.DomainType(DomainTypeObservableSimpleDTO.fromJs(source.DomainType));
        this.Lambda(SubscriptionLambdaObservableSimpleDTO.fromJs(source.Lambda));
        this.MessageTemplate(MessageTemplateObservableSimpleDTO.fromJs(source.MessageTemplate));
        this.TargetSystem(TargetSystemObservableSimpleDTO.fromJs(source.TargetSystem));
    }

    public toJs(): SubscriptionRootFilterModelFullDTO {
        let e = new SubscriptionRootFilterModelFullDTO();
        e.fromObservable(this);
        return e;
    }
...
export class SubscriptionRootFilterModelObservableRichDTO extends SubscriptionRootFilterModelObservableFullDTO {
    public __type = 'SubscriptionRootFilterModelObservableRichDTO';

    private _subscriptionrootfiltermodelobservablerichdto: string;

    public static fromJs(source: ISubscriptionRootFilterModelRichDTO): SubscriptionRootFilterModelObservableRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionRootFilterModelObservableRichDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionRootFilterModelRichDTO): void {
        super.fromJs(source);
    }

    public toJs(): SubscriptionRootFilterModelRichDTO {
        let e = new SubscriptionRootFilterModelRichDTO();
        e.fromObservable(this);
        return e;
    }
...
export class SubscriptionSecurityItemObservableIdentityDTO {
    public Id: Guid;
    ...
    public static fromJs(source: any): SubscriptionSecurityItemObservableIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new SubscriptionSecurityItemObservableIdentityDTO(source.Id);
    }

}

export class SubscriptionSecurityItemObservableSimpleDTO extends BaseObservableAuditPersistentDTO {
    public __type = 'SubscriptionSecurityItemObservableSimpleDTO';

    private _subscriptionsecurityitemobservablesimpledto: string;

    public AuthDomainTypeId = observable<Guid>();

    public ExpandType = observable<NotificationExpandType>();

    public static fromJs(source: ISubscriptionSecurityItemSimpleDTO): SubscriptionSecurityItemObservableSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionSecurityItemObservableSimpleDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionSecurityItemSimpleDTO): void {
        super.fromJs(source);
        this.AuthDomainTypeId(source.AuthDomainTypeId);
        this.ExpandType(source.ExpandType);
    }

    public identity(): SubscriptionSecurityItemIdentityDTO {
        return new SubscriptionSecurityItemIdentityDTO(this.Id());
    }

    public toJs(): SubscriptionSecurityItemSimpleDTO {
        let e = new SubscriptionSecurityItemSimpleDTO();
        e.fromObservable(this);
        return e;
    }

    public toStrict(): SubscriptionSecurityItemStrictDTO {
        let e = new SubscriptionSecurityItemSimpleDTO();
        e.fromObservable(this);
        return e.toStrict();
    }
...
export class SubscriptionSecurityItemObservableFullDTO extends SubscriptionSecurityItemObservableSimpleDTO {
    public __type = 'SubscriptionSecurityItemObservableFullDTO';

    private _subscriptionsecurityitemobservablefulldto: string;

    public Source = observable<SubscriptionLambdaObservableSimpleDTO>();

    public Subscription = observable<SubscriptionObservableSimpleDTO>();

    public static fromJs(source: ISubscriptionSecurityItemFullDTO): SubscriptionSecurityItemObservableFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionSecurityItemObservableFullDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionSecurityItemFullDTO): void {
        super.fromJs(source);
        this.Source(SubscriptionLambdaObservableSimpleDTO.fromJs(source.Source));
        this.Subscription(SubscriptionObservableSimpleDTO.fromJs(source.Subscription));
    }

    public toJs(): SubscriptionSecurityItemFullDTO {
        let e = new SubscriptionSecurityItemFullDTO();
        e.fromObservable(this);
        return e;
    }
...
export class SubscriptionSecurityItemObservableRichDTO extends SubscriptionSecurityItemObservableFullDTO {
    public __type = 'SubscriptionSecurityItemObservableRichDTO';

    private _subscriptionsecurityitemobservablerichdto: string;

    public static fromJs(source: ISubscriptionSecurityItemRichDTO): SubscriptionSecurityItemObservableRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionSecurityItemObservableRichDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ISubscriptionSecurityItemRichDTO): void {
        super.fromJs(source);
    }

    public toJs(): SubscriptionSecurityItemRichDTO {
        let e = new SubscriptionSecurityItemRichDTO();
        e.fromObservable(this);
        return e;
    }
...
export class TestSubscriptionModelObservableIdentityDTO {
    public Id: Guid;
    ...
    public static fromJs(source: any): TestSubscriptionModelObservableIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new TestSubscriptionModelObservableIdentityDTO(source.Id);
    }

}

export class TestSubscriptionModelObservableSimpleDTO extends BaseObservableAbstractDTO {
    public __type = 'TestSubscriptionModelObservableSimpleDTO';

    private _testsubscriptionmodelobservablesimpledto: string;

    public DomainObjectId = observable<Guid>();

    public Revision = observable<number>();

    public static fromJs(source: ITestSubscriptionModelSimpleDTO): TestSubscriptionModelObservableSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new TestSubscriptionModelObservableSimpleDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ITestSubscriptionModelSimpleDTO): void {
        super.fromJs(source);
        this.DomainObjectId(source.DomainObjectId);
        this.Revision(source.Revision);
    }

    public toJs(): TestSubscriptionModelSimpleDTO {
        let e = new TestSubscriptionModelSimpleDTO();
        e.fromObservable(this);
        return e;
    }

    public toStrict(): TestSubscriptionModelStrictDTO {
        let e = new TestSubscriptionModelSimpleDTO();
        e.fromObservable(this);
        return e.toStrict();
    }
...
export class TestSubscriptionModelObservableFullDTO extends TestSubscriptionModelObservableSimpleDTO {
    public __type = 'TestSubscriptionModelObservableFullDTO';

    private _testsubscriptionmodelobservablefulldto: string;

    public Subscription = observable<SubscriptionObservableSimpleDTO>();

    public static fromJs(source: ITestSubscriptionModelFullDTO): TestSubscriptionModelObservableFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new TestSubscriptionModelObservableFullDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ITestSubscriptionModelFullDTO): void {
        super.fromJs(source);
        this.Subscription(SubscriptionObservableSimpleDTO.fromJs(source.Subscription));
    }

    public toJs(): TestSubscriptionModelFullDTO {
        let e = new TestSubscriptionModelFullDTO();
        e.fromObservable(this);
        return e;
    }
...
export class TestSubscriptionModelObservableRichDTO extends TestSubscriptionModelObservableFullDTO {
    public __type = 'TestSubscriptionModelObservableRichDTO';

    private _testsubscriptionmodelobservablerichdto: string;

    public static fromJs(source: ITestSubscriptionModelRichDTO): TestSubscriptionModelObservableRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new TestSubscriptionModelObservableRichDTO();
        e.fromJs(source);
        return e;
    }

    public fromJs(source: ITestSubscriptionModelRichDTO): void {
        super.fromJs(source);
    }

    public toJs(): TestSubscriptionModelRichDTO {
        let e = new TestSubscriptionModelRichDTO();
        e.fromObservable(this);
        return e;
    }
...
export class ExecuteRegularJobResultSimpleDTO extends BaseAbstractDTO {
    public __type = 'ExecuteRegularJobResultSimpleDTO';

    private _executeregularjobresultsimpledto: string;

    public Description: string;

    public ExecutionTime: number;

    public Status: RegularJobStatus;

    public Time: number;

    public static fromJs(source: IExecuteRegularJobResultSimpleDTO): ExecuteRegularJobResultSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new ExecuteRegularJobResultSimpleDTO();
    ...
    public fromObservable(source: ExecuteRegularJobResultObservableSimpleDTO): void {
        super.fromObservable(source);
        this.Description = unwrap(source.Description);
        this.ExecutionTime = unwrap(source.ExecutionTime);
        this.Status = unwrap(source.Status);
        this.Time = unwrap(source.Time);
    }

    public toObservable(): ExecuteRegularJobResultObservableSimpleDTO {
        let e = new ExecuteRegularJobResultObservableSimpleDTO();
        e.fromJs(this);
        return e;
    }
    ...
    public toStrict(): ExecuteRegularJobResultStrictDTO {
        let e = new ExecuteRegularJobResultStrictDTO();
        e.fromSimple(this);
        return e;
    }
...
export class ExecuteRegularJobResultFullDTO extends ExecuteRegularJobResultSimpleDTO {
    public __type = 'ExecuteRegularJobResultFullDTO';

    private _executeregularjobresultfulldto: string;

    public static fromJs(source: IExecuteRegularJobResultFullDTO): ExecuteRegularJobResultFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new ExecuteRegularJobResultFullDTO();
    ...
    public fromObservable(source: ExecuteRegularJobResultObservableFullDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): ExecuteRegularJobResultObservableFullDTO {
        let e = new ExecuteRegularJobResultObservableFullDTO();
        e.fromJs(this);
        return e;
    }
...
export class ExecuteRegularJobResultRichDTO extends ExecuteRegularJobResultFullDTO {
    public __type = 'ExecuteRegularJobResultRichDTO';

    private _executeregularjobresultrichdto: string;

    public static fromJs(source: IExecuteRegularJobResultRichDTO): ExecuteRegularJobResultRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new ExecuteRegularJobResultRichDTO();
    ...
    public fromObservable(source: ExecuteRegularJobResultObservableRichDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): ExecuteRegularJobResultObservableRichDTO {
        let e = new ExecuteRegularJobResultObservableRichDTO();
        e.fromJs(this);
        return e;
    }
...
export class ExecuteRegularJobResultIdentityDTO {
    public static Empty = new ExecuteRegularJobResultIdentityDTO(Guid.Empty);

    public __type = 'ExecuteRegularJobResultIdentityDTO';

    private _executeregularjobresultidentitydto: string;
    ...
    public static fromJs(source: any): ExecuteRegularJobResultIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new ExecuteRegularJobResultIdentityDTO(source.Id);
    }

    public toNativeJson(): ExecuteRegularJobResultIdentityDTO {
        return this;
    }
...
export class MessageTemplateSimpleDTO extends BaseAuditPersistentDTO {
    public __type = 'MessageTemplateSimpleDTO';

    private _messagetemplatesimpledto: string;
    ...
    public get Identity() : MessageTemplateIdentityDTO {
        return new MessageTemplateIdentityDTO(this.Id);
    }

    public static fromJs(source: IMessageTemplateSimpleDTO): MessageTemplateSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new MessageTemplateSimpleDTO();
    ...
    public fromObservable(source: MessageTemplateObservableSimpleDTO): void {
        super.fromObservable(source);
        this.Code = unwrap(source.Code);
        this.Comment = unwrap(source.Comment);
        this.Message = unwrap(source.Message);
        this.Renderer = unwrap(source.Renderer);
        this.Subject = unwrap(source.Subject);
    }

    public toObservable(): MessageTemplateObservableSimpleDTO {
        let e = new MessageTemplateObservableSimpleDTO();
        e.fromJs(this);
        return e;
    }
    ...
    public toStrict(): MessageTemplateStrictDTO {
        let e = new MessageTemplateStrictDTO();
        e.fromSimple(this);
        return e;
    }
...
export class MessageTemplateFullDTO extends MessageTemplateSimpleDTO {
    public __type = 'MessageTemplateFullDTO';

    private _messagetemplatefulldto: string;

    public DomainType: DomainTypeSimpleDTO;

    public TargetSystem: TargetSystemSimpleDTO;

    public static fromJs(source: IMessageTemplateFullDTO): MessageTemplateFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new MessageTemplateFullDTO();
    ...
    public fromObservable(source: MessageTemplateObservableFullDTO): void {
        super.fromObservable(source);
        if (unwrap(source.DomainType)) {
            this.DomainType = unwrap(source.DomainType).toJs();
        }
    ...
    public toObservable(): MessageTemplateObservableFullDTO {
        let e = new MessageTemplateObservableFullDTO();
        e.fromJs(this);
        return e;
    }
...
export class MessageTemplateRichDTO extends MessageTemplateFullDTO {
    public __type = 'MessageTemplateRichDTO';

    private _messagetemplaterichdto: string;

    public static fromJs(source: IMessageTemplateRichDTO): MessageTemplateRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new MessageTemplateRichDTO();
    ...
    public fromObservable(source: MessageTemplateObservableRichDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): MessageTemplateObservableRichDTO {
        let e = new MessageTemplateObservableRichDTO();
        e.fromJs(this);
        return e;
    }
...
export class MessageTemplateCreateModelSimpleDTO extends BaseAbstractDTO {
    public __type = 'MessageTemplateCreateModelSimpleDTO';

    private _messagetemplatecreatemodelsimpledto: string;

    public static fromJs(source: IMessageTemplateCreateModelSimpleDTO): MessageTemplateCreateModelSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new MessageTemplateCreateModelSimpleDTO();
    ...
    public fromObservable(source: MessageTemplateCreateModelObservableSimpleDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): MessageTemplateCreateModelObservableSimpleDTO {
        let e = new MessageTemplateCreateModelObservableSimpleDTO();
        e.fromJs(this);
        return e;
    }
    ...
    public toStrict(): MessageTemplateCreateModelStrictDTO {
        let e = new MessageTemplateCreateModelStrictDTO();
        e.fromSimple(this);
        return e;
    }
...
export class MessageTemplateCreateModelFullDTO extends MessageTemplateCreateModelSimpleDTO {
    public __type = 'MessageTemplateCreateModelFullDTO';

    private _messagetemplatecreatemodelfulldto: string;

    public static fromJs(source: IMessageTemplateCreateModelFullDTO): MessageTemplateCreateModelFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new MessageTemplateCreateModelFullDTO();
    ...
    public fromObservable(source: MessageTemplateCreateModelObservableFullDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): MessageTemplateCreateModelObservableFullDTO {
        let e = new MessageTemplateCreateModelObservableFullDTO();
        e.fromJs(this);
        return e;
    }
...
export class MessageTemplateCreateModelRichDTO extends MessageTemplateCreateModelFullDTO {
    public __type = 'MessageTemplateCreateModelRichDTO';

    private _messagetemplatecreatemodelrichdto: string;

    public static fromJs(source: IMessageTemplateCreateModelRichDTO): MessageTemplateCreateModelRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new MessageTemplateCreateModelRichDTO();
    ...
    public fromObservable(source: MessageTemplateCreateModelObservableRichDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): MessageTemplateCreateModelObservableRichDTO {
        let e = new MessageTemplateCreateModelObservableRichDTO();
        e.fromJs(this);
        return e;
    }
...
export class MessageTemplateCreateModelIdentityDTO {
    public static Empty = new MessageTemplateCreateModelIdentityDTO(Guid.Empty);

    public __type = 'MessageTemplateCreateModelIdentityDTO';

    private _messagetemplatecreatemodelidentitydto: string;
    ...
    public static fromJs(source: any): MessageTemplateCreateModelIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new MessageTemplateCreateModelIdentityDTO(source.Id);
    }

    public toNativeJson(): MessageTemplateCreateModelIdentityDTO {
        return this;
    }

}

export class MessageTemplateRootFilterModelSimpleDTO extends BaseAbstractDTO {
    public __type = 'MessageTemplateRootFilterModelSimpleDTO';

    private _messagetemplaterootfiltermodelsimpledto: string;

    public WithUntyped = true;

    public static fromJs(source: IMessageTemplateRootFilterModelSimpleDTO): MessageTemplateRootFilterModelSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new MessageTemplateRootFilterModelSimpleDTO();
    ...
    public fromObservable(source: MessageTemplateRootFilterModelObservableSimpleDTO): void {
        super.fromObservable(source);
        this.WithUntyped = unwrap(source.WithUntyped);
    }

    public toObservable(): MessageTemplateRootFilterModelObservableSimpleDTO {
        let e = new MessageTemplateRootFilterModelObservableSimpleDTO();
        e.fromJs(this);
        return e;
    }
    ...
    public toStrict(): MessageTemplateRootFilterModelStrictDTO {
        let e = new MessageTemplateRootFilterModelStrictDTO();
        e.fromSimple(this);
        return e;
    }
...
export class MessageTemplateRootFilterModelFullDTO extends MessageTemplateRootFilterModelSimpleDTO {
    public __type = 'MessageTemplateRootFilterModelFullDTO';

    private _messagetemplaterootfiltermodelfulldto: string;

    public DomainType: DomainTypeSimpleDTO;

    public TargetSystem: TargetSystemSimpleDTO;

    public static fromJs(source: IMessageTemplateRootFilterModelFullDTO): MessageTemplateRootFilterModelFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new MessageTemplateRootFilterModelFullDTO();
    ...
    public fromObservable(source: MessageTemplateRootFilterModelObservableFullDTO): void {
        super.fromObservable(source);
        if (unwrap(source.DomainType)) {
            this.DomainType = unwrap(source.DomainType).toJs();
        }
    ...
    public toObservable(): MessageTemplateRootFilterModelObservableFullDTO {
        let e = new MessageTemplateRootFilterModelObservableFullDTO();
        e.fromJs(this);
        return e;
    }
...
export class MessageTemplateRootFilterModelRichDTO extends MessageTemplateRootFilterModelFullDTO {
    public __type = 'MessageTemplateRootFilterModelRichDTO';

    private _messagetemplaterootfiltermodelrichdto: string;

    public static fromJs(source: IMessageTemplateRootFilterModelRichDTO): MessageTemplateRootFilterModelRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new MessageTemplateRootFilterModelRichDTO();
    ...
    public fromObservable(source: MessageTemplateRootFilterModelObservableRichDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): MessageTemplateRootFilterModelObservableRichDTO {
        let e = new MessageTemplateRootFilterModelObservableRichDTO();
        e.fromJs(this);
        return e;
    }
...
export class MessageTemplateRootFilterModelIdentityDTO {
    public static Empty = new MessageTemplateRootFilterModelIdentityDTO(Guid.Empty);

    public __type = 'MessageTemplateRootFilterModelIdentityDTO';

    private _messagetemplaterootfiltermodelidentitydto: string;
    ...
    public static fromJs(source: any): MessageTemplateRootFilterModelIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new MessageTemplateRootFilterModelIdentityDTO(source.Id);
    }

    public toNativeJson(): MessageTemplateRootFilterModelIdentityDTO {
        return this;
    }
...
export class RegularJobRevisionFilterModelSimpleDTO extends BaseAbstractDTO {
    public __type = 'RegularJobRevisionFilterModelSimpleDTO';

    private _regularjobrevisionfiltermodelsimpledto: string;

    public CountingEntities: number;

    public static fromJs(source: IRegularJobRevisionFilterModelSimpleDTO): RegularJobRevisionFilterModelSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RegularJobRevisionFilterModelSimpleDTO();
    ...
    public fromObservable(source: RegularJobRevisionFilterModelObservableSimpleDTO): void {
        super.fromObservable(source);
        this.CountingEntities = unwrap(source.CountingEntities);
    }

    public toObservable(): RegularJobRevisionFilterModelObservableSimpleDTO {
        let e = new RegularJobRevisionFilterModelObservableSimpleDTO();
        e.fromJs(this);
        return e;
    }
    ...
    public toStrict(): RegularJobRevisionFilterModelStrictDTO {
        let e = new RegularJobRevisionFilterModelStrictDTO();
        e.fromSimple(this);
        return e;
    }
...
export class RegularJobRevisionFilterModelFullDTO extends RegularJobRevisionFilterModelSimpleDTO {
    public __type = 'RegularJobRevisionFilterModelFullDTO';

    private _regularjobrevisionfiltermodelfulldto: string;

    public RegularJob: RegularJobSimpleDTO;

    public static fromJs(source: IRegularJobRevisionFilterModelFullDTO): RegularJobRevisionFilterModelFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RegularJobRevisionFilterModelFullDTO();
    ...
    public fromJs(source: IRegularJobRevisionFilterModelFullDTO): void {
        super.fromJs(source);
        this.RegularJob = RegularJobSimpleDTO.fromJs(source.RegularJob);
    }

    public fromObservable(source: RegularJobRevisionFilterModelObservableFullDTO): void {
        super.fromObservable(source);
        if (unwrap(source.RegularJob)) {
            this.RegularJob = unwrap(source.RegularJob).toJs();
        }
    }

    public toObservable(): RegularJobRevisionFilterModelObservableFullDTO {
        let e = new RegularJobRevisionFilterModelObservableFullDTO();
        e.fromJs(this);
        return e;
    }
...
export class RegularJobRevisionFilterModelRichDTO extends RegularJobRevisionFilterModelFullDTO {
    public __type = 'RegularJobRevisionFilterModelRichDTO';

    private _regularjobrevisionfiltermodelrichdto: string;

    public static fromJs(source: IRegularJobRevisionFilterModelRichDTO): RegularJobRevisionFilterModelRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RegularJobRevisionFilterModelRichDTO();
    ...
    public fromObservable(source: RegularJobRevisionFilterModelObservableRichDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): RegularJobRevisionFilterModelObservableRichDTO {
        let e = new RegularJobRevisionFilterModelObservableRichDTO();
        e.fromJs(this);
        return e;
    }
...
export class RegularJobRevisionFilterModelIdentityDTO {
    public static Empty = new RegularJobRevisionFilterModelIdentityDTO(Guid.Empty);

    public __type = 'RegularJobRevisionFilterModelIdentityDTO';

    private _regularjobrevisionfiltermodelidentitydto: string;
    ...
    public static fromJs(source: any): RegularJobRevisionFilterModelIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new RegularJobRevisionFilterModelIdentityDTO(source.Id);
    }

    public toNativeJson(): RegularJobRevisionFilterModelIdentityDTO {
        return this;
    }
...
export class RegularJobSimpleDTO extends BaseAuditPersistentDTO {
    public __type = 'RegularJobSimpleDTO';

    private _regularjobsimpledto: string;

    public ExpectedNextStartTime: Date;

    public Function: string;

    public LastPulseTime: Date;

    public Name: string;

    public ShedulerTime: ShedulerTime;

    public State: RegularJobState;

    public Version: number;

    public WrapUpSession = false;

    public get Identity() : RegularJobIdentityDTO {
        return new RegularJobIdentityDTO(this.Id);
    }

    public static fromJs(source: IRegularJobSimpleDTO): RegularJobSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RegularJobSimpleDTO();
    ...
    public fromObservable(source: RegularJobObservableSimpleDTO): void {
        super.fromObservable(source);
        this.ExpectedNextStartTime = unwrap(source.ExpectedNextStartTime);
        this.Function = unwrap(source.Function);
        this.LastPulseTime = unwrap(source.LastPulseTime);
        this.Name = unwrap(source.Name);
        this.ShedulerTime = unwrap(source.ShedulerTime);
        this.State = unwrap(source.State);
        this.Version = unwrap(source.Version);
        this.WrapUpSession = unwrap(source.WrapUpSession);
    }

    public toObservable(): RegularJobObservableSimpleDTO {
        let e = new RegularJobObservableSimpleDTO();
        e.fromJs(this);
        return e;
    }
...
export class RegularJobFullDTO extends RegularJobSimpleDTO {
    public __type = 'RegularJobFullDTO';

    private _regularjobfulldto: string;

    public ExecutionResult: ExecuteRegularJobResultSimpleDTO;

    public static fromJs(source: IRegularJobFullDTO): RegularJobFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RegularJobFullDTO();
    ...
    public fromJs(source: IRegularJobFullDTO): void {
        super.fromJs(source);
        this.ExecutionResult = ExecuteRegularJobResultSimpleDTO.fromJs(source.ExecutionResult);
    }

    public fromObservable(source: RegularJobObservableFullDTO): void {
        super.fromObservable(source);
        if (unwrap(source.ExecutionResult)) {
            this.ExecutionResult = unwrap(source.ExecutionResult).toJs();
        }
    }

    public toObservable(): RegularJobObservableFullDTO {
        let e = new RegularJobObservableFullDTO();
        e.fromJs(this);
        return e;
    }
...
export class RegularJobRichDTO extends RegularJobFullDTO {
    public __type = 'RegularJobRichDTO';

    private _regularjobrichdto: string;

    public static fromJs(source: IRegularJobRichDTO): RegularJobRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RegularJobRichDTO();
    ...
    public fromObservable(source: RegularJobObservableRichDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): RegularJobObservableRichDTO {
        let e = new RegularJobObservableRichDTO();
        e.fromJs(this);
        return e;
    }
...
export class RegularJobRevisionModelSimpleDTO extends BaseAbstractDTO {
    public __type = 'RegularJobRevisionModelSimpleDTO';

    private _regularjobrevisionmodelsimpledto: string;

    public RevisionNumber: number;

    public static fromJs(source: IRegularJobRevisionModelSimpleDTO): RegularJobRevisionModelSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RegularJobRevisionModelSimpleDTO();
    ...
    public fromObservable(source: RegularJobRevisionModelObservableSimpleDTO): void {
        super.fromObservable(source);
        this.RevisionNumber = unwrap(source.RevisionNumber);
    }

    public toObservable(): RegularJobRevisionModelObservableSimpleDTO {
        let e = new RegularJobRevisionModelObservableSimpleDTO();
        e.fromJs(this);
        return e;
    }
    ...
    public toStrict(): RegularJobRevisionModelStrictDTO {
        let e = new RegularJobRevisionModelStrictDTO();
        e.fromSimple(this);
        return e;
    }
...
export class RegularJobRevisionModelFullDTO extends RegularJobRevisionModelSimpleDTO {
    public __type = 'RegularJobRevisionModelFullDTO';

    private _regularjobrevisionmodelfulldto: string;

    public ExecutionResult: ExecuteRegularJobResultSimpleDTO;

    public ExtendedObject: RegularJobSimpleDTO;

    public static fromJs(source: IRegularJobRevisionModelFullDTO): RegularJobRevisionModelFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RegularJobRevisionModelFullDTO();
    ...
    public fromJs(source: IRegularJobRevisionModelFullDTO): void {
        super.fromJs(source);
        this.ExecutionResult = ExecuteRegularJobResultSimpleDTO.fromJs(source.ExecutionResult);
        this.ExtendedObject = RegularJobSimpleDTO.fromJs(source.ExtendedObject);
    }

    public fromObservable(source: RegularJobRevisionModelObservableFullDTO): void {
        super.fromObservable(source);
        if (unwrap(source.ExecutionResult)) {
            this.ExecutionResult = unwrap(source.ExecutionResult).toJs();
        }
        if (unwrap(source.ExtendedObject)) {
            this.ExtendedObject = unwrap(source.ExtendedObject).toJs();
        }
    }

    public toObservable(): RegularJobRevisionModelObservableFullDTO {
        let e = new RegularJobRevisionModelObservableFullDTO();
        e.fromJs(this);
        return e;
    }
...
export class RegularJobRevisionModelRichDTO extends RegularJobRevisionModelFullDTO {
    public __type = 'RegularJobRevisionModelRichDTO';

    private _regularjobrevisionmodelrichdto: string;

    public static fromJs(source: IRegularJobRevisionModelRichDTO): RegularJobRevisionModelRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RegularJobRevisionModelRichDTO();
    ...
    public fromObservable(source: RegularJobRevisionModelObservableRichDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): RegularJobRevisionModelObservableRichDTO {
        let e = new RegularJobRevisionModelObservableRichDTO();
        e.fromJs(this);
        return e;
    }
...
export class RegularJobRevisionModelIdentityDTO {
    public static Empty = new RegularJobRevisionModelIdentityDTO(Guid.Empty);

    public __type = 'RegularJobRevisionModelIdentityDTO';

    private _regularjobrevisionmodelidentitydto: string;
    ...
    public static fromJs(source: any): RegularJobRevisionModelIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new RegularJobRevisionModelIdentityDTO(source.Id);
    }

    public toNativeJson(): RegularJobRevisionModelIdentityDTO {
        return this;
    }
...
export class RunRegularJobModelSimpleDTO extends BaseAbstractDTO {
    public __type = 'RunRegularJobModelSimpleDTO';

    private _runregularjobmodelsimpledto: string;

    public InstanceServerName: string;

    public Mode: RunRegularJobMode;

    public static fromJs(source: IRunRegularJobModelSimpleDTO): RunRegularJobModelSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RunRegularJobModelSimpleDTO();
    ...
    public fromObservable(source: RunRegularJobModelObservableSimpleDTO): void {
        super.fromObservable(source);
        this.InstanceServerName = unwrap(source.InstanceServerName);
        this.Mode = unwrap(source.Mode);
    }

    public toObservable(): RunRegularJobModelObservableSimpleDTO {
        let e = new RunRegularJobModelObservableSimpleDTO();
        e.fromJs(this);
        return e;
    }
    ...
    public toStrict(): RunRegularJobModelStrictDTO {
        let e = new RunRegularJobModelStrictDTO();
        e.fromSimple(this);
        return e;
    }
...
export class RunRegularJobModelFullDTO extends RunRegularJobModelSimpleDTO {
    public __type = 'RunRegularJobModelFullDTO';

    private _runregularjobmodelfulldto: string;

    public RegularJob: RegularJobSimpleDTO;

    public static fromJs(source: IRunRegularJobModelFullDTO): RunRegularJobModelFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RunRegularJobModelFullDTO();
    ...
    public fromObservable(source: RunRegularJobModelObservableFullDTO): void {
        super.fromObservable(source);
        if (unwrap(source.RegularJob)) {
            this.RegularJob = unwrap(source.RegularJob).toJs();
        }
    ...
    public toObservable(): RunRegularJobModelObservableFullDTO {
        let e = new RunRegularJobModelObservableFullDTO();
        e.fromJs(this);
        return e;
    }
...
export class RunRegularJobModelRichDTO extends RunRegularJobModelFullDTO {
    public __type = 'RunRegularJobModelRichDTO';

    private _runregularjobmodelrichdto: string;

    public static fromJs(source: IRunRegularJobModelRichDTO): RunRegularJobModelRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RunRegularJobModelRichDTO();
    ...
    public fromObservable(source: RunRegularJobModelObservableRichDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): RunRegularJobModelObservableRichDTO {
        let e = new RunRegularJobModelObservableRichDTO();
        e.fromJs(this);
        return e;
    }
...
export class RunRegularJobModelIdentityDTO {
    public static Empty = new RunRegularJobModelIdentityDTO(Guid.Empty);

    public __type = 'RunRegularJobModelIdentityDTO';

    private _runregularjobmodelidentitydto: string;
    ...
    public static fromJs(source: any): RunRegularJobModelIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new RunRegularJobModelIdentityDTO(source.Id);
    }

    public toNativeJson(): RunRegularJobModelIdentityDTO {
        return this;
    }
...
export class SubBusinessRoleSimpleDTO extends BaseAuditPersistentDTO {
    public __type = 'SubBusinessRoleSimpleDTO';

    private _subbusinessrolesimpledto: string;

    public BusinessRoleId: Guid;

    public Name: string;

    public get Identity() : SubBusinessRoleIdentityDTO {
        return new SubBusinessRoleIdentityDTO(this.Id);
    }

    public static fromJs(source: ISubBusinessRoleSimpleDTO): SubBusinessRoleSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubBusinessRoleSimpleDTO();
    ...
    public fromObservable(source: SubBusinessRoleObservableSimpleDTO): void {
        super.fromObservable(source);
        this.BusinessRoleId = unwrap(source.BusinessRoleId);
        this.Name = unwrap(source.Name);
    }

    public toObservable(): SubBusinessRoleObservableSimpleDTO {
        let e = new SubBusinessRoleObservableSimpleDTO();
        e.fromJs(this);
        return e;
    }
    ...
    public toStrict(): SubBusinessRoleStrictDTO {
        let e = new SubBusinessRoleStrictDTO();
        e.fromSimple(this);
        return e;
    }
...
export class SubBusinessRoleFullDTO extends SubBusinessRoleSimpleDTO {
    public __type = 'SubBusinessRoleFullDTO';

    private _subbusinessrolefulldto: string;

    public Subscription: SubscriptionSimpleDTO;

    public static fromJs(source: ISubBusinessRoleFullDTO): SubBusinessRoleFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubBusinessRoleFullDTO();
    ...
    public fromJs(source: ISubBusinessRoleFullDTO): void {
        super.fromJs(source);
        this.Subscription = SubscriptionSimpleDTO.fromJs(source.Subscription);
    }

    public fromObservable(source: SubBusinessRoleObservableFullDTO): void {
        super.fromObservable(source);
        if (unwrap(source.Subscription)) {
            this.Subscription = unwrap(source.Subscription).toJs();
        }
    }

    public toObservable(): SubBusinessRoleObservableFullDTO {
        let e = new SubBusinessRoleObservableFullDTO();
        e.fromJs(this);
        return e;
    }
...
export class SubBusinessRoleRichDTO extends SubBusinessRoleFullDTO {
    public __type = 'SubBusinessRoleRichDTO';

    private _subbusinessrolerichdto: string;

    public static fromJs(source: ISubBusinessRoleRichDTO): SubBusinessRoleRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubBusinessRoleRichDTO();
    ...
    public fromObservable(source: SubBusinessRoleObservableRichDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): SubBusinessRoleObservableRichDTO {
        let e = new SubBusinessRoleObservableRichDTO();
        e.fromJs(this);
        return e;
    }
...
export class SubscriptionSimpleDTO extends BaseAuditPersistentDTO {
    public __type = 'SubscriptionSimpleDTO';

    private _subscriptionsimpledto: string;

    public AllowEmptyListOfRecipients = false;

    public Code: string;

    public DynamicSourceExpandType: NotificationExpandType;

    public ExcludeCurrentUser = false;

    public IncludeAttachments = false;

    public RecepientsMode: RecepientsSelectorMode;

    public SenderEmail: string;

    public SenderName: string;

    public SendIndividualLetters = false;

    public get Identity() : SubscriptionIdentityDTO {
        return new SubscriptionIdentityDTO(this.Id);
    }

    public static fromJs(source: ISubscriptionSimpleDTO): SubscriptionSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionSimpleDTO();
    ...
    public fromObservable(source: SubscriptionObservableSimpleDTO): void {
        super.fromObservable(source);
        this.AllowEmptyListOfRecipients = unwrap(source.AllowEmptyListOfRecipients);
        this.Code = unwrap(source.Code);
        this.DynamicSourceExpandType = unwrap(source.DynamicSourceExpandType);
        this.ExcludeCurrentUser = unwrap(source.ExcludeCurrentUser);
        this.IncludeAttachments = unwrap(source.IncludeAttachments);
        this.RecepientsMode = unwrap(source.RecepientsMode);
        this.SenderEmail = unwrap(source.SenderEmail);
        this.SenderName = unwrap(source.SenderName);
        this.SendIndividualLetters = unwrap(source.SendIndividualLetters);
    }

    public toObservable(): SubscriptionObservableSimpleDTO {
        let e = new SubscriptionObservableSimpleDTO();
        e.fromJs(this);
        return e;
    }
    ...
    public toStrict(): SubscriptionStrictDTO {
        let e = new SubscriptionStrictDTO();
        e.fromSimple(this);
        return e;
    }
...
export class SubscriptionFullDTO extends SubscriptionSimpleDTO {
    public __type = 'SubscriptionFullDTO';

    private _subscriptionfulldto: string;

    public Condition: SubscriptionLambdaSimpleDTO;

    public CopyGeneration: SubscriptionLambdaSimpleDTO;

    public DomainType: DomainTypeSimpleDTO;

    public DynamicSource: SubscriptionLambdaSimpleDTO;

    public Generation: SubscriptionLambdaSimpleDTO;

    public MessageTemplate: MessageTemplateSimpleDTO;

    public ReplyToGeneration: SubscriptionLambdaSimpleDTO;

    public TargetSystem: TargetSystemSimpleDTO;

    public static fromJs(source: ISubscriptionFullDTO): SubscriptionFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionFullDTO();
    ...
    public fromJs(source: ISubscriptionFullDTO): void {
        super.fromJs(source);
        this.Condition = SubscriptionLambdaSimpleDTO.fromJs(source.Condition);
        this.CopyGeneration = SubscriptionLambdaSimpleDTO.fromJs(source.CopyGeneration);
        this.DomainType = DomainTypeSimpleDTO.fromJs(source.DomainType);
        this.DynamicSource = SubscriptionLambdaSimpleDTO.fromJs(source.DynamicSource);
        this.Generation = SubscriptionLambdaSimpleDTO.fromJs(source.Generation);
        this.MessageTemplate = MessageTemplateSimpleDTO.fromJs(source.MessageTemplate);
        this.ReplyToGeneration = SubscriptionLambdaSimpleDTO.fromJs(source.ReplyToGeneration);
        this.TargetSystem = TargetSystemSimpleDTO.fromJs(source.TargetSystem);
    }

    public fromObservable(source: SubscriptionObservableFullDTO): void {
        super.fromObservable(source);
        if (unwrap(source.Condition)) {
            this.Condition = unwrap(source.Condition).toJs();
        }
        if (unwrap(source.CopyGeneration)) {
            this.CopyGeneration = unwrap(source.CopyGeneration).toJs();
        }
        if (unwrap(source.DomainType)) {
            this.DomainType = unwrap(source.DomainType).toJs();
        }
        if (unwrap(source.DynamicSource)) {
            this.DynamicSource = unwrap(source.DynamicSource).toJs();
        }
        if (unwrap(source.Generation)) {
            this.Generation = unwrap(source.Generation).toJs();
        }
        if (unwrap(source.MessageTemplate)) {
            this.MessageTemplate = unwrap(source.MessageTemplate).toJs();
        }
        if (unwrap(source.ReplyToGeneration)) {
            this.ReplyToGeneration = unwrap(source.ReplyToGeneration).toJs();
        }
        if (unwrap(source.TargetSystem)) {
            this.TargetSystem = unwrap(source.TargetSystem).toJs();
        }
    ...
    public toObservable(): SubscriptionObservableFullDTO {
        let e = new SubscriptionObservableFullDTO();
        e.fromJs(this);
        return e;
    }
...
export class SubscriptionRichDTO extends SubscriptionFullDTO {
    public __type = 'SubscriptionRichDTO';

    private _subscriptionrichdto: string;

    public SecurityItems: SubscriptionSecurityItemRichDTO [];

    public SubBusinessRoles: SubBusinessRoleRichDTO [];

    public static fromJs(source: ISubscriptionRichDTO): SubscriptionRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionRichDTO();
    ...
    public fromJs(source: ISubscriptionRichDTO): void {
        ...
        if (source.SecurityItems) {
            this.SecurityItems = source.SecurityItems.map(e => {
                return SubscriptionSecurityItemRichDTO.fromJs(e);
            });
        }
        if (source.SubBusinessRoles) {
            this.SubBusinessRoles = source.SubBusinessRoles.map(e => {
                return SubBusinessRoleRichDTO.fromJs(e);
            });
        }
    }

    public fromObservable(source: SubscriptionObservableRichDTO): void {
        super.fromObservable(source);
        if (unwrap(source.SecurityItems)) {
            this.SecurityItems = source.SecurityItems().map(e => {
                return e.toJs();
            });
        }
        if (unwrap(source.SubBusinessRoles)) {
            this.SubBusinessRoles = source.SubBusinessRoles().map(e => {
                return e.toJs();
            });
        }
    ...
    public toObservable(): SubscriptionObservableRichDTO {
        let e = new SubscriptionObservableRichDTO();
        e.fromJs(this);
        return e;
    }
...
export class SubscriptionContainerSimpleDTO extends BaseAbstractDTO {
    public __type = 'SubscriptionContainerSimpleDTO';

    private _subscriptioncontainersimpledto: string;

    public static fromJs(source: ISubscriptionContainerSimpleDTO): SubscriptionContainerSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionContainerSimpleDTO();
    ...
    public fromObservable(source: SubscriptionContainerObservableSimpleDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): SubscriptionContainerObservableSimpleDTO {
        let e = new SubscriptionContainerObservableSimpleDTO();
        e.fromJs(this);
        return e;
    }
    ...
    public toStrict(): SubscriptionContainerStrictDTO {
        let e = new SubscriptionContainerStrictDTO();
        e.fromSimple(this);
        return e;
    }
...
export class SubscriptionContainerFullDTO extends SubscriptionContainerSimpleDTO {
    public __type = 'SubscriptionContainerFullDTO';

    private _subscriptioncontainerfulldto: string;

    public static fromJs(source: ISubscriptionContainerFullDTO): SubscriptionContainerFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionContainerFullDTO();
    ...
    public fromObservable(source: SubscriptionContainerObservableFullDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): SubscriptionContainerObservableFullDTO {
        let e = new SubscriptionContainerObservableFullDTO();
        e.fromJs(this);
        return e;
    }
...
export class SubscriptionContainerRichDTO extends SubscriptionContainerFullDTO {
    public __type = 'SubscriptionContainerRichDTO';

    private _subscriptioncontainerrichdto: string;

    public AttachmentContainers: AttachmentContainerRichDTO [];

    public Lambdas: SubscriptionLambdaRichDTO [];

    public MessageTemplates: MessageTemplateRichDTO [];

    public Subscriptions: SubscriptionRichDTO [];

    public static fromJs(source: ISubscriptionContainerRichDTO): SubscriptionContainerRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionContainerRichDTO();
    ...
    public fromJs(source: ISubscriptionContainerRichDTO): void {
        ...
        if (source.AttachmentContainers) {
            this.AttachmentContainers = source.AttachmentContainers.map(e => {
                return AttachmentContainerRichDTO.fromJs(e);
            });
        }
        if (source.Lambdas) {
            this.Lambdas = source.Lambdas.map(e => {
                return SubscriptionLambdaRichDTO.fromJs(e);
            });
        }
        if (source.MessageTemplates) {
            this.MessageTemplates = source.MessageTemplates.map(e => {
                return MessageTemplateRichDTO.fromJs(e);
            });
        }
        if (source.Subscriptions) {
            this.Subscriptions = source.Subscriptions.map(e => {
                return SubscriptionRichDTO.fromJs(e);
            });
        }
    }

    public fromObservable(source: SubscriptionContainerObservableRichDTO): void {
        super.fromObservable(source);
        if (unwrap(source.AttachmentContainers)) {
            this.AttachmentContainers = source.AttachmentContainers().map(e => {
                return e.toJs();
            });
        }
        if (unwrap(source.Lambdas)) {
            this.Lambdas = source.Lambdas().map(e => {
                return e.toJs();
            });
        }
        if (unwrap(source.MessageTemplates)) {
            this.MessageTemplates = source.MessageTemplates().map(e => {
                return e.toJs();
            });
        }
        if (unwrap(source.Subscriptions)) {
            this.Subscriptions = source.Subscriptions().map(e => {
                return e.toJs();
            });
        }
    ...
    public toObservable(): SubscriptionContainerObservableRichDTO {
        let e = new SubscriptionContainerObservableRichDTO();
        e.fromJs(this);
        return e;
    }
...
export class SubscriptionContainerIdentityDTO {
    public static Empty = new SubscriptionContainerIdentityDTO(Guid.Empty);

    public __type = 'SubscriptionContainerIdentityDTO';

    private _subscriptioncontaineridentitydto: string;
    ...
    public static fromJs(source: any): SubscriptionContainerIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new SubscriptionContainerIdentityDTO(source.Id);
    }

    public toNativeJson(): SubscriptionContainerIdentityDTO {
        return this;
    }

}

export class SubscriptionCreateModelSimpleDTO extends BaseAbstractDTO {
    public __type = 'SubscriptionCreateModelSimpleDTO';

    private _subscriptioncreatemodelsimpledto: string;

    public static fromJs(source: ISubscriptionCreateModelSimpleDTO): SubscriptionCreateModelSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionCreateModelSimpleDTO();
    ...
    public fromObservable(source: SubscriptionCreateModelObservableSimpleDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): SubscriptionCreateModelObservableSimpleDTO {
        let e = new SubscriptionCreateModelObservableSimpleDTO();
        e.fromJs(this);
        return e;
    }
    ...
    public toStrict(): SubscriptionCreateModelStrictDTO {
        let e = new SubscriptionCreateModelStrictDTO();
        e.fromSimple(this);
        return e;
    }
...
export class SubscriptionCreateModelFullDTO extends SubscriptionCreateModelSimpleDTO {
    public __type = 'SubscriptionCreateModelFullDTO';

    private _subscriptioncreatemodelfulldto: string;

    public static fromJs(source: ISubscriptionCreateModelFullDTO): SubscriptionCreateModelFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionCreateModelFullDTO();
    ...
    public fromObservable(source: SubscriptionCreateModelObservableFullDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): SubscriptionCreateModelObservableFullDTO {
        let e = new SubscriptionCreateModelObservableFullDTO();
        e.fromJs(this);
        return e;
    }
...
export class SubscriptionCreateModelRichDTO extends SubscriptionCreateModelFullDTO {
    public __type = 'SubscriptionCreateModelRichDTO';

    private _subscriptioncreatemodelrichdto: string;

    public static fromJs(source: ISubscriptionCreateModelRichDTO): SubscriptionCreateModelRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionCreateModelRichDTO();
    ...
    public fromObservable(source: SubscriptionCreateModelObservableRichDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): SubscriptionCreateModelObservableRichDTO {
        let e = new SubscriptionCreateModelObservableRichDTO();
        e.fromJs(this);
        return e;
    }
...
export class SubscriptionCreateModelIdentityDTO {
    public static Empty = new SubscriptionCreateModelIdentityDTO(Guid.Empty);

    public __type = 'SubscriptionCreateModelIdentityDTO';

    private _subscriptioncreatemodelidentitydto: string;
    ...
    public static fromJs(source: any): SubscriptionCreateModelIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new SubscriptionCreateModelIdentityDTO(source.Id);
    }

    public toNativeJson(): SubscriptionCreateModelIdentityDTO {
        return this;
    }

}

export class SubscriptionLambdaSimpleDTO extends BaseAuditPersistentDTO {
    public __type = 'SubscriptionLambdaSimpleDTO';

    private _subscriptionlambdasimpledto: string;

    public AuthDomainTypeId: Guid;

    public FormattedType: string;

    public Name: string;

    public ProcessType: SubscriptionType;

    public RequiredModeNext: boolean;

    public RequiredModePrev: boolean;

    public Type: SubscriptionLambdaType;

    public Value: string;

    public WithContext = false;

    public get Identity() : SubscriptionLambdaIdentityDTO {
        return new SubscriptionLambdaIdentityDTO(this.Id);
    }

    public static fromJs(source: ISubscriptionLambdaSimpleDTO): SubscriptionLambdaSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionLambdaSimpleDTO();
    ...
    public fromObservable(source: SubscriptionLambdaObservableSimpleDTO): void {
        super.fromObservable(source);
        this.AuthDomainTypeId = unwrap(source.AuthDomainTypeId);
        this.FormattedType = unwrap(source.FormattedType);
        this.Name = unwrap(source.Name);
        this.ProcessType = unwrap(source.ProcessType);
        this.RequiredModeNext = unwrap(source.RequiredModeNext);
        this.RequiredModePrev = unwrap(source.RequiredModePrev);
        this.Type = unwrap(source.Type);
        this.Value = unwrap(source.Value);
        this.WithContext = unwrap(source.WithContext);
    }

    public toObservable(): SubscriptionLambdaObservableSimpleDTO {
        let e = new SubscriptionLambdaObservableSimpleDTO();
        e.fromJs(this);
        return e;
    }
    ...
    public toStrict(): SubscriptionLambdaStrictDTO {
        let e = new SubscriptionLambdaStrictDTO();
        e.fromSimple(this);
        return e;
    }
...
export class SubscriptionLambdaFullDTO extends SubscriptionLambdaSimpleDTO {
    public __type = 'SubscriptionLambdaFullDTO';

    private _subscriptionlambdafulldto: string;

    public DomainType: DomainTypeSimpleDTO;

    public TargetSystem: TargetSystemSimpleDTO;

    public static fromJs(source: ISubscriptionLambdaFullDTO): SubscriptionLambdaFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionLambdaFullDTO();
    ...
    public fromObservable(source: SubscriptionLambdaObservableFullDTO): void {
        super.fromObservable(source);
        if (unwrap(source.DomainType)) {
            this.DomainType = unwrap(source.DomainType).toJs();
        }
    ...
    public toObservable(): SubscriptionLambdaObservableFullDTO {
        let e = new SubscriptionLambdaObservableFullDTO();
        e.fromJs(this);
        return e;
    }
...
export class SubscriptionLambdaRichDTO extends SubscriptionLambdaFullDTO {
    public __type = 'SubscriptionLambdaRichDTO';

    private _subscriptionlambdarichdto: string;

    public static fromJs(source: ISubscriptionLambdaRichDTO): SubscriptionLambdaRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionLambdaRichDTO();
    ...
    public fromObservable(source: SubscriptionLambdaObservableRichDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): SubscriptionLambdaObservableRichDTO {
        let e = new SubscriptionLambdaObservableRichDTO();
        e.fromJs(this);
        return e;
    }
...
export class SubscriptionLambdaCreateModelSimpleDTO extends BaseAbstractDTO {
    public __type = 'SubscriptionLambdaCreateModelSimpleDTO';

    private _subscriptionlambdacreatemodelsimpledto: string;

    public static fromJs(source: ISubscriptionLambdaCreateModelSimpleDTO): SubscriptionLambdaCreateModelSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionLambdaCreateModelSimpleDTO();
    ...
    public fromObservable(source: SubscriptionLambdaCreateModelObservableSimpleDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): SubscriptionLambdaCreateModelObservableSimpleDTO {
        let e = new SubscriptionLambdaCreateModelObservableSimpleDTO();
        e.fromJs(this);
        return e;
    }
    ...
    public toStrict(): SubscriptionLambdaCreateModelStrictDTO {
        let e = new SubscriptionLambdaCreateModelStrictDTO();
        e.fromSimple(this);
        return e;
    }
...
export class SubscriptionLambdaCreateModelFullDTO extends SubscriptionLambdaCreateModelSimpleDTO {
    public __type = 'SubscriptionLambdaCreateModelFullDTO';

    private _subscriptionlambdacreatemodelfulldto: string;

    public static fromJs(source: ISubscriptionLambdaCreateModelFullDTO): SubscriptionLambdaCreateModelFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionLambdaCreateModelFullDTO();
    ...
    public fromObservable(source: SubscriptionLambdaCreateModelObservableFullDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): SubscriptionLambdaCreateModelObservableFullDTO {
        let e = new SubscriptionLambdaCreateModelObservableFullDTO();
        e.fromJs(this);
        return e;
    }
...
export class SubscriptionLambdaCreateModelRichDTO extends SubscriptionLambdaCreateModelFullDTO {
    public __type = 'SubscriptionLambdaCreateModelRichDTO';

    private _subscriptionlambdacreatemodelrichdto: string;

    public static fromJs(source: ISubscriptionLambdaCreateModelRichDTO): SubscriptionLambdaCreateModelRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionLambdaCreateModelRichDTO();
    ...
    public fromObservable(source: SubscriptionLambdaCreateModelObservableRichDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): SubscriptionLambdaCreateModelObservableRichDTO {
        let e = new SubscriptionLambdaCreateModelObservableRichDTO();
        e.fromJs(this);
        return e;
    }
...
export class SubscriptionLambdaCreateModelIdentityDTO {
    public static Empty = new SubscriptionLambdaCreateModelIdentityDTO(Guid.Empty);

    public __type = 'SubscriptionLambdaCreateModelIdentityDTO';

    private _subscriptionlambdacreatemodelidentitydto: string;
    ...
    public static fromJs(source: any): SubscriptionLambdaCreateModelIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new SubscriptionLambdaCreateModelIdentityDTO(source.Id);
    }

    public toNativeJson(): SubscriptionLambdaCreateModelIdentityDTO {
        return this;
    }

}

export class SubscriptionLambdaRootFilterModelSimpleDTO extends BaseAbstractDTO {
    public __type = 'SubscriptionLambdaRootFilterModelSimpleDTO';

    private _subscriptionlambdarootfiltermodelsimpledto: string;

    public AuthDomainTypeId: Guid;

    public Type: SubscriptionLambdaType;

    public static fromJs(source: ISubscriptionLambdaRootFilterModelSimpleDTO): SubscriptionLambdaRootFilterModelSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionLambdaRootFilterModelSimpleDTO();
    ...
    public fromObservable(source: SubscriptionLambdaRootFilterModelObservableSimpleDTO): void {
        super.fromObservable(source);
        this.AuthDomainTypeId = unwrap(source.AuthDomainTypeId);
        this.Type = unwrap(source.Type);
    }

    public toObservable(): SubscriptionLambdaRootFilterModelObservableSimpleDTO {
        let e = new SubscriptionLambdaRootFilterModelObservableSimpleDTO();
        e.fromJs(this);
        return e;
    }
    ...
    public toStrict(): SubscriptionLambdaRootFilterModelStrictDTO {
        let e = new SubscriptionLambdaRootFilterModelStrictDTO();
        e.fromSimple(this);
        return e;
    }
...
export class SubscriptionLambdaRootFilterModelFullDTO extends SubscriptionLambdaRootFilterModelSimpleDTO {
    public __type = 'SubscriptionLambdaRootFilterModelFullDTO';

    private _subscriptionlambdarootfiltermodelfulldto: string;

    public DomainType: DomainTypeSimpleDTO;

    public TargetSystem: TargetSystemSimpleDTO;

    public static fromJs(source: ISubscriptionLambdaRootFilterModelFullDTO): SubscriptionLambdaRootFilterModelFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionLambdaRootFilterModelFullDTO();
    ...
    public fromObservable(source: SubscriptionLambdaRootFilterModelObservableFullDTO): void {
        super.fromObservable(source);
        if (unwrap(source.DomainType)) {
            this.DomainType = unwrap(source.DomainType).toJs();
        }
    ...
    public toObservable(): SubscriptionLambdaRootFilterModelObservableFullDTO {
        let e = new SubscriptionLambdaRootFilterModelObservableFullDTO();
        e.fromJs(this);
        return e;
    }
...
export class SubscriptionLambdaRootFilterModelRichDTO extends SubscriptionLambdaRootFilterModelFullDTO {
    public __type = 'SubscriptionLambdaRootFilterModelRichDTO';

    private _subscriptionlambdarootfiltermodelrichdto: string;

    public static fromJs(source: ISubscriptionLambdaRootFilterModelRichDTO): SubscriptionLambdaRootFilterModelRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionLambdaRootFilterModelRichDTO();
    ...
    public fromObservable(source: SubscriptionLambdaRootFilterModelObservableRichDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): SubscriptionLambdaRootFilterModelObservableRichDTO {
        let e = new SubscriptionLambdaRootFilterModelObservableRichDTO();
        e.fromJs(this);
        return e;
    }
...
export class SubscriptionLambdaRootFilterModelIdentityDTO {
    public static Empty = new SubscriptionLambdaRootFilterModelIdentityDTO(Guid.Empty);

    public __type = 'SubscriptionLambdaRootFilterModelIdentityDTO';

    private _subscriptionlambdarootfiltermodelidentitydto: string;
    ...
    public static fromJs(source: any): SubscriptionLambdaRootFilterModelIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new SubscriptionLambdaRootFilterModelIdentityDTO(source.Id);
    }

    public toNativeJson(): SubscriptionLambdaRootFilterModelIdentityDTO {
        return this;
    }

}

export class SubscriptionRootFilterModelSimpleDTO extends BaseAbstractDTO {
    public __type = 'SubscriptionRootFilterModelSimpleDTO';

    private _subscriptionrootfiltermodelsimpledto: string;

    public static fromJs(source: ISubscriptionRootFilterModelSimpleDTO): SubscriptionRootFilterModelSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionRootFilterModelSimpleDTO();
    ...
    public fromObservable(source: SubscriptionRootFilterModelObservableSimpleDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): SubscriptionRootFilterModelObservableSimpleDTO {
        let e = new SubscriptionRootFilterModelObservableSimpleDTO();
        e.fromJs(this);
        return e;
    }
    ...
    public toStrict(): SubscriptionRootFilterModelStrictDTO {
        let e = new SubscriptionRootFilterModelStrictDTO();
        e.fromSimple(this);
        return e;
    }
...
export class SubscriptionRootFilterModelFullDTO extends SubscriptionRootFilterModelSimpleDTO {
    public __type = 'SubscriptionRootFilterModelFullDTO';

    private _subscriptionrootfiltermodelfulldto: string;

    public DomainType: DomainTypeSimpleDTO;

    public Lambda: SubscriptionLambdaSimpleDTO;

    public MessageTemplate: MessageTemplateSimpleDTO;

    public TargetSystem: TargetSystemSimpleDTO;

    public static fromJs(source: ISubscriptionRootFilterModelFullDTO): SubscriptionRootFilterModelFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionRootFilterModelFullDTO();
    ...
    public fromJs(source: ISubscriptionRootFilterModelFullDTO): void {
        super.fromJs(source);
        this.DomainType = DomainTypeSimpleDTO.fromJs(source.DomainType);
        this.Lambda = SubscriptionLambdaSimpleDTO.fromJs(source.Lambda);
        this.MessageTemplate = MessageTemplateSimpleDTO.fromJs(source.MessageTemplate);
        this.TargetSystem = TargetSystemSimpleDTO.fromJs(source.TargetSystem);
    }

    public fromObservable(source: SubscriptionRootFilterModelObservableFullDTO): void {
        super.fromObservable(source);
        if (unwrap(source.DomainType)) {
            this.DomainType = unwrap(source.DomainType).toJs();
        }
        if (unwrap(source.Lambda)) {
            this.Lambda = unwrap(source.Lambda).toJs();
        }
        if (unwrap(source.MessageTemplate)) {
            this.MessageTemplate = unwrap(source.MessageTemplate).toJs();
        }
    ...
    public toObservable(): SubscriptionRootFilterModelObservableFullDTO {
        let e = new SubscriptionRootFilterModelObservableFullDTO();
        e.fromJs(this);
        return e;
    }
...
export class SubscriptionRootFilterModelRichDTO extends SubscriptionRootFilterModelFullDTO {
    public __type = 'SubscriptionRootFilterModelRichDTO';

    private _subscriptionrootfiltermodelrichdto: string;

    public static fromJs(source: ISubscriptionRootFilterModelRichDTO): SubscriptionRootFilterModelRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionRootFilterModelRichDTO();
    ...
    public fromObservable(source: SubscriptionRootFilterModelObservableRichDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): SubscriptionRootFilterModelObservableRichDTO {
        let e = new SubscriptionRootFilterModelObservableRichDTO();
        e.fromJs(this);
        return e;
    }
...
export class SubscriptionRootFilterModelIdentityDTO {
    public static Empty = new SubscriptionRootFilterModelIdentityDTO(Guid.Empty);

    public __type = 'SubscriptionRootFilterModelIdentityDTO';

    private _subscriptionrootfiltermodelidentitydto: string;
    ...
    public static fromJs(source: any): SubscriptionRootFilterModelIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new SubscriptionRootFilterModelIdentityDTO(source.Id);
    }

    public toNativeJson(): SubscriptionRootFilterModelIdentityDTO {
        return this;
    }

}

export class SubscriptionSecurityItemSimpleDTO extends BaseAuditPersistentDTO {
    public __type = 'SubscriptionSecurityItemSimpleDTO';

    private _subscriptionsecurityitemsimpledto: string;

    public AuthDomainTypeId: Guid;

    public ExpandType: NotificationExpandType;

    public get Identity() : SubscriptionSecurityItemIdentityDTO {
        return new SubscriptionSecurityItemIdentityDTO(this.Id);
    }

    public static fromJs(source: ISubscriptionSecurityItemSimpleDTO): SubscriptionSecurityItemSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionSecurityItemSimpleDTO();
    ...
    public fromObservable(source: SubscriptionSecurityItemObservableSimpleDTO): void {
        super.fromObservable(source);
        this.AuthDomainTypeId = unwrap(source.AuthDomainTypeId);
        this.ExpandType = unwrap(source.ExpandType);
    }

    public toObservable(): SubscriptionSecurityItemObservableSimpleDTO {
        let e = new SubscriptionSecurityItemObservableSimpleDTO();
        e.fromJs(this);
        return e;
    }
    ...
    public toStrict(): SubscriptionSecurityItemStrictDTO {
        let e = new SubscriptionSecurityItemStrictDTO();
        e.fromSimple(this);
        return e;
    }
...
export class SubscriptionSecurityItemFullDTO extends SubscriptionSecurityItemSimpleDTO {
    public __type = 'SubscriptionSecurityItemFullDTO';

    private _subscriptionsecurityitemfulldto: string;

    public Source: SubscriptionLambdaSimpleDTO;

    public Subscription: SubscriptionSimpleDTO;

    public static fromJs(source: ISubscriptionSecurityItemFullDTO): SubscriptionSecurityItemFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionSecurityItemFullDTO();
    ...
    public fromJs(source: ISubscriptionSecurityItemFullDTO): void {
        super.fromJs(source);
        this.Source = SubscriptionLambdaSimpleDTO.fromJs(source.Source);
        this.Subscription = SubscriptionSimpleDTO.fromJs(source.Subscription);
    }

    public fromObservable(source: SubscriptionSecurityItemObservableFullDTO): void {
        super.fromObservable(source);
        if (unwrap(source.Source)) {
            this.Source = unwrap(source.Source).toJs();
        }
        if (unwrap(source.Subscription)) {
            this.Subscription = unwrap(source.Subscription).toJs();
        }
    ...
    public toObservable(): SubscriptionSecurityItemObservableFullDTO {
        let e = new SubscriptionSecurityItemObservableFullDTO();
        e.fromJs(this);
        return e;
    }
...
export class SubscriptionSecurityItemRichDTO extends SubscriptionSecurityItemFullDTO {
    public __type = 'SubscriptionSecurityItemRichDTO';

    private _subscriptionsecurityitemrichdto: string;

    public static fromJs(source: ISubscriptionSecurityItemRichDTO): SubscriptionSecurityItemRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionSecurityItemRichDTO();
    ...
    public fromObservable(source: SubscriptionSecurityItemObservableRichDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): SubscriptionSecurityItemObservableRichDTO {
        let e = new SubscriptionSecurityItemObservableRichDTO();
        e.fromJs(this);
        return e;
    }
...
export class TestSubscriptionModelSimpleDTO extends BaseAbstractDTO {
    public __type = 'TestSubscriptionModelSimpleDTO';

    private _testsubscriptionmodelsimpledto: string;

    public DomainObjectId: Guid;

    public Revision: number;

    public static fromJs(source: ITestSubscriptionModelSimpleDTO): TestSubscriptionModelSimpleDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new TestSubscriptionModelSimpleDTO();
    ...
    public fromObservable(source: TestSubscriptionModelObservableSimpleDTO): void {
        super.fromObservable(source);
        this.DomainObjectId = unwrap(source.DomainObjectId);
        this.Revision = unwrap(source.Revision);
    }

    public toObservable(): TestSubscriptionModelObservableSimpleDTO {
        let e = new TestSubscriptionModelObservableSimpleDTO();
        e.fromJs(this);
        return e;
    }
    ...
    public toStrict(): TestSubscriptionModelStrictDTO {
        let e = new TestSubscriptionModelStrictDTO();
        e.fromSimple(this);
        return e;
    }
...
export class TestSubscriptionModelFullDTO extends TestSubscriptionModelSimpleDTO {
    public __type = 'TestSubscriptionModelFullDTO';

    private _testsubscriptionmodelfulldto: string;

    public Subscription: SubscriptionSimpleDTO;

    public static fromJs(source: ITestSubscriptionModelFullDTO): TestSubscriptionModelFullDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new TestSubscriptionModelFullDTO();
    ...
    public fromObservable(source: TestSubscriptionModelObservableFullDTO): void {
        super.fromObservable(source);
        if (unwrap(source.Subscription)) {
            this.Subscription = unwrap(source.Subscription).toJs();
        }
    ...
    public toObservable(): TestSubscriptionModelObservableFullDTO {
        let e = new TestSubscriptionModelObservableFullDTO();
        e.fromJs(this);
        return e;
    }
...
export class TestSubscriptionModelRichDTO extends TestSubscriptionModelFullDTO {
    public __type = 'TestSubscriptionModelRichDTO';

    private _testsubscriptionmodelrichdto: string;

    public static fromJs(source: ITestSubscriptionModelRichDTO): TestSubscriptionModelRichDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new TestSubscriptionModelRichDTO();
    ...
    public fromObservable(source: TestSubscriptionModelObservableRichDTO): void {
        super.fromObservable(source);
    }

    public toObservable(): TestSubscriptionModelObservableRichDTO {
        let e = new TestSubscriptionModelObservableRichDTO();
        e.fromJs(this);
        return e;
    }
...
export class TestSubscriptionModelIdentityDTO {
    public static Empty = new TestSubscriptionModelIdentityDTO(Guid.Empty);

    public __type = 'TestSubscriptionModelIdentityDTO';

    private _testsubscriptionmodelidentitydto: string;
    ...
    public static fromJs(source: any): TestSubscriptionModelIdentityDTO {
        if (!(source)) {
            return undefined;
        }
        return new TestSubscriptionModelIdentityDTO(source.Id);
    }

    public toNativeJson(): TestSubscriptionModelIdentityDTO {
        return this;
    }
...
export interface IExecuteRegularJobResultSimpleDTO extends IBaseAbstractDTO {
    Description : string;
    ExecutionTime? : number;
    Status : RegularJobStatus;
    Time? : number;
}

export interface IExecuteRegularJobResultFullDTO extends IExecuteRegularJobResultSimpleDTO {
}

export interface IExecuteRegularJobResultRichDTO extends IExecuteRegularJobResultFullDTO {
}
...
export interface IMessageTemplateSimpleDTO extends IBaseAuditPersistentDTO {
    Code : string;
    Comment : string;
    Message : string;
...
export interface IMessageTemplateFullDTO extends IMessageTemplateSimpleDTO {
    DomainType : DomainTypeSimpleDTO;
    TargetSystem : TargetSystemSimpleDTO;
}

export interface IMessageTemplateRichDTO extends IMessageTemplateFullDTO {
}

export class MessageTemplateVisualDTO extends BasePersistentDTO {
    public __type = 'MessageTemplateVisualDTO';

    private _messagetemplatevisualdto: string;
    ...
    public static fromJs(source: IBasePersistentDTO): MessageTemplateVisualDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new MessageTemplateVisualDTO();
    ...
    public fromObservable(source: MessageTemplateObservableVisualDTO): void {
        super.fromObservable(source);
        this.Code = unwrap(source.Code);
    }

    public toObservable(): MessageTemplateObservableVisualDTO {
        let e = new MessageTemplateObservableVisualDTO();
        e.fromJs(this);
        return e;
    }
...
export interface IMessageTemplateCreateModelSimpleDTO extends IBaseAbstractDTO {
}

export interface IMessageTemplateCreateModelFullDTO extends IMessageTemplateCreateModelSimpleDTO {
}

export interface IMessageTemplateCreateModelRichDTO extends IMessageTemplateCreateModelFullDTO {
}

export interface IMessageTemplateRootFilterModelSimpleDTO extends IBaseAbstractDTO {
    WithUntyped : boolean;
}

export interface IMessageTemplateRootFilterModelFullDTO extends IMessageTemplateRootFilterModelSimpleDTO {
    DomainType : DomainTypeSimpleDTO;
    TargetSystem : TargetSystemSimpleDTO;
}

export interface IMessageTemplateRootFilterModelRichDTO extends IMessageTemplateRootFilterModelFullDTO {
}
...
export interface IRegularJobRevisionFilterModelSimpleDTO extends IBaseAbstractDTO {
    CountingEntities : number;
}

export interface IRegularJobRevisionFilterModelFullDTO extends IRegularJobRevisionFilterModelSimpleDTO {
    RegularJob : RegularJobSimpleDTO;
}

export interface IRegularJobRevisionFilterModelRichDTO extends IRegularJobRevisionFilterModelFullDTO {
}
...
export interface IRegularJobSimpleDTO extends IBaseAuditPersistentDTO {
    ExpectedNextStartTime : Date;
    Function : string;
    LastPulseTime? : Date;
    Name : string;
    ShedulerTime : ShedulerTime;
    State : RegularJobState;
    Version : number;
    WrapUpSession : boolean;
}

export interface IRegularJobFullDTO extends IRegularJobSimpleDTO {
    ExecutionResult : ExecuteRegularJobResultSimpleDTO;
}

export interface IRegularJobRichDTO extends IRegularJobFullDTO {
}

export class RegularJobVisualDTO extends BasePersistentDTO {
    public __type = 'RegularJobVisualDTO';

    private _regularjobvisualdto: string;
    ...
    public static fromJs(source: IBasePersistentDTO): RegularJobVisualDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new RegularJobVisualDTO();
    ...
    public fromObservable(source: RegularJobObservableVisualDTO): void {
        super.fromObservable(source);
        this.Name = unwrap(source.Name);
    }

    public toObservable(): RegularJobObservableVisualDTO {
        let e = new RegularJobObservableVisualDTO();
        e.fromJs(this);
        return e;
    }
...
export interface IRegularJobRevisionModelSimpleDTO extends IBaseAbstractDTO {
    RevisionNumber : number;
}

export interface IRegularJobRevisionModelFullDTO extends IRegularJobRevisionModelSimpleDTO {
    ExecutionResult : ExecuteRegularJobResultSimpleDTO;
    ExtendedObject : RegularJobSimpleDTO;
}

export interface IRegularJobRevisionModelRichDTO extends IRegularJobRevisionModelFullDTO {
}
...
export interface IRunRegularJobModelSimpleDTO extends IBaseAbstractDTO {
    InstanceServerName : string;
    Mode : RunRegularJobMode;
}

export interface IRunRegularJobModelFullDTO extends IRunRegularJobModelSimpleDTO {
    RegularJob : RegularJobSimpleDTO;
}

export interface IRunRegularJobModelRichDTO extends IRunRegularJobModelFullDTO {
}
...
export interface ISubBusinessRoleSimpleDTO extends IBaseAuditPersistentDTO {
    BusinessRoleId : Guid;
    Name : string;
}

export interface ISubBusinessRoleFullDTO extends ISubBusinessRoleSimpleDTO {
    Subscription : SubscriptionSimpleDTO;
}

export interface ISubBusinessRoleRichDTO extends ISubBusinessRoleFullDTO {
}

export interface ISubscriptionSimpleDTO extends IBaseAuditPersistentDTO {
    AllowEmptyListOfRecipients : boolean;
    Code : string;
    DynamicSourceExpandType? : NotificationExpandType;
    ExcludeCurrentUser : boolean;
    IncludeAttachments : boolean;
    RecepientsMode : RecepientsSelectorMode;
    SenderEmail : string;
    SenderName : string;
    SendIndividualLetters : boolean;
}

export interface ISubscriptionFullDTO extends ISubscriptionSimpleDTO {
    Condition : SubscriptionLambdaSimpleDTO;
    CopyGeneration : SubscriptionLambdaSimpleDTO;
    DomainType : DomainTypeSimpleDTO;
    DynamicSource : SubscriptionLambdaSimpleDTO;
    Generation : SubscriptionLambdaSimpleDTO;
    MessageTemplate : MessageTemplateSimpleDTO;
    ReplyToGeneration : SubscriptionLambdaSimpleDTO;
    TargetSystem : TargetSystemSimpleDTO;
}

export interface ISubscriptionRichDTO extends ISubscriptionFullDTO {
    SecurityItems : SubscriptionSecurityItemRichDTO [];
    SubBusinessRoles : SubBusinessRoleRichDTO [];
}

export class SubscriptionVisualDTO extends BasePersistentDTO {
    public __type = 'SubscriptionVisualDTO';

    private _subscriptionvisualdto: string;
    ...
    public static fromJs(source: IBasePersistentDTO): SubscriptionVisualDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionVisualDTO();
    ...
    public fromObservable(source: SubscriptionObservableVisualDTO): void {
        super.fromObservable(source);
        this.Code = unwrap(source.Code);
    }

    public toObservable(): SubscriptionObservableVisualDTO {
        let e = new SubscriptionObservableVisualDTO();
        e.fromJs(this);
        return e;
    }
...
export interface ISubscriptionContainerSimpleDTO extends IBaseAbstractDTO {
}

export interface ISubscriptionContainerFullDTO extends ISubscriptionContainerSimpleDTO {
}

export interface ISubscriptionContainerRichDTO extends ISubscriptionContainerFullDTO {
    AttachmentContainers : AttachmentContainerRichDTO [];
    Lambdas : SubscriptionLambdaRichDTO [];
    MessageTemplates : MessageTemplateRichDTO [];
    Subscriptions : SubscriptionRichDTO [];
}

export interface ISubscriptionCreateModelSimpleDTO extends IBaseAbstractDTO {
}

export interface ISubscriptionCreateModelFullDTO extends ISubscriptionCreateModelSimpleDTO {
}

export interface ISubscriptionCreateModelRichDTO extends ISubscriptionCreateModelFullDTO {
}

export interface ISubscriptionLambdaSimpleDTO extends IBaseAuditPersistentDTO {
    AuthDomainTypeId : Guid;
    FormattedType : string;
    Name : string;
    ProcessType : SubscriptionType;
    RequiredModeNext? : boolean;
    RequiredModePrev? : boolean;
    Type : SubscriptionLambdaType;
    Value : string;
    WithContext : boolean;
}

export interface ISubscriptionLambdaFullDTO extends ISubscriptionLambdaSimpleDTO {
    DomainType : DomainTypeSimpleDTO;
    TargetSystem : TargetSystemSimpleDTO;
}

export interface ISubscriptionLambdaRichDTO extends ISubscriptionLambdaFullDTO {
}

export class SubscriptionLambdaVisualDTO extends BasePersistentDTO {
    public __type = 'SubscriptionLambdaVisualDTO';

    private _subscriptionlambdavisualdto: string;
    ...
    public static fromJs(source: IBasePersistentDTO): SubscriptionLambdaVisualDTO {
        if (!(source)) {
            return undefined;
        }
        let e = new SubscriptionLambdaVisualDTO();
    ...
    public fromObservable(source: SubscriptionLambdaObservableVisualDTO): void {
        super.fromObservable(source);
        this.Name = unwrap(source.Name);
    }

    public toObservable(): SubscriptionLambdaObservableVisualDTO {
        let e = new SubscriptionLambdaObservableVisualDTO();
        e.fromJs(this);
        return e;
    }
...
export interface ISubscriptionLambdaCreateModelSimpleDTO extends IBaseAbstractDTO {
}

export interface ISubscriptionLambdaCreateModelFullDTO extends ISubscriptionLambdaCreateModelSimpleDTO {
}

export interface ISubscriptionLambdaCreateModelRichDTO extends ISubscriptionLambdaCreateModelFullDTO {
}

export interface ISubscriptionLambdaRootFilterModelSimpleDTO extends IBaseAbstractDTO {
    AuthDomainTypeId : Guid;
    Type? : SubscriptionLambdaType;
}

export interface ISubscriptionLambdaRootFilterModelFullDTO extends ISubscriptionLambdaRootFilterModelSimpleDTO {
    DomainType : DomainTypeSimpleDTO;
    TargetSystem : TargetSystemSimpleDTO;
}

export interface ISubscriptionLambdaRootFilterModelRichDTO extends ISubscriptionLambdaRootFilterModelFullDTO {
}

export interface ISubscriptionRootFilterModelSimpleDTO extends IBaseAbstractDTO {
}

export interface ISubscriptionRootFilterModelFullDTO extends ISubscriptionRootFilterModelSimpleDTO {
    DomainType : DomainTypeSimpleDTO;
    Lambda : SubscriptionLambdaSimpleDTO;
    MessageTemplate : MessageTemplateSimpleDTO;
    TargetSystem : TargetSystemSimpleDTO;
}

export interface ISubscriptionRootFilterModelRichDTO extends ISubscriptionRootFilterModelFullDTO {
}

export interface ISubscriptionSecurityItemSimpleDTO extends IBaseAuditPersistentDTO {
    AuthDomainTypeId : Guid;
    ExpandType : NotificationExpandType;
}

export interface ISubscriptionSecurityItemFullDTO extends ISubscriptionSecurityItemSimpleDTO {
    Source : SubscriptionLambdaSimpleDTO;
    Subscription : SubscriptionSimpleDTO;
}

export interface ISubscriptionSecurityItemRichDTO extends ISubscriptionSecurityItemFullDTO {
}
...
export interface ITestSubscriptionModelSimpleDTO extends IBaseAbstractDTO {
    DomainObjectId : Guid;
    Revision? : number;
}

export interface ITestSubscriptionModelFullDTO extends ITestSubscriptionModelSimpleDTO {
    Subscription : SubscriptionSimpleDTO;
}

export interface ITestSubscriptionModelRichDTO extends ITestSubscriptionModelFullDTO {
}
...
export class ExecuteRegularJobResultStrictDTO {
    public __type = 'ExecuteRegularJobResultStrictDTO';

    private _executeregularjobresultstrictdto: string;

    public static fromFull(source: ExecuteRegularJobResultFullDTO): ExecuteRegularJobResultStrictDTO {
        let e = new ExecuteRegularJobResultStrictDTO();
        e.fromFull(source);
        return e;
    }

    public static fromRich(source: ExecuteRegularJobResultRichDTO): ExecuteRegularJobResultStrictDTO {
        let e = new ExecuteRegularJobResultStrictDTO();
        e.fromRich(source);
        return e;
    }

    public static fromSimple(source: ExecuteRegularJobResultSimpleDTO): ExecuteRegularJobResultStrictDTO {
        let e = new ExecuteRegularJobResultStrictDTO();
        e.fromSimple(source);
        return e;
    }

    public fromFull(source: ExecuteRegularJobResultFullDTO): void {
        this.fromSimple(source);
    }

    public fromRich(source: ExecuteRegularJobResultRichDTO): void {
        this.fromFull(source);
    }

    public fromSimple(source: ExecuteRegularJobResultSimpleDTO): void {
    }
...
export class MessageTemplateStrictDTO {
    public __type = 'MessageTemplateStrictDTO';

    private _messagetemplatestrictdto: string;
    ...
    public static fromBaseAuditPersistent(source: BaseAuditPersistentDTO): MessageTemplateStrictDTO {
        let e = new MessageTemplateStrictDTO();
        e.fromBaseAuditPersistent(source);
        return e;
    }

    public static fromBasePersistent(source: BasePersistentDTO): MessageTemplateStrictDTO {
        let e = new MessageTemplateStrictDTO();
        e.fromBasePersistent(source);
        return e;
    }

    public static fromFull(source: MessageTemplateFullDTO): MessageTemplateStrictDTO {
        let e = new MessageTemplateStrictDTO();
        e.fromFull(source);
        return e;
    }

    public static fromRich(source: MessageTemplateRichDTO): MessageTemplateStrictDTO {
        let e = new MessageTemplateStrictDTO();
        e.fromRich(source);
        return e;
    }

    public static fromSimple(source: MessageTemplateSimpleDTO): MessageTemplateStrictDTO {
        let e = new MessageTemplateStrictDTO();
        e.fromSimple(source);
        return e;
    }
    ...
    public fromFull(source: MessageTemplateFullDTO): void {
        this.fromSimple(source);
        if (source.DomainType) {
            this.DomainType = source.DomainType.Identity;
        }
    ...
    public fromRich(source: MessageTemplateRichDTO): void {
        this.fromFull(source);
    }

    public fromSimple(source: MessageTemplateSimpleDTO): void {
        this.fromBaseAuditPersistent(source);
        this.Code = source.Code;
        this.Comment = source.Comment;
        this.Message = source.Message;
...
export class MessageTemplateCreateModelStrictDTO {
    public __type = 'MessageTemplateCreateModelStrictDTO';

    private _messagetemplatecreatemodelstrictdto: string;

    public static fromFull(source: MessageTemplateCreateModelFullDTO): MessageTemplateCreateModelStrictDTO {
        let e = new MessageTemplateCreateModelStrictDTO();
        e.fromFull(source);
        return e;
    }

    public static fromRich(source: MessageTemplateCreateModelRichDTO): MessageTemplateCreateModelStrictDTO {
        let e = new MessageTemplateCreateModelStrictDTO();
        e.fromRich(source);
        return e;
    }

    public static fromSimple(source: MessageTemplateCreateModelSimpleDTO): MessageTemplateCreateModelStrictDTO {
        let e = new MessageTemplateCreateModelStrictDTO();
        e.fromSimple(source);
        return e;
    }

    public fromFull(source: MessageTemplateCreateModelFullDTO): void {
        this.fromSimple(source);
    }

    public fromRich(source: MessageTemplateCreateModelRichDTO): void {
        this.fromFull(source);
    }

    public fromSimple(source: MessageTemplateCreateModelSimpleDTO): void {
    }
...
export class MessageTemplateRootFilterModelStrictDTO {
    public __type = 'MessageTemplateRootFilterModelStrictDTO';

    private _messagetemplaterootfiltermodelstrictdto: string;

    public DomainType: DomainTypeIdentityDTO;

    public TargetSystem: TargetSystemIdentityDTO;

    public WithUntyped: boolean;

    public static fromFull(source: MessageTemplateRootFilterModelFullDTO): MessageTemplateRootFilterModelStrictDTO {
        let e = new MessageTemplateRootFilterModelStrictDTO();
        e.fromFull(source);
        return e;
    }

    public static fromRich(source: MessageTemplateRootFilterModelRichDTO): MessageTemplateRootFilterModelStrictDTO {
        let e = new MessageTemplateRootFilterModelStrictDTO();
        e.fromRich(source);
        return e;
    }

    public static fromSimple(source: MessageTemplateRootFilterModelSimpleDTO): MessageTemplateRootFilterModelStrictDTO {
        let e = new MessageTemplateRootFilterModelStrictDTO();
        e.fromSimple(source);
        return e;
    }

    public fromFull(source: MessageTemplateRootFilterModelFullDTO): void {
        this.fromSimple(source);
        if (source.DomainType) {
            this.DomainType = source.DomainType.Identity;
        }
    ...
    public fromRich(source: MessageTemplateRootFilterModelRichDTO): void {
        this.fromFull(source);
    }

    public fromSimple(source: MessageTemplateRootFilterModelSimpleDTO): void {
        this.WithUntyped = source.WithUntyped;
    }
    ...
    public toNativeJson(): any {
        ...
        result.WithUntyped = this.WithUntyped;
        return result;
    }
...
export class RegularJobRevisionFilterModelStrictDTO {
    public __type = 'RegularJobRevisionFilterModelStrictDTO';

    private _regularjobrevisionfiltermodelstrictdto: string;

    public CountingEntities: number;

    public RegularJob: RegularJobIdentityDTO;

    public static fromFull(source: RegularJobRevisionFilterModelFullDTO): RegularJobRevisionFilterModelStrictDTO {
        let e = new RegularJobRevisionFilterModelStrictDTO();
        e.fromFull(source);
        return e;
    }

    public static fromRich(source: RegularJobRevisionFilterModelRichDTO): RegularJobRevisionFilterModelStrictDTO {
        let e = new RegularJobRevisionFilterModelStrictDTO();
        e.fromRich(source);
        return e;
    }

    public static fromSimple(source: RegularJobRevisionFilterModelSimpleDTO): RegularJobRevisionFilterModelStrictDTO {
        let e = new RegularJobRevisionFilterModelStrictDTO();
        e.fromSimple(source);
        return e;
    }

    public fromFull(source: RegularJobRevisionFilterModelFullDTO): void {
        this.fromSimple(source);
        if (source.RegularJob) {
            this.RegularJob = source.RegularJob.Identity;
        }
    }

    public fromRich(source: RegularJobRevisionFilterModelRichDTO): void {
        this.fromFull(source);
    }

    public fromSimple(source: RegularJobRevisionFilterModelSimpleDTO): void {
        this.CountingEntities = source.CountingEntities;
    }
    ...
    public toNativeJson(): any {
        ...
        if (this.RegularJob) {
            result.RegularJob = this.RegularJob.toNativeJson();
        }
        return result;
    }
...
export class RegularJobStrictDTO {
    public __type = 'RegularJobStrictDTO';

    private _regularjobstrictdto: string;
    ...
    public WrapUpSession: boolean;

    public static fromBaseAuditPersistent(source: BaseAuditPersistentDTO): RegularJobStrictDTO {
        let e = new RegularJobStrictDTO();
        e.fromBaseAuditPersistent(source);
        return e;
    }

    public static fromBasePersistent(source: BasePersistentDTO): RegularJobStrictDTO {
        let e = new RegularJobStrictDTO();
        e.fromBasePersistent(source);
        return e;
    }

    public static fromFull(source: RegularJobFullDTO): RegularJobStrictDTO {
        let e = new RegularJobStrictDTO();
        e.fromFull(source);
        return e;
    }

    public static fromRich(source: RegularJobRichDTO): RegularJobStrictDTO {
        let e = new RegularJobStrictDTO();
        e.fromRich(source);
        return e;
    }

    public static fromSimple(source: RegularJobSimpleDTO): RegularJobStrictDTO {
        let e = new RegularJobStrictDTO();
        e.fromSimple(source);
        return e;
    }
    ...
    public fromFull(source: RegularJobFullDTO): void {
        this.fromSimple(source);
    }

    public fromRich(source: RegularJobRichDTO): void {
        this.fromFull(source);
    }

    public fromSimple(source: RegularJobSimpleDTO): void {
        this.fromBaseAuditPersistent(source);
        this.ExpectedNextStartTime = source.ExpectedNextStartTime;
        this.Function = source.Function;
        this.Name = source.Name;
        if (source.ShedulerTime) {
            this.ShedulerTime = source.ShedulerTime;
        }
        this.State = source.State;
        this.Version = source.Version;
        this.WrapUpSession = source.WrapUpSession;
    ...
    public toNativeJson(): any {
        let result:any = {};
        result.Active = this.Active;
        result.ExpectedNextStartTime = Convert.toOData(this.ExpectedNextStartTime);
        result.Function = this.Function;
        result.Id = this.Id;
        result.Name = this.Name;
        if (this.ShedulerTime) {
            result.ShedulerTime = this.ShedulerTime.toNativeJson();
        }
        result.State = this.State;
        result.Version = this.Version;
        result.WrapUpSession = this.WrapUpSession;
        return result;
    }

}

export class RegularJobRevisionModelStrictDTO {
    public __type = 'RegularJobRevisionModelStrictDTO';

    private _regularjobrevisionmodelstrictdto: string;

    public static fromFull(source: RegularJobRevisionModelFullDTO): RegularJobRevisionModelStrictDTO {
        let e = new RegularJobRevisionModelStrictDTO();
        e.fromFull(source);
        return e;
    }

    public static fromRich(source: RegularJobRevisionModelRichDTO): RegularJobRevisionModelStrictDTO {
        let e = new RegularJobRevisionModelStrictDTO();
        e.fromRich(source);
        return e;
    }

    public static fromSimple(source: RegularJobRevisionModelSimpleDTO): RegularJobRevisionModelStrictDTO {
        let e = new RegularJobRevisionModelStrictDTO();
        e.fromSimple(source);
        return e;
    }

    public fromFull(source: RegularJobRevisionModelFullDTO): void {
        this.fromSimple(source);
    }

    public fromRich(source: RegularJobRevisionModelRichDTO): void {
        this.fromFull(source);
    }

    public fromSimple(source: RegularJobRevisionModelSimpleDTO): void {
    }
...
export class RunRegularJobModelStrictDTO {
    public __type = 'RunRegularJobModelStrictDTO';

    private _runregularjobmodelstrictdto: string;
    ...
    public static fromFull(source: RunRegularJobModelFullDTO): RunRegularJobModelStrictDTO {
        let e = new RunRegularJobModelStrictDTO();
        e.fromFull(source);
        return e;
    }

    public static fromRich(source: RunRegularJobModelRichDTO): RunRegularJobModelStrictDTO {
        let e = new RunRegularJobModelStrictDTO();
        e.fromRich(source);
        return e;
    }

    public static fromSimple(source: RunRegularJobModelSimpleDTO): RunRegularJobModelStrictDTO {
        let e = new RunRegularJobModelStrictDTO();
        e.fromSimple(source);
        return e;
    }

    public fromFull(source: RunRegularJobModelFullDTO): void {
        this.fromSimple(source);
        if (source.RegularJob) {
            this.RegularJob = source.RegularJob.Identity;
        }
    ...
    public fromRich(source: RunRegularJobModelRichDTO): void {
        this.fromFull(source);
    }

    public fromSimple(source: RunRegularJobModelSimpleDTO): void {
        this.InstanceServerName = source.InstanceServerName;
        this.Mode = source.Mode;
    }
    ...
    public toNativeJson(): any {
        let result:any = {};
        result.InstanceServerName = this.InstanceServerName;
...
export class SubBusinessRoleStrictDTO {
    public __type = 'SubBusinessRoleStrictDTO';

    private _subbusinessrolestrictdto: string;

    public BusinessRoleId: Guid;

    public Id: Guid;

    public static fromBaseAuditPersistent(source: BaseAuditPersistentDTO): SubBusinessRoleStrictDTO {
        let e = new SubBusinessRoleStrictDTO();
        e.fromBaseAuditPersistent(source);
        return e;
    }

    public static fromBasePersistent(source: BasePersistentDTO): SubBusinessRoleStrictDTO {
        let e = new SubBusinessRoleStrictDTO();
        e.fromBasePersistent(source);
        return e;
    }

    public static fromFull(source: SubBusinessRoleFullDTO): SubBusinessRoleStrictDTO {
        let e = new SubBusinessRoleStrictDTO();
        e.fromFull(source);
        return e;
    }

    public static fromRich(source: SubBusinessRoleRichDTO): SubBusinessRoleStrictDTO {
        let e = new SubBusinessRoleStrictDTO();
        e.fromRich(source);
        return e;
    }

    public static fromSimple(source: SubBusinessRoleSimpleDTO): SubBusinessRoleStrictDTO {
        let e = new SubBusinessRoleStrictDTO();
        e.fromSimple(source);
        return e;
    }
    ...
    public fromFull(source: SubBusinessRoleFullDTO): void {
        this.fromSimple(source);
    }

    public fromRich(source: SubBusinessRoleRichDTO): void {
        this.fromFull(source);
    }

    public fromSimple(source: SubBusinessRoleSimpleDTO): void {
        this.fromBaseAuditPersistent(source);
        this.BusinessRoleId = source.BusinessRoleId;
    }
    ...
    public toNativeJson(): any {
        let result:any = {};
        result.BusinessRoleId = this.BusinessRoleId;
        result.Id = this.Id;
        return result;
    }
...
export class SubscriptionStrictDTO {
    public __type = 'SubscriptionStrictDTO';

    private _subscriptionstrictdto: string;

    public Active: boolean;

    public AllowEmptyListOfRecipients: boolean;

    public Code: string;

    public Condition: SubscriptionLambdaIdentityDTO;

    public CopyGeneration: SubscriptionLambdaIdentityDTO;

    public DomainType: DomainTypeIdentityDTO;

    public DynamicSource: SubscriptionLambdaIdentityDTO;

    public DynamicSourceExpandType: NotificationExpandType;

    public ExcludeCurrentUser: boolean;

    public Generation: SubscriptionLambdaIdentityDTO;

    public Id: Guid;

    public IncludeAttachments: boolean;

    public MessageTemplate: MessageTemplateIdentityDTO;

    public RecepientsMode: RecepientsSelectorMode;

    public ReplyToGeneration: SubscriptionLambdaIdentityDTO;

    public SecurityItems: SubscriptionSecurityItemStrictDTO [];

    public SenderEmail: string;

    public SenderName: string;

    public SendIndividualLetters: boolean;

    public SubBusinessRoles: SubBusinessRoleStrictDTO [];

    public static fromBaseAuditPersistent(source: BaseAuditPersistentDTO): SubscriptionStrictDTO {
        let e = new SubscriptionStrictDTO();
        e.fromBaseAuditPersistent(source);
        return e;
    }

    public static fromBasePersistent(source: BasePersistentDTO): SubscriptionStrictDTO {
        let e = new SubscriptionStrictDTO();
        e.fromBasePersistent(source);
        return e;
    }

    public static fromFull(source: SubscriptionFullDTO): SubscriptionStrictDTO {
        let e = new SubscriptionStrictDTO();
        e.fromFull(source);
        return e;
    }

    public static fromRich(source: SubscriptionRichDTO): SubscriptionStrictDTO {
        let e = new SubscriptionStrictDTO();
        e.fromRich(source);
        return e;
    }

    public static fromSimple(source: SubscriptionSimpleDTO): SubscriptionStrictDTO {
        let e = new SubscriptionStrictDTO();
        e.fromSimple(source);
        return e;
    }
    ...
    public fromFull(source: SubscriptionFullDTO): void {
        this.fromSimple(source);
        if (source.Condition) {
            this.Condition = source.Condition.Identity;
        }
        if (source.CopyGeneration) {
            this.CopyGeneration = source.CopyGeneration.Identity;
        }
        if (source.DomainType) {
            this.DomainType = source.DomainType.Identity;
        }
        if (source.DynamicSource) {
            this.DynamicSource = source.DynamicSource.Identity;
        }
        if (source.Generation) {
            this.Generation = source.Generation.Identity;
        }
        if (source.MessageTemplate) {
            this.MessageTemplate = source.MessageTemplate.Identity;
        }
        if (source.ReplyToGeneration) {
            this.ReplyToGeneration = source.ReplyToGeneration.Identity;
        }
    }

    public fromRich(source: SubscriptionRichDTO): void {
        this.fromFull(source);
        if (source.SecurityItems) {
            this.SecurityItems = source.SecurityItems.map(e => {
                return e.toStrict();
    ...
    public fromSimple(source: SubscriptionSimpleDTO): void {
        this.fromBaseAuditPersistent(source);
        this.AllowEmptyListOfRecipients = source.AllowEmptyListOfRecipients;
        this.Code = source.Code;
        this.DynamicSourceExpandType = source.DynamicSourceExpandType;
    ...
    public toNativeJson(): any {
        let result:any = {};
        result.Active = this.Active;
        result.AllowEmptyListOfRecipients = this.AllowEmptyListOfRecipients;
        result.Code = this.Code;
        if (this.Condition) {
            result.Condition = this.Condition.toNativeJson();
        }
        if (this.CopyGeneration) {
            result.CopyGeneration = this.CopyGeneration.toNativeJson();
        }
        if (this.DomainType) {
            result.DomainType = this.DomainType.toNativeJson();
        }
        if (this.DynamicSource) {
            result.DynamicSource = this.DynamicSource.toNativeJson();
        }
        result.DynamicSourceExpandType = this.DynamicSourceExpandType;
        result.ExcludeCurrentUser = this.ExcludeCurrentUser;
        if (this.Generation) {
            result.Generation = this.Generation.toNativeJson();
        }
        result.Id = this.Id;
        result.IncludeAttachments = this.IncludeAttachments;
        if (this.MessageTemplate) {
            result.MessageTemplate = this.MessageTemplate.toNativeJson();
        }
        result.RecepientsMode = this.RecepientsMode;
        if (this.ReplyToGeneration) {
            result.ReplyToGeneration = this.ReplyToGeneration.toNativeJson();
        }
        if (this.SecurityItems) {
            result.SecurityItems = this.SecurityItems.map(e => {
                return e.toNativeJson();
            });
        }
        result.SenderEmail = this.SenderEmail;
        result.SenderName = this.SenderName;
        result.SendIndividualLetters = this.SendIndividualLetters;
        if (this.SubBusinessRoles) {
            result.SubBusinessRoles = this.SubBusinessRoles.map(e => {
                return e.toNativeJson();
            });
        }
        return result;
...
export class SubscriptionContainerStrictDTO {
    public __type = 'SubscriptionContainerStrictDTO';

    private _subscriptioncontainerstrictdto: string;

    public AttachmentContainers: AttachmentContainerStrictDTO [];

    public Lambdas: SubscriptionLambdaStrictDTO [];

    public MessageTemplates: MessageTemplateStrictDTO [];

    public Subscriptions: SubscriptionStrictDTO [];

    public static fromFull(source: SubscriptionContainerFullDTO): SubscriptionContainerStrictDTO {
        let e = new SubscriptionContainerStrictDTO();
        e.fromFull(source);
        return e;
    }

    public static fromRich(source: SubscriptionContainerRichDTO): SubscriptionContainerStrictDTO {
        let e = new SubscriptionContainerStrictDTO();
        e.fromRich(source);
        return e;
    }

    public static fromSimple(source: SubscriptionContainerSimpleDTO): SubscriptionContainerStrictDTO {
        let e = new SubscriptionContainerStrictDTO();
        e.fromSimple(source);
        return e;
    }

    public fromFull(source: SubscriptionContainerFullDTO): void {
        this.fromSimple(source);
    }

    public fromRich(source: SubscriptionContainerRichDTO): void {
        this.fromFull(source);
        if (source.AttachmentContainers) {
            this.AttachmentContainers = source.AttachmentContainers.map(e => {
                return e.toStrict();
    ...
    public fromSimple(source: SubscriptionContainerSimpleDTO): void {
    }

    public toNativeJson(): any {
        let result:any = {};
        if (this.AttachmentContainers) {
            result.AttachmentContainers = this.AttachmentContainers.map(e => {
                return e.toNativeJson();
            });
        }
        if (this.Lambdas) {
            result.Lambdas = this.Lambdas.map(e => {
                return e.toNativeJson();
            });
        }
        if (this.MessageTemplates) {
            result.MessageTemplates = this.MessageTemplates.map(e => {
                return e.toNativeJson();
            });
        }
        if (this.Subscriptions) {
            result.Subscriptions = this.Subscriptions.map(e => {
                return e.toNativeJson();
            });
        }
        return result;
...
export class SubscriptionCreateModelStrictDTO {
    public __type = 'SubscriptionCreateModelStrictDTO';

    private _subscriptioncreatemodelstrictdto: string;

    public static fromFull(source: SubscriptionCreateModelFullDTO): SubscriptionCreateModelStrictDTO {
        let e = new SubscriptionCreateModelStrictDTO();
        e.fromFull(source);
        return e;
    }

    public static fromRich(source: SubscriptionCreateModelRichDTO): SubscriptionCreateModelStrictDTO {
        let e = new SubscriptionCreateModelStrictDTO();
        e.fromRich(source);
        return e;
    }

    public static fromSimple(source: SubscriptionCreateModelSimpleDTO): SubscriptionCreateModelStrictDTO {
        let e = new SubscriptionCreateModelStrictDTO();
        e.fromSimple(source);
        return e;
    }

    public fromFull(source: SubscriptionCreateModelFullDTO): void {
        this.fromSimple(source);
    }

    public fromRich(source: SubscriptionCreateModelRichDTO): void {
        this.fromFull(source);
    }

    public fromSimple(source: SubscriptionCreateModelSimpleDTO): void {
    }
...
export class SubscriptionLambdaStrictDTO {
    public __type = 'SubscriptionLambdaStrictDTO';

    private _subscriptionlambdastrictdto: string;
    ...
    public static fromBaseAuditPersistent(source: BaseAuditPersistentDTO): SubscriptionLambdaStrictDTO {
        let e = new SubscriptionLambdaStrictDTO();
        e.fromBaseAuditPersistent(source);
        return e;
    }

    public static fromBasePersistent(source: BasePersistentDTO): SubscriptionLambdaStrictDTO {
        let e = new SubscriptionLambdaStrictDTO();
        e.fromBasePersistent(source);
        return e;
    }

    public static fromFull(source: SubscriptionLambdaFullDTO): SubscriptionLambdaStrictDTO {
        let e = new SubscriptionLambdaStrictDTO();
        e.fromFull(source);
        return e;
    }

    public static fromRich(source: SubscriptionLambdaRichDTO): SubscriptionLambdaStrictDTO {
        let e = new SubscriptionLambdaStrictDTO();
        e.fromRich(source);
        return e;
    }

    public static fromSimple(source: SubscriptionLambdaSimpleDTO): SubscriptionLambdaStrictDTO {
        let e = new SubscriptionLambdaStrictDTO();
        e.fromSimple(source);
        return e;
    }
    ...
    public fromFull(source: SubscriptionLambdaFullDTO): void {
        this.fromSimple(source);
        if (source.DomainType) {
            this.DomainType = source.DomainType.Identity;
        }
    ...
    public fromRich(source: SubscriptionLambdaRichDTO): void {
        this.fromFull(source);
    }

    public fromSimple(source: SubscriptionLambdaSimpleDTO): void {
        this.fromBaseAuditPersistent(source);
        this.AuthDomainTypeId = source.AuthDomainTypeId;
        this.Name = source.Name;
        this.RequiredModeNext = source.RequiredModeNext;
    ...
    public toNativeJson(): any {
        let result:any = {};
        result.AuthDomainTypeId = this.AuthDomainTypeId;
        if (this.DomainType) {
            result.DomainType = this.DomainType.toNativeJson();
        }
        result.Id = this.Id;
        result.Name = this.Name;
        result.RequiredModeNext = this.RequiredModeNext;
        result.RequiredModePrev = this.RequiredModePrev;
        result.Type = this.Type;
        result.Value = this.Value;
        result.WithContext = this.WithContext;
        return result;
    }

}

export class SubscriptionLambdaCreateModelStrictDTO {
    public __type = 'SubscriptionLambdaCreateModelStrictDTO';

    private _subscriptionlambdacreatemodelstrictdto: string;

    public static fromFull(source: SubscriptionLambdaCreateModelFullDTO): SubscriptionLambdaCreateModelStrictDTO {
        let e = new SubscriptionLambdaCreateModelStrictDTO();
        e.fromFull(source);
        return e;
    }

    public static fromRich(source: SubscriptionLambdaCreateModelRichDTO): SubscriptionLambdaCreateModelStrictDTO {
        let e = new SubscriptionLambdaCreateModelStrictDTO();
        e.fromRich(source);
        return e;
    }

    public static fromSimple(source: SubscriptionLambdaCreateModelSimpleDTO): SubscriptionLambdaCreateModelStrictDTO {
        let e = new SubscriptionLambdaCreateModelStrictDTO();
        e.fromSimple(source);
        return e;
    }

    public fromFull(source: SubscriptionLambdaCreateModelFullDTO): void {
        this.fromSimple(source);
    }

    public fromRich(source: SubscriptionLambdaCreateModelRichDTO): void {
        this.fromFull(source);
    }

    public fromSimple(source: SubscriptionLambdaCreateModelSimpleDTO): void {
    }
...
export class SubscriptionLambdaRootFilterModelStrictDTO {
    public __type = 'SubscriptionLambdaRootFilterModelStrictDTO';

    private _subscriptionlambdarootfiltermodelstrictdto: string;
    ...
    public static fromFull(source: SubscriptionLambdaRootFilterModelFullDTO): SubscriptionLambdaRootFilterModelStrictDTO {
        let e = new SubscriptionLambdaRootFilterModelStrictDTO();
        e.fromFull(source);
        return e;
    }

    public static fromRich(source: SubscriptionLambdaRootFilterModelRichDTO): SubscriptionLambdaRootFilterModelStrictDTO {
        let e = new SubscriptionLambdaRootFilterModelStrictDTO();
        e.fromRich(source);
        return e;
    }

    public static fromSimple(source: SubscriptionLambdaRootFilterModelSimpleDTO): SubscriptionLambdaRootFilterModelStrictDTO {
        let e = new SubscriptionLambdaRootFilterModelStrictDTO();
        e.fromSimple(source);
        return e;
    }

    public fromFull(source: SubscriptionLambdaRootFilterModelFullDTO): void {
        this.fromSimple(source);
        if (source.DomainType) {
            this.DomainType = source.DomainType.Identity;
        }
    ...
    public fromRich(source: SubscriptionLambdaRootFilterModelRichDTO): void {
        this.fromFull(source);
    }

    public fromSimple(source: SubscriptionLambdaRootFilterModelSimpleDTO): void {
        this.AuthDomainTypeId = source.AuthDomainTypeId;
        this.Type = source.Type;
    }
...
export class SubscriptionRootFilterModelStrictDTO {
    public __type = 'SubscriptionRootFilterModelStrictDTO';

    private _subscriptionrootfiltermodelstrictdto: string;

    public DomainType: DomainTypeIdentityDTO;

    public Lambda: SubscriptionLambdaIdentityDTO;

    public MessageTemplate: MessageTemplateIdentityDTO;

    public TargetSystem: TargetSystemIdentityDTO;

    public static fromFull(source: SubscriptionRootFilterModelFullDTO): SubscriptionRootFilterModelStrictDTO {
        let e = new SubscriptionRootFilterModelStrictDTO();
        e.fromFull(source);
        return e;
    }

    public static fromRich(source: SubscriptionRootFilterModelRichDTO): SubscriptionRootFilterModelStrictDTO {
        let e = new SubscriptionRootFilterModelStrictDTO();
        e.fromRich(source);
        return e;
    }

    public static fromSimple(source: SubscriptionRootFilterModelSimpleDTO): SubscriptionRootFilterModelStrictDTO {
        let e = new SubscriptionRootFilterModelStrictDTO();
        e.fromSimple(source);
        return e;
    }

    public fromFull(source: SubscriptionRootFilterModelFullDTO): void {
        this.fromSimple(source);
        if (source.DomainType) {
            this.DomainType = source.DomainType.Identity;
        }
        if (source.Lambda) {
            this.Lambda = source.Lambda.Identity;
        }
        if (source.MessageTemplate) {
            this.MessageTemplate = source.MessageTemplate.Identity;
        }
    ...
    public fromRich(source: SubscriptionRootFilterModelRichDTO): void {
        this.fromFull(source);
    }

    public fromSimple(source: SubscriptionRootFilterModelSimpleDTO): void {
    }
    ...
    public toNativeJson(): any {
        ...
        if (this.Lambda) {
            result.Lambda = this.Lambda.toNativeJson();
        }
        if (this.MessageTemplate) {
            result.MessageTemplate = this.MessageTemplate.toNativeJson();
        }
...
export class SubscriptionSecurityItemStrictDTO {
    public __type = 'SubscriptionSecurityItemStrictDTO';

    private _subscriptionsecurityitemstrictdto: string;
    ...
    public Source: SubscriptionLambdaIdentityDTO;

    public static fromBaseAuditPersistent(source: BaseAuditPersistentDTO): SubscriptionSecurityItemStrictDTO {
        let e = new SubscriptionSecurityItemStrictDTO();
        e.fromBaseAuditPersistent(source);
        return e;
    }

    public static fromBasePersistent(source: BasePersistentDTO): SubscriptionSecurityItemStrictDTO {
        let e = new SubscriptionSecurityItemStrictDTO();
        e.fromBasePersistent(source);
        return e;
    }

    public static fromFull(source: SubscriptionSecurityItemFullDTO): SubscriptionSecurityItemStrictDTO {
        let e = new SubscriptionSecurityItemStrictDTO();
        e.fromFull(source);
        return e;
    }

    public static fromRich(source: SubscriptionSecurityItemRichDTO): SubscriptionSecurityItemStrictDTO {
        let e = new SubscriptionSecurityItemStrictDTO();
        e.fromRich(source);
        return e;
    }

    public static fromSimple(source: SubscriptionSecurityItemSimpleDTO): SubscriptionSecurityItemStrictDTO {
        let e = new SubscriptionSecurityItemStrictDTO();
        e.fromSimple(source);
        return e;
    }
    ...
    public fromFull(source: SubscriptionSecurityItemFullDTO): void {
        this.fromSimple(source);
        if (source.Source) {
            this.Source = source.Source.Identity;
        }
    }

    public fromRich(source: SubscriptionSecurityItemRichDTO): void {
        this.fromFull(source);
    }

    public fromSimple(source: SubscriptionSecurityItemSimpleDTO): void {
        this.fromBaseAuditPersistent(source);
        this.AuthDomainTypeId = source.AuthDomainTypeId;
        this.ExpandType = source.ExpandType;
    }
    ...
    public toNativeJson(): any {
        let result:any = {};
        result.AuthDomainTypeId = this.AuthDomainTypeId;
        result.ExpandType = this.ExpandType;
        result.Id = this.Id;
        if (this.Source) {
            result.Source = this.Source.toNativeJson();
        }
        return result;
    }
...
export class TestSubscriptionModelStrictDTO {
    public __type = 'TestSubscriptionModelStrictDTO';

    private _testsubscriptionmodelstrictdto: string;

    public DomainObjectId: Guid;

    public Revision: number;

    public Subscription: SubscriptionIdentityDTO;

    public static fromFull(source: TestSubscriptionModelFullDTO): TestSubscriptionModelStrictDTO {
        let e = new TestSubscriptionModelStrictDTO();
        e.fromFull(source);
        return e;
    }

    public static fromRich(source: TestSubscriptionModelRichDTO): TestSubscriptionModelStrictDTO {
        let e = new TestSubscriptionModelStrictDTO();
        e.fromRich(source);
        return e;
    }

    public static fromSimple(source: TestSubscriptionModelSimpleDTO): TestSubscriptionModelStrictDTO {
        let e = new TestSubscriptionModelStrictDTO();
        e.fromSimple(source);
        return e;
    }

    public fromFull(source: TestSubscriptionModelFullDTO): void {
        this.fromSimple(source);
        if (source.Subscription) {
            this.Subscription = source.Subscription.Identity;
        }
    }

    public fromRich(source: TestSubscriptionModelRichDTO): void {
        this.fromFull(source);
    }

    public fromSimple(source: TestSubscriptionModelSimpleDTO): void {
        this.DomainObjectId = source.DomainObjectId;
        this.Revision = source.Revision;
    }
    ...
    public toNativeJson(): any {
        ...
        if (this.Subscription) {
            result.Subscription = this.Subscription.toNativeJson();
        }
        return result;
    }
...
export class ShedulerTime {
    public __type = 'ShedulerTime';

    private _shedulertime: string;

    public Value: number;

    public ValueType: SheduleValueType;

    public static fromJs(source: any): ShedulerTime {
        if (!(source)) {
            return undefined;
        }
        let e = new ShedulerTime();
        e.fromJs(source);
        return e;
    }
...
export enum NamedLockOperation {
    ProcessModifications = 3,
    RegularJobLock = 0,
    UpdateDomainTypeLock = 1,
    UpdateSequence = 2,
}
...
export enum RegularJobState {
    Running = 1,
    SendToProcessing = 2,
    WaitPulse = 0,
}

export enum RegularJobStatus {
    Fail = 2,
    Initial = 0,
    Successed = 1,
}

export enum SubscriptionLambdaType {
    Attachment = 5,
    AuthSource = 4,
    Condition = 0,
    DynamicSource = 1,
...
export enum SubscriptionSourceMode {
    Dynamic = 2,
    Invalid = 0,
    NonContext = 1,
    Typed = 3,
...
export enum ConfigurationSecurityOperationCode {
    Disabled = 0,
    DisplayInternalError = 22,
    ExceptionMessageView = 1,
    ForceDomainTypeEvent = 14,
    MessageTemplateEdit = 3,
    MessageTemplateView = 2,
    ProcessModifications = 23,
    QueueMonitoring = 24,
    RegularJobEdit = 8,
    RegularJobForce = 9,
    RegularJobView = 7,
    ...
    SubscriptionTest = 6,
    SubscriptionView = 4,
    SystemConstantEdit = 11,
    SystemConstantView = 10,
    SystemIntegration = 25,
    TargetSystemEdit = 13,
    TargetSystemView = 12,
    UserActionOpenModule = 20,
    UserActionView = 21,
}
...
export enum NotificationExpandType {
    All = 4,
    Direct = 1,
    DirectOrEmpty = 0,
