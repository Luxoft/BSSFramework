...
using Framework.CodeGeneration.WebApiGenerator.Configuration.Query;
...
using Framework.CodeGeneration.WebApiGenerator.MethodGenerators.Main;
using Framework.CodeGeneration.WebApiGenerator.MethodGenerators.Main.Remove;
using Framework.CodeGeneration.WebApiGenerator.MethodGenerators.Main.Save;
using Framework.CodeGeneration.WebApiGenerator.MethodGenerators.Main.View;
