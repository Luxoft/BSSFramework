...
{
    public IQueryable<Permission> GetAvailablePermissionsQueryable(bool withRunAs = true, SecurityRule.RoleBaseSecurityRule? securityRule = null, bool applyCurrentUser = true)
    {
