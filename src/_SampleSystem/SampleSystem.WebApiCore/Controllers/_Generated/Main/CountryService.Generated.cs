namespace SampleSystem.WebApiCore.Controllers.Main
{
    ...
    public partial class CountryController : Framework.Infrastructure.ApiControllerBase<SampleSystem.BLL.ISampleSystemBLLContext, SampleSystem.Generated.DTO.ISampleSystemDTOMappingService>
    {
        ...
        protected virtual System.Collections.Generic.IEnumerable<SampleSystem.Generated.DTO.CountryFullDTO> GetFullCountriesByIdentsInternal(SampleSystem.Generated.DTO.CountryIdentityDTO[] countryIdents, Framework.Infrastructure.Service.EvaluatedData<SampleSystem.BLL.ISampleSystemBLLContext, SampleSystem.Generated.DTO.ISampleSystemDTOMappingService> evaluateData)
        {
            ...
            return SampleSystem.Generated.DTO.LambdaHelper.ToFullDTOList(bll.GetListByIdents(countryIdents, new Framework.BLL.DTOFetchRule<SampleSystem.Domain.Country>(Framework.BLL.Domain.DTO.ViewDTOType.FullDTO)), evaluateData.MappingService);
        }
        ...
        {
            SampleSystem.BLL.ICountryBLL bll = evaluateData.Context.Logics.CountryFactory.Create(SecuritySystem.SecurityRule.View);
            return SampleSystem.Generated.DTO.LambdaHelper.ToFullDTOList(bll.GetFullList(new Framework.BLL.DTOFetchRule<SampleSystem.Domain.Country>(Framework.BLL.Domain.DTO.ViewDTOType.FullDTO)), evaluateData.MappingService);
        }
        ...
        {
            SampleSystem.BLL.ICountryBLL bll = evaluateData.Context.Logics.CountryFactory.Create(SecuritySystem.SecurityRule.View);
            SampleSystem.Domain.Country domainObject = Framework.BLL.DefaultDomainBLLBaseExtensions.GetByCode(bll, countryCode, true, new Framework.BLL.DTOFetchRule<SampleSystem.Domain.Country>(Framework.BLL.Domain.DTO.ViewDTOType.FullDTO));
        ...
        {
            SampleSystem.BLL.ICountryBLL bll = evaluateData.Context.Logics.CountryFactory.Create(SecuritySystem.SecurityRule.View);
            SampleSystem.Domain.Country domainObject = Framework.BLL.DefaultDomainBLLBaseExtensions.GetByName(bll, countryName, true, new Framework.BLL.DTOFetchRule<SampleSystem.Domain.Country>(Framework.BLL.Domain.DTO.ViewDTOType.FullDTO));
            return SampleSystem.Generated.DTO.LambdaHelper.ToFullDTO(domainObject, evaluateData.MappingService);
        }
        ...
        {
            SampleSystem.BLL.ICountryBLL bll = evaluateData.Context.Logics.CountryFactory.Create(SecuritySystem.SecurityRule.View);
            SampleSystem.Domain.Country domainObject = bll.GetById(countryIdentity.Id, true, new Framework.BLL.DTOFetchRule<SampleSystem.Domain.Country>(Framework.BLL.Domain.DTO.ViewDTOType.FullDTO));
            return SampleSystem.Generated.DTO.LambdaHelper.ToFullDTO(domainObject, evaluateData.MappingService);
        }
        ...
        {
            SampleSystem.BLL.ICountryBLL bll = evaluateData.Context.Logics.CountryFactory.Create(SecuritySystem.SecurityRule.View);
            return SampleSystem.Generated.DTO.LambdaHelper.ToSimpleDTOList(bll.GetListByIdents(countryIdents, new Framework.BLL.DTOFetchRule<SampleSystem.Domain.Country>(Framework.BLL.Domain.DTO.ViewDTOType.SimpleDTO)), evaluateData.MappingService);
        }
        ...
        {
            SampleSystem.BLL.ICountryBLL bll = evaluateData.Context.Logics.CountryFactory.Create(SecuritySystem.SecurityRule.View);
            return SampleSystem.Generated.DTO.LambdaHelper.ToSimpleDTOList(bll.GetFullList(new Framework.BLL.DTOFetchRule<SampleSystem.Domain.Country>(Framework.BLL.Domain.DTO.ViewDTOType.SimpleDTO)), evaluateData.MappingService);
        }
        ...
        {
            SampleSystem.BLL.ICountryBLL bll = evaluateData.Context.Logics.CountryFactory.Create(SecuritySystem.SecurityRule.View);
            SampleSystem.Domain.Country domainObject = Framework.BLL.DefaultDomainBLLBaseExtensions.GetByCode(bll, countryCode, true, new Framework.BLL.DTOFetchRule<SampleSystem.Domain.Country>(Framework.BLL.Domain.DTO.ViewDTOType.SimpleDTO));
        ...
        {
            SampleSystem.BLL.ICountryBLL bll = evaluateData.Context.Logics.CountryFactory.Create(SecuritySystem.SecurityRule.View);
            SampleSystem.Domain.Country domainObject = Framework.BLL.DefaultDomainBLLBaseExtensions.GetByName(bll, countryName, true, new Framework.BLL.DTOFetchRule<SampleSystem.Domain.Country>(Framework.BLL.Domain.DTO.ViewDTOType.SimpleDTO));
            return SampleSystem.Generated.DTO.LambdaHelper.ToSimpleDTO(domainObject, evaluateData.MappingService);
        }
        ...
        {
            SampleSystem.BLL.ICountryBLL bll = evaluateData.Context.Logics.CountryFactory.Create(SecuritySystem.SecurityRule.View);
            SampleSystem.Domain.Country domainObject = bll.GetById(countryIdentity.Id, true, new Framework.BLL.DTOFetchRule<SampleSystem.Domain.Country>(Framework.BLL.Domain.DTO.ViewDTOType.SimpleDTO));
            return SampleSystem.Generated.DTO.LambdaHelper.ToSimpleDTO(domainObject, evaluateData.MappingService);
        }
        ...
        {
            SampleSystem.BLL.ICountryBLL bll = evaluateData.Context.Logics.CountryFactory.Create(SecuritySystem.SecurityRule.View);
            return SampleSystem.Generated.DTO.LambdaHelper.ToVisualDTOList(bll.GetListByIdents(countryIdents, new Framework.BLL.DTOFetchRule<SampleSystem.Domain.Country>(Framework.BLL.Domain.DTO.ViewDTOType.VisualDTO)), evaluateData.MappingService);
        }
        ...
        {
            SampleSystem.BLL.ICountryBLL bll = evaluateData.Context.Logics.CountryFactory.Create(SecuritySystem.SecurityRule.View);
            return SampleSystem.Generated.DTO.LambdaHelper.ToVisualDTOList(bll.GetFullList(new Framework.BLL.DTOFetchRule<SampleSystem.Domain.Country>(Framework.BLL.Domain.DTO.ViewDTOType.VisualDTO)), evaluateData.MappingService);
        }
        ...
        {
            SampleSystem.BLL.ICountryBLL bll = evaluateData.Context.Logics.CountryFactory.Create(SecuritySystem.SecurityRule.View);
            SampleSystem.Domain.Country domainObject = Framework.BLL.DefaultDomainBLLBaseExtensions.GetByCode(bll, countryCode, true, new Framework.BLL.DTOFetchRule<SampleSystem.Domain.Country>(Framework.BLL.Domain.DTO.ViewDTOType.VisualDTO));
        ...
        {
            SampleSystem.BLL.ICountryBLL bll = evaluateData.Context.Logics.CountryFactory.Create(SecuritySystem.SecurityRule.View);
            SampleSystem.Domain.Country domainObject = Framework.BLL.DefaultDomainBLLBaseExtensions.GetByName(bll, countryName, true, new Framework.BLL.DTOFetchRule<SampleSystem.Domain.Country>(Framework.BLL.Domain.DTO.ViewDTOType.VisualDTO));
            return SampleSystem.Generated.DTO.LambdaHelper.ToVisualDTO(domainObject, evaluateData.MappingService);
        }
        ...
        {
            SampleSystem.BLL.ICountryBLL bll = evaluateData.Context.Logics.CountryFactory.Create(SecuritySystem.SecurityRule.View);
            SampleSystem.Domain.Country domainObject = bll.GetById(countryIdentity.Id, true, new Framework.BLL.DTOFetchRule<SampleSystem.Domain.Country>(Framework.BLL.Domain.DTO.ViewDTOType.VisualDTO));
            return SampleSystem.Generated.DTO.LambdaHelper.ToVisualDTO(domainObject, evaluateData.MappingService);
        }
        ...
        {
            SampleSystem.Domain.Country domainObject = Framework.BLL.DefaultDomainBLLBaseExtensions.GetByIdOrCreate(bll, countryStrict.Id);
