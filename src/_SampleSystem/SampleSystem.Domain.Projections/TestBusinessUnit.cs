...
public partial class TestBusinessUnit
{
    ...
    public override string Employees => this.BusinessUnitEmployeeRoles.OrderBy<MiniBusinessUnitEmployeeRole, string>(link => link.Employee.NameEngFirstName).Join(",", link => link.Employee.NameEngFirstName);
}
