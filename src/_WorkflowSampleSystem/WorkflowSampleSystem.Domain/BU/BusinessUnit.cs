...
namespace WorkflowSampleSystem.Domain
{
    ...
    [WorkflowSampleSystemViewDomainObject(WorkflowSampleSystemSecurityOperationCode.BusinessUnitView, WorkflowSampleSystemSecurityOperationCode.BusinessUnitHrDepartmentView, SourceTypes = new[] { typeof(Employee), typeof(BusinessUnitHrDepartment) })]
