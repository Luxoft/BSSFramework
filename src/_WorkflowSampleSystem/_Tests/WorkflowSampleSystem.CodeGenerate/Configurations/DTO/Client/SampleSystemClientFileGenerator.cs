...
{
    public class WorkflowSampleSystemClientFileGenerator<TConfiguration> : ClientFileGenerator<TConfiguration>
        where TConfiguration : class, IClientGeneratorConfigurationBase<IClientGenerationEnvironmentBase>
    {
        public WorkflowSampleSystemClientFileGenerator(TConfiguration configuration)
            : base(configuration)
        {
        }
