    ...
    where TConfiguration : class, IGeneratorConfigurationBase<IGenerationEnvironmentBase>
{
    ...
    {
        yield return typeof(BLLContextHandlerValidator<,>).ToTypeReference(this.Configuration.Environment.BLLCore.BLLContextInterfaceTypeReference, this.Configuration.OperationContextTypeReference);
    }
    ...
    protected override IEnumerable<CodeTypeMember> GetMembers()
    {
        ...
        foreach (var domainType in this.Configuration.ValidationTypes)
        {
            ...
            var operationContextParameter = this.Configuration.OperationContextTypeReference.ToParameterDeclarationExpression("operationContext");
