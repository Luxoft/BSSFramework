...
public interface IDTOGeneratorConfiguration<out TEnvironment> : IDTOGeneratorConfiguration, ICodeGeneratorConfiguration<TEnvironment, BaseFileType>
    where TEnvironment : IDTOGenerationEnvironment;

public interface IDTOGeneratorConfiguration : ICodeGeneratorConfiguration, ICodeTypeReferenceService<BaseFileType>
{
