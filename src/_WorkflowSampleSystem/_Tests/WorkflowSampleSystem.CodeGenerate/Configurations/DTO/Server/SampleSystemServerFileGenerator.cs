...
{
    public class WorkflowSampleSystemServerFileGenerator<TConfiguration> : ServerFileGenerator<TConfiguration>
        where TConfiguration : class, IServerGeneratorConfigurationBase<IServerGenerationEnvironmentBase>
    {
        public WorkflowSampleSystemServerFileGenerator(TConfiguration configuration)
            : base(configuration)
        {
        }
