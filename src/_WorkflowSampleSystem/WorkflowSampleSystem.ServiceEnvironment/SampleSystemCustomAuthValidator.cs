...
namespace WorkflowSampleSystem.ServiceEnvironment
{
    ...
    /// </summary>
    public class WorkflowSampleSystemCustomAuthValidator : AuthorizationValidator
    {
        public WorkflowSampleSystemCustomAuthValidator(IAuthorizationBLLContext context, ValidatorCompileCache cache)
                : base(context, cache)
        {
        }
