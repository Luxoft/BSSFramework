namespace SampleSystem.WebApiCore.Controllers.MainQuery
{
    ...
    public partial class PrincipalQueryController : Framework.Infrastructure.ApiControllerBase<SampleSystem.BLL.ISampleSystemBLLContext, SampleSystem.Generated.DTO.ISampleSystemDTOMappingService>
    {
        ...
        public virtual OData.Domain.SelectOperationResult<SampleSystem.Generated.DTO.PrincipalFullDTO> GetFullPrincipalsByODataQueryString([Microsoft.AspNetCore.Mvc.FromBodyAttribute()] string odataQueryString)
        {
        ...
        protected virtual OData.Domain.SelectOperationResult<SampleSystem.Generated.DTO.PrincipalFullDTO> GetFullPrincipalsByODataQueryStringInternal(string odataQueryString, Framework.Infrastructure.Service.EvaluatedData<SampleSystem.BLL.ISampleSystemBLLContext, SampleSystem.Generated.DTO.ISampleSystemDTOMappingService> evaluateData)
        {
            ...
            OData.Domain.SelectOperation<SampleSystem.Domain.ExternalPrincipal.Principal> selectOperation = evaluateData.Context.SelectOperationParser.Parse<SampleSystem.Domain.ExternalPrincipal.Principal>(odataQueryString);
            OData.Domain.SelectOperationResult<SampleSystem.Domain.ExternalPrincipal.Principal> preResult = bll.GetObjectsByOData(selectOperation, new Framework.BLL.DTOFetchRule<SampleSystem.Domain.ExternalPrincipal.Principal>(Framework.BLL.Domain.DTO.ViewDTOType.FullDTO));
        ...
        /// </summary>
        [Microsoft.AspNetCore.Mvc.HttpPostAttribute()]
        public virtual OData.Domain.SelectOperationResult<SampleSystem.Generated.DTO.PrincipalSimpleDTO> GetSimplePrincipalsByODataQueryString([Microsoft.AspNetCore.Mvc.FromBodyAttribute()] string odataQueryString)
        {
        ...
        protected virtual OData.Domain.SelectOperationResult<SampleSystem.Generated.DTO.PrincipalSimpleDTO> GetSimplePrincipalsByODataQueryStringInternal(string odataQueryString, Framework.Infrastructure.Service.EvaluatedData<SampleSystem.BLL.ISampleSystemBLLContext, SampleSystem.Generated.DTO.ISampleSystemDTOMappingService> evaluateData)
        {
            SampleSystem.BLL.IPrincipalBLL bll = evaluateData.Context.Logics.PrincipalFactory.Create(SecuritySystem.SecurityRule.View);
            OData.Domain.SelectOperation<SampleSystem.Domain.ExternalPrincipal.Principal> selectOperation = evaluateData.Context.SelectOperationParser.Parse<SampleSystem.Domain.ExternalPrincipal.Principal>(odataQueryString);
            OData.Domain.SelectOperationResult<SampleSystem.Domain.ExternalPrincipal.Principal> preResult = bll.GetObjectsByOData(selectOperation, new Framework.BLL.DTOFetchRule<SampleSystem.Domain.ExternalPrincipal.Principal>(Framework.BLL.Domain.DTO.ViewDTOType.SimpleDTO));
