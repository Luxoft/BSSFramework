...
using WorkflowSampleSystem.WebApiCore.Controllers.Audit;

using EmployeeController = WorkflowSampleSystem.WebApiCore.Controllers.Main.EmployeeController;
...
namespace WorkflowSampleSystem.IntegrationTests
{
    ...
    public class AuditTests : TestBase
    {
        ...
        public void GetObjectRevisions_CheckCount_Correct()
        {
            ...
            var employeeAuditController = this.GetController<WorkflowSampleSystem.WebApiCore.Controllers.Audit.EmployeeController>();
            var testCount = 10;
        ...
        public void GetObjectPropertyRevisions_ChangePrimitiveProperty_CorrectRevisions()
        {
            ...
            var checkPropertyRevision = employeeAuditController.GetEmployeePropertyRevisions(new GetEmployeePropertyRevisionsAutoRequest
                                                               ...
                                                               .OrderBy(z => z.RevisionNumber)
                                                               .Skip(skip) ////
                                                               .FirstOrDefault() as WorkflowSampleSystemPropertyRevisionDTO<string>;
