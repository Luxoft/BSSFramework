...
namespace WorkflowSampleSystem.IntegrationTests.Reports
{
    ...
    public class RegularReportsTests : TestBase
    {
        ...
        public void GetReport_GetLocationNameReportGetDepartmentNameReport_CorrectBuild()
        {
            ...
            var locationReportStream = WorkflowSampleSystemGenericReportController.GetStream(new ReportGenerationModelStrictDTO() { Report = locationReport1Identity });
            var departmentReportStream = WorkflowSampleSystemGenericReportController.GetStream(new ReportGenerationModelStrictDTO() { Report = departmentReportIdentity });
            var location2ReportStream = WorkflowSampleSystemGenericReportController.GetStream(new ReportGenerationModelStrictDTO() { Report = locationReport2Identity });
        ...
        public void GetEmployeeReport_ReportForPersistentPropertiesWithVirtualFilterNextChangeProperty_CorrectBuild()
        {
            ...
            var reportStream = WorkflowSampleSystemGenericReportController.GetStream(reportGenerationModel);
            ...
            WorkflowSampleSystemGenericReportController.SaveReport(reportRichDTO.ToStrict());

            reportRichDTO = WorkflowSampleSystemGenericReportController.GetRichReport(reportRichDTO.Identity);

            reportGenerationModel = CreateReportModel(reportRichDTO, new Dictionary<string, object>());

            // Assert
            reportStream = WorkflowSampleSystemGenericReportController.GetStream(reportGenerationModel);
        ...
        public void GetEmployeeReport_ReportForPersistentPropertiesWithVirtualFilterNextChangePropertyNextChangeProperty_CorrectBuild()
        {
            ...
            WorkflowSampleSystemGenericReportController.SaveReport(reportRichDTO1.ToStrict());
        ...
        public void GetStream_TwoReportForDepartmentWithOtherLocationSubset_Correct()
        {
            ...
            // Act
            Action buildReports = () => models.Foreach(z => WorkflowSampleSystemGenericReportController.GetStream(z));
        ...
        public void GeneratateReport_FilterPropertyFromParameter_SuccesedGenerate()
        {
            ...
            // Act
            var result = WorkflowSampleSystemGenericReportController.GetStream(generateModel);
        ...
        public void GeneratateReport_AddFilterPropertyFromParameter_SuccesedGenerate()
        {
            ...
            var prevReportStream = WorkflowSampleSystemGenericReportController.GetStream(reportGenerationModel);
            ...
            // Act
            var nextReportStream = WorkflowSampleSystemGenericReportController.GetStream(nextReportGenerationModel);
        ...
        public void GetSimpleReportParameterValuesByTypeName_Correct()
        {
            ...
            var results = WorkflowSampleSystemGenericReportController.GetSimpleReportParameterValuesByTypeName(new GetSimpleReportParameterValuesByTypeNameRequest
            {
                    typeName = "Location",
        ...
        public void GetEmployeeReport_PrincipalWithRole_CorrectReportExcel()
        {
            ...
            var operation = this.GetAuthorizationController().GetSimpleOperationByName(WorkflowSampleSystemSecurityOperationCode.EmployeeView.ToString());
            ...
            // Act
            var reportStream = this.GetController<WorkflowSampleSystemGenericReportController>(Tester).GetStream(reportGenerationModel);
            ...
            reportStream = this.GetController<WorkflowSampleSystemGenericReportController>(Tester).GetStream(reportGenerationModel);
