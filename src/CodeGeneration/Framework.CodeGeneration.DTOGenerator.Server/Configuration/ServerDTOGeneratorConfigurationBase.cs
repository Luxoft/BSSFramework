...
public abstract class ServerDTOGeneratorConfigurationBase<TEnvironment> : DTOGeneratorConfigurationBase<TEnvironment>, IServerDTOGeneratorConfiguration<TEnvironment>
    where TEnvironment : class, IServerDTOGenerationEnvironment
{
    ...
    protected ServerDTOGeneratorConfigurationBase(TEnvironment environment)
        : base(environment)
    {
    ...
    public override ILayerCodeTypeReferenceService? GetLayerCodeTypeReferenceService(DTOFileType fileType)
    {
        ...
        {
            return new CryptCodeTypeReferenceService<ServerDTOGeneratorConfigurationBase<TEnvironment>>(this, ServerFileType.SimpleIntegrationDTO, ServerFileType.RichIntegrationDTO);
        }
        else if (fileType == ServerFileType.SimpleEventDTO || fileType == ServerFileType.RichEventDTO)
        {
            return new CryptCodeTypeReferenceService<ServerDTOGeneratorConfigurationBase<TEnvironment>>(this, ServerFileType.SimpleEventDTO, ServerFileType.RichEventDTO);
        }
        else
        {
