...
abstract class DatabaseScriptGeneratorContainer
{
    ...
    protected readonly MigrationDBScriptGeneratorBuilder MigrationDbScriptGeneratorBuilder;

    protected DatabaseScriptGeneratorContainer()
    {
        this.generators = new List<IDatabaseScriptGenerator>();
        this.MigrationDbScriptGeneratorBuilder = new MigrationDBScriptGeneratorBuilder();
    }
