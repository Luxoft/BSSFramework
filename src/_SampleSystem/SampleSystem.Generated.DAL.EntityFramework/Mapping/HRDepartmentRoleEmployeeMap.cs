...
public class HRDepartmentRoleEmployeeMap : SampleSystemBaseMap<HRDepartmentRoleEmployee>
{
    public override void Configure(EntityTypeBuilder<HRDepartmentRoleEmployee> builder)
    {
        ...
        builder.HasIndex("employeeId", "hRDepartmentId", "hRDepartmentEmployeeRoleType").IsUnique().HasDatabaseName("UIX_employee_hRDepartment_hRDepartmentEmployeeRoleTypeHRDepartmentRoleEmployee");
    }
}
