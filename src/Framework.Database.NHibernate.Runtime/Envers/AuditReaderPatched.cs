...
{
    private readonly AuditConfiguration verCfg = verCfg;
    ...
    public long GetMaxRevision()
    {
        var result = this.CreatePatchedQuery()
                         ...
                         .AddProjection(new global::NHibernate.Envers.Query.Criteria.AuditProperty(new RevisionNumberFieldPropertyName()).Max())
