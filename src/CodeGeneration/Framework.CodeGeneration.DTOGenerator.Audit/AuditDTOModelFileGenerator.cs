    ...
    where TConfiguration : class, IAuditDTOGeneratorConfiguration<IAuditDTOGenerationEnvironment>
{
    ...
    private IEnumerable<CodeAttributeDeclaration> GetCustomerAttributeNames()
    {
        ...
        var allDomainPersistentObject = this.Configuration.DomainTypes
                                            .Where(z => !this.Configuration.Environment.ExtendedMetadata.GetType(z).HasAttribute<NotAuditedClassAttribute>())
        ...
        var allPropertyInfoCollection = allDomainPersistentObject
                                        ...
                                        .Where(z => this.Configuration.Environment.ExtendedMetadata.GetProperty(z).GetCustomAttributes<CustomSerializationAttribute>().EmptyIfNull().All(q => q.Mode != CustomSerializationMode.Ignore))
