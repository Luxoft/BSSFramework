...
namespace WorkflowSampleSystem.Generated.DAL.NHibernate.FluentMapping
{
    public class ManagementUnitFluentMappingMap : ClassMap<ManagementUnitFluentMapping>
    {
        ...
        /*
  <class name="WorkflowSampleSystem.Domain.ManagementUnitFluentMapping" table="[ManagementUnitFluentMapping]">
    ...
    <many-to-one name="Parent" column="[parentId]" class="WorkflowSampleSystem.Domain.ManagementUnitFluentMapping" access="field.camelcase" />
    <set name="Children" inverse="true" access="field.camelcase" cascade="None">
      <key column="[parentId]" />
      <one-to-many class="WorkflowSampleSystem.Domain.ManagementUnitFluentMapping" />
    </set>
