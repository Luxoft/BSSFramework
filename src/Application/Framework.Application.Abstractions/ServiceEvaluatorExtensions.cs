...
public static class ServiceEvaluatorExtensions
{
    ...
    {
        public async Task<TResult> EvaluateAsync<TResult>(DBSessionMode sessionMode, Func<TService, Task<TResult>> getResult) =>
            await serviceEvaluator.EvaluateAsync(sessionMode, null, getResult);
