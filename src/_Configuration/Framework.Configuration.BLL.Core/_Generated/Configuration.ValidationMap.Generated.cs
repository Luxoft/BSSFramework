...
namespace Framework.Configuration.BLL
{
    ...
    public abstract partial class ConfigurationValidationMapBase : Framework.Validation.ValidationMapBase
    {
        ...
        {
            yield return new Framework.Validation.UniqueCollectionValidator<Framework.Configuration.Domain.DomainType, System.Collections.Generic.IEnumerable<Framework.Configuration.Domain.DomainTypeEventOperation>, Framework.Configuration.Domain.DomainTypeEventOperation, System.Tuple<string>>(source => new System.Tuple<string>(CommonFramework.StringExtensions.TrimNull(source.Name).ToLower()), "Name");
        ...
        {
            yield return new Framework.Validation.UniqueCollectionValidator<Framework.Configuration.Domain.TargetSystem, System.Collections.Generic.IEnumerable<Framework.Configuration.Domain.DomainType>, Framework.Configuration.Domain.DomainType, System.Tuple<string, string>>(source => new System.Tuple<string, string>(CommonFramework.StringExtensions.TrimNull(source.Name).ToLower(), CommonFramework.StringExtensions.TrimNull(source.NameSpace).ToLower()), "Name, NameSpace");
