...
public static class SampleSystemSecurityOperation
{
    ...
    public static SecurityOperation<Guid> BusinessUnitTypeModuleOpen { get; } = new(nameof(BusinessUnitTypeModuleOpen), new Guid("E4243A14-615E-40a8-809E-C7F3D6DF67B0")) { IsClient = true };

    public static SecurityOperation<Guid> BusinessUnitTypeView { get; } = new(nameof(BusinessUnitTypeView), new Guid("E4243A14-615E-40a8-809E-C7F3D6DF67B1"));

    public static SecurityOperation<Guid> BusinessUnitTypeEdit { get; } = new(nameof(BusinessUnitTypeEdit), new Guid("E4243A14-615E-40a8-809E-C7F3D6DF67B2"));
    ...
    public static SecurityOperation<Guid> EmployeeSpecializationOpenModule { get; } = new(nameof(EmployeeSpecializationOpenModule), new Guid("00000000-71C4-47CD-8683-000000000003"));

    public static SecurityOperation<Guid> EmployeeSpecializationView { get; } = new(nameof(EmployeeSpecializationView), new Guid("00000000-71C4-47CD-8683-000000000004"));

    #endregion

    #region EmployeeRole

    public static SecurityOperation<Guid> EmployeeRoleView { get; } = new(nameof(EmployeeRoleView), new Guid("00000000-71C4-47CD-8683-000000000007"));

    #endregion

    #region EmployeeRoleDegree

    public static SecurityOperation<Guid> EmployeeRoleDegreeView { get; } = new(nameof(EmployeeRoleDegreeView), new Guid("00000000-71C4-47CD-8683-000000000010"));
    ...
    public static SecurityOperation<Guid> HRDepartmentAdvancedEdit { get; } = new(nameof(HRDepartmentAdvancedEdit), new Guid("{F75385D0-BAF3-4689-B0CE-4E7998B9957C}"));
    ...
    public static SecurityOperation<Guid> CountryView { get; } = new(nameof(CountryView), new Guid("{D2171DC7-5D6E-4FF4-BF2C-CBC5B7ABFB51}"));

    public static SecurityOperation<Guid> CountryEdit { get; } = new(nameof(CountryEdit), new Guid("{EE81E81B-DBB6-47E7-8B13-9AC20CA1B730}"));

    #endregion

    #region CompanyLegalEntity

    public static SecurityOperation<Guid> CompanyLegalEntityView { get; } = new(nameof(CompanyLegalEntityView), new Guid("00000000-71C4-47CD-8683-000000000015"));

    public static SecurityOperation<Guid> CompanyLegalEntityEdit { get; } = new(nameof(CompanyLegalEntityEdit), new Guid("00000000-71C4-47CD-8683-000000000016"));
    ...
    public static SecurityOperation<Guid> EmployeePersonalCellPhoneView { get; } = new(nameof(EmployeePersonalCellPhoneView), new Guid("{EF42631D-0B49-4418-A3A7-4EE413ACEDF0}"));

    public static SecurityOperation<Guid> EmployeePersonalCellPhoneEdit { get; } = new(nameof(EmployeePersonalCellPhoneEdit), new Guid("{A30BB9DE-578F-485B-BFFF-1CE6256F34F6}"));
    ...
    public static SecurityOperation<Guid> ApproveWorkflowOperation { get; } = new(nameof(ApproveWorkflowOperation), new Guid("{939EC98C-131B-4E3E-B97C-9DF95620C758}")) { AdminHasAccess = false };

    public static SecurityOperation<Guid> ApprovingWorkflowOperation { get; } = new(nameof(ApprovingWorkflowOperation), new Guid("{927E4AFC-8CC2-4EDA-B6EE-FE6B2C53D0BA}")) { ApproveOperation = ApproveWorkflowOperation };
