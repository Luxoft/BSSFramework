...
public class SecurityRuleOptimizer : SecurityRuleVisitor, ISecurityRuleOptimizer
{
    protected override DomainSecurityRule Visit(OrSecurityRule baseSecurityRule)
    {
        ...
        return visitedBase switch
        {
            ...
            OrSecurityRule
            {
                Left: ExpandedRolesSecurityRule left, Right: ExpandedRolesSecurityRule right
            ...
            OrSecurityRule
            {
                Left: OrSecurityRule
                {
                    Left: ExpandedRolesSecurityRule leftLeft, Right: { } leftRight
                },
            ...
            OrSecurityRule
            {
                Left: OrSecurityRule
                {
                    Left: { } leftLeft, Right: ExpandedRolesSecurityRule leftRight
                },
                Right: ExpandedRolesSecurityRule right
            ...
            OrSecurityRule
                {
                    ...
                    Right: OrSecurityRule
                    {
                        Left: ExpandedRolesSecurityRule rightLeft, Right: { } rightRight
                    }
            ...
            OrSecurityRule
                {
                    ...
                    Right: OrSecurityRule
                    {
                        Left: { } rightLeft, Right: ExpandedRolesSecurityRule rightRight
                    }
            ...
            OrSecurityRule
            {
                Left: NonExpandedRolesSecurityRule left, Right: NonExpandedRolesSecurityRule right
            } when left.CustomExpandType == right.CustomExpandType => left + right,
            ...
            OrSecurityRule
            {
                Left: OrSecurityRule
                {
                    Left: NonExpandedRolesSecurityRule leftLeft, Right: { } leftRight
                },
            ...
            OrSecurityRule
            {
                Left: OrSecurityRule
                {
                    Left: { } leftLeft, Right: NonExpandedRolesSecurityRule leftRight
                },
                Right: NonExpandedRolesSecurityRule right
            } when leftRight.CustomExpandType == right.CustomExpandType => leftLeft.Or(leftRight + right),
            ...
            OrSecurityRule
                {
                    ...
                    Right: OrSecurityRule
                    {
                        Left: NonExpandedRolesSecurityRule rightLeft, Right: { } rightRight
                    }
                } when left.CustomExpandType == rightLeft.CustomExpandType => (left + rightLeft).Or(rightRight),
            ...
            OrSecurityRule
                {
                    ...
                    Right: OrSecurityRule
                    {
                        Left: { } rightLeft, Right: NonExpandedRolesSecurityRule rightRight
                    }
                } when left.CustomExpandType == rightRight.CustomExpandType => (left + rightRight).Or(rightLeft),
