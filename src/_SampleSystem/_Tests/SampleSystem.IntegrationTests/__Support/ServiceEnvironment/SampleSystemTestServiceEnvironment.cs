...
{
    /// <summary>
    /// SampleSystemTestServiceEnvironment Extends EDServiceEnvironment for Test Run. Different Test Env settings are initilized.
    /// </summary>
    public class SampleSystemTestServiceEnvironment : SampleSystemServiceEnvironment, IRootServiceProviderContainer
    {
        ...
        protected static IServiceProvider BuildServiceProvider()
        {
            ...
            return new ServiceCollection()
                                  ...
                                  .AddSingleton<SampleSystemTestServiceEnvironment>().AddSingleton<SampleSystemServiceEnvironment>(sp => sp.GetRequiredService<SampleSystemTestServiceEnvironment>())
