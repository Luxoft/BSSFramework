...
using AttachmentsSampleSystem.CodeGenerate;
...
namespace AttachmentsSampleSystem.DbGenerate
{
    ...
    public class DbGeneratorTest
    {
        ...
        public string GenerateAllDB(
                string serverName,
                string mainDatabaseName = nameof(AttachmentsSampleSystem),
                ...
                params string[] migrationScriptFolderPaths)
        {
            ...
            var result = this.GenerateAttachmentsSampleSystemDB(
                                                     serverName,
        ...
        private string GenerateAttachmentsSampleSystemDB(
                string serverName,
                ...
                UserCredential credential = null)
        {
            var generator = new AttachmentsSampleSystemDBGenerator(this.GetMappingSettings(serverName, databaseName, auditDatabaseName));
        ...
        private IMappingSettings GetMappingSettings(string serverName, DatabaseName dbName, AuditDatabaseName dbAuditName)
        {
            ...
            return new AttachmentsSampleSystemMappingSettings(
                                                   initMappingAction,
                                                   dbName,
                                                   dbAuditName,
                                                   $"Data Source={serverName};Initial Catalog={dbName.Name};Application Name=AttachmentsSampleSystem");
        }
    }
}
