...
public abstract class TestEnvironment : BssTestEnvironment
{
    ...
    protected override void SetInitializers(IDatabaseTestingSetup setup) =>
        ...
        setup.SetTestDataInitializer<TestDataInitializer>();
    ...
    protected abstract IBssFrameworkExtension BssFrameworkExtension { get; }
}
