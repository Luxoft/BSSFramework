...
{
    public class WorkflowSampleSystemProjectionSource : ProjectionSource
    {
        public WorkflowSampleSystemProjectionSource()
        {
            ...
            this.TestLocationCollectionProperties = new Projection<Location>(() => this.TestLocationCollectionProperties, true)
                 ...
                 .CustomProperty<WorkflowSampleSystemSecurityOperationCode[]>("Security_Codes");
            ...
            this.CustomCompanyLegalEntity = new Projection<CompanyLegalEntity>(() => this.CustomCompanyLegalEntity, true)
                ...
                .Attribute(new WorkflowSampleSystemViewDomainObjectAttribute(WorkflowSampleSystemSecurityOperationCode.AuthorizationImpersonate)) // Подменяем атрибут доступа проекции
                .Property(legalEntity => legalEntity.Code, propertyAttributes: new Attribute[] { new WorkflowSampleSystemViewDomainObjectAttribute(WorkflowSampleSystemSecurityOperationCode.CompanyLegalEntityView) }) // Добавляем свойство и атрибут доступа к нему
