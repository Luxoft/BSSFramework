    ...
    where TOperationContext : struct, Enum
{
    ...
    protected void RegisterHandler<TDomainObject>(Func<TDomainObject, TOperationContext, IValidationState, ValidationResult> func)
    {
        this.handlers.Add(typeof(TDomainObject), func);
    }
}
